/* star3d1r_abft_v2_12_90_90_90.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star3d1r_abft_v2_12_90_90_90 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj, tk]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N }
 *	 		C2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p <= 2 and -2 <= q <= 2 and -2 <= r <= 2 }
 *	 		I : {[tt, ti, tj, tk]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N }
 *	 		WKernel : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WCombos : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WAll : {[w]: 0 < w <= 12 }
 *	 		C2_NR : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR5 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR6 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR7 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= r < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= r < 0 }
 *	 		C2_NR9 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= r < 0 }
 *	 		C2_NR10 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR11 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR12 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR13 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR14 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR15 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR16 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < r <= 2 }
 *	 		C2_NR17 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < r <= 2 }
 *	 		C2_NR18 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < r <= 2 }
 *	 		C2_NR19 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR20 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR21 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 }
 *	 		C2_NR22 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR23 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR24 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 }
 *	 		C2_NR25 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 }
 *	 		C2_NR26 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 }
 *	 		C2_NR27 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N }
 *	 		I_NR : {[tt, ti, tj, tk]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj,tk] = reduce(+, (tt,ti,tj,tk,i,j,k->tt,ti,tj,tk), {: 90ti <= i <= 113 + 90ti and 90tj <= j <= 113 + 90tj and 90tk <= k <= 113 + 90tk } : Y[12tt,i,j,k]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p+w,90tj+q+w,90tk+r+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p-w+113,90tj+q+w,90tk+r+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w } : (WAll[w] * Y[12tt-w,i,90tj+q+w,90tk+r+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p+w,90tj+q-w+113,90tk+r+w]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p-w+113,90tj+q-w+113,90tk+r+w]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w } : (WAll[w] * Y[12tt-w,i,90tj+q-w+113,90tk+r+w]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w } : (WAll[w] * Y[12tt-w,90ti+p+w,j,90tk+r+w]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w } : (WAll[w] * Y[12tt-w,90ti+p-w+113,j,90tk+r+w]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tj + w <= j <= 113 + 90tj - w } : (WAll[w] * Y[12tt-w,i,j,90tk+r+w]));
 *	 		
 *	 		C2_NR10[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p+w,90tj+q+w,90tk+r-w+113]));
 *	 		
 *	 		C2_NR11[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p-w+113,90tj+q+w,90tk+r-w+113]));
 *	 		
 *	 		C2_NR12[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w } : (WAll[w] * Y[12tt-w,i,90tj+q+w,90tk+r-w+113]));
 *	 		
 *	 		C2_NR13[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p+w,90tj+q-w+113,90tk+r-w+113]));
 *	 		
 *	 		C2_NR14[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,90ti+p-w+113,90tj+q-w+113,90tk+r-w+113]));
 *	 		
 *	 		C2_NR15[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w } : (WAll[w] * Y[12tt-w,i,90tj+q-w+113,90tk+r-w+113]));
 *	 		
 *	 		C2_NR16[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w } : (WAll[w] * Y[12tt-w,90ti+p+w,j,90tk+r-w+113]));
 *	 		
 *	 		C2_NR17[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w } : (WAll[w] * Y[12tt-w,90ti+p-w+113,j,90tk+r-w+113]));
 *	 		
 *	 		C2_NR18[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tj + w <= j <= 113 + 90tj - w } : (WAll[w] * Y[12tt-w,i,j,90tk+r-w+113]));
 *	 		
 *	 		C2_NR19[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,90ti+p+w,90tj+q+w,k]));
 *	 		
 *	 		C2_NR20[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,90ti+p-w+113,90tj+q+w,k]));
 *	 		
 *	 		C2_NR21[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,i,90tj+q+w,k]));
 *	 		
 *	 		C2_NR22[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,90ti+p+w,90tj+q-w+113,k]));
 *	 		
 *	 		C2_NR23[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,90ti+p-w+113,90tj+q-w+113,k]));
 *	 		
 *	 		C2_NR24[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,i,90tj+q-w+113,k]));
 *	 		
 *	 		C2_NR25[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,90ti+p+w,j,k]));
 *	 		
 *	 		C2_NR26[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w and 90tk + w <= k <= 113 + 90tk - w } : (WAll[w] * Y[12tt-w,90ti+p-w+113,j,k]));
 *	 		
 *	 		C2_NR27[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j,k->tt,ti,tj,tk,p,q,r), {: w = 12 and 12 + 90ti <= i <= 101 + 90ti and 12 + 90tj <= j <= 101 + 90tj and 12 + 90tk <= k <= 101 + 90tk } : (WAll[w] * Y[12tt-w,i,j,k]));
 *	 		
...
void inject_star3d1r_abft_v2_12_90_90_90(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star3d1r_abft_v2_12_90_90_90(double T, double N, float ***X, float ****Y)
#else
struct Result star3d1r_abft_v2_12_90_90_90(long T, long N, float ***X, float ****Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-36) + T >= ((double)0) && ((double)-205) + N >= ((double)0)) ? (((((((double)59931114) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N) - ((double)29964376) * floord(T, ((double)12))) + (((double)-89893128) + ((double)44946564) * floord(T, ((double)12))) * floord(((double)65) + N, ((double)90)) + (((double)44946564) - ((double)22473282) * floord(T, ((double)12))) * floord(((double)65) + N, ((double)90))*floord(((double)65) + N, ((double)90)) + (((double)-7491094) + ((double)3745547) * floord(T, ((double)12))) * floord(((double)65) + N, ((double)90))*floord(((double)65) + N, ((double)90))*floord(((double)65) + N, ((double)90)))) : ((((double)-36) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)204) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)35) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)2362) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N)) : ((double)0));
	...
	float**** I_NR = (float****)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		I_NR[tt] = (float***)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); ti++) {
			I_NR[tt][ti] = (float**)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); tj++) {
				I_NR[tt][ti][tj] = (float*)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float)));
			}
		}
	}
	
	float**** I = (float****)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		I[tt] = (float***)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); ti++) {
			I[tt][ti] = (float**)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); tj++) {
				I[tt][ti][tj] = (float*)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float)));
			}
		}
	}
	...
	float**** C1 = (float****)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		C1[tt] = (float***)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); ti++) {
			C1[tt][ti] = (float**)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); tj++) {
				C1[tt][ti][tj] = (float*)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float)));
			}
		}
	}
	...
	float******* C2 = (float*******)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float******)));
	for (int tt=0; tt<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		C2[tt] = (float******)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float*****)));
		for (int ti=0; ti<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); ti++) {
			C2[tt][ti] = (float*****)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float****)));
			for (int tj=0; tj<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); tj++) {
				C2[tt][ti][tj] = (float****)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0),sizeof(float***)));
				for (int tk=0; tk<((-36 + T >= 0 && -205 + N >= 0) ? ((-2 + floord(65 + N, 90))) : 0); tk++) {
					C2[tt][ti][tj][tk] = (float***)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? (5) : 0),sizeof(float**)));
					for (int p=0; p<((-36 + T >= 0 && -205 + N >= 0) ? (5) : 0); p++) {
						C2[tt][ti][tj][tk][p] = (float**)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? (5) : 0),sizeof(float*)));
						for (int q=0; q<((-36 + T >= 0 && -205 + N >= 0) ? (5) : 0); q++) {
							C2[tt][ti][tj][tk][p][q] = (float*)(calloc(((-36 + T >= 0 && -205 + N >= 0) ? (5) : 0),sizeof(float)));
						}
					}
				}
			}
	...
	#define SC2_NR(tt,ti,tj,tk,p,q,r,w) C2_NR(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),(90*(tj) + (q) + (w)),(90*(tk) + (r) + (w))))
	#define SC2_NR10(tt,ti,tj,tk,p,q,r,w) C2_NR10(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),(90*(tj) + (q) + (w)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR11(tt,ti,tj,tk,p,q,r,w) C2_NR11(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),(90*(tj) + (q) + (w)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR12(tt,ti,tj,tk,p,q,r,w,i) C2_NR12(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(90*(tj) + (q) + (w)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR13(tt,ti,tj,tk,p,q,r,w) C2_NR13(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),(113 + 90*(tj) + (q) - (w)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR14(tt,ti,tj,tk,p,q,r,w) C2_NR14(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),(113 + 90*(tj) + (q) - (w)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR15(tt,ti,tj,tk,p,q,r,w,i) C2_NR15(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(113 + 90*(tj) + (q) - (w)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR16(tt,ti,tj,tk,p,q,r,w,j) C2_NR16(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),((j)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR17(tt,ti,tj,tk,p,q,r,w,j) C2_NR17(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),((j)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR18(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR18(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),((j)),(113 + 90*(tk) + (r) - (w))))
	#define SC2_NR19(tt,ti,tj,tk,p,q,r,w,k) C2_NR19(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),(90*(tj) + (q) + (w)),((k))))
	#define SC2_NR2(tt,ti,tj,tk,p,q,r,w) C2_NR2(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),(90*(tj) + (q) + (w)),(90*(tk) + (r) + (w))))
	#define SC2_NR20(tt,ti,tj,tk,p,q,r,w,k) C2_NR20(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),(90*(tj) + (q) + (w)),((k))))
	#define SC2_NR21(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR21(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(90*(tj) + (q) + (w)),((k))))
	#define SC2_NR22(tt,ti,tj,tk,p,q,r,w,k) C2_NR22(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),(113 + 90*(tj) + (q) - (w)),((k))))
	#define SC2_NR23(tt,ti,tj,tk,p,q,r,w,k) C2_NR23(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),(113 + 90*(tj) + (q) - (w)),((k))))
	#define SC2_NR24(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR24(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(113 + 90*(tj) + (q) - (w)),((k))))
	#define SC2_NR25(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR25(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),((j)),((k))))
	#define SC2_NR26(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR26(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),((j)),((k))))
	#define SC2_NR27(tt,ti,tj,tk,p,q,r,w,i,j,k) C2_NR27(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),((j)),((k))))
	#define SC2_NR3(tt,ti,tj,tk,p,q,r,w,i) C2_NR3(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(90*(tj) + (q) + (w)),(90*(tk) + (r) + (w))))
	#define SC2_NR4(tt,ti,tj,tk,p,q,r,w) C2_NR4(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),(113 + 90*(tj) + (q) - (w)),(90*(tk) + (r) + (w))))
	#define SC2_NR5(tt,ti,tj,tk,p,q,r,w) C2_NR5(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),(113 + 90*(tj) + (q) - (w)),(90*(tk) + (r) + (w))))
	#define SC2_NR6(tt,ti,tj,tk,p,q,r,w,i) C2_NR6(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(113 + 90*(tj) + (q) - (w)),(90*(tk) + (r) + (w))))
	#define SC2_NR7(tt,ti,tj,tk,p,q,r,w,j) C2_NR7(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(90*(ti) + (p) + (w)),((j)),(90*(tk) + (r) + (w))))
	#define SC2_NR8(tt,ti,tj,tk,p,q,r,w,j) C2_NR8(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(113 + 90*(ti) + (p) - (w)),((j)),(90*(tk) + (r) + (w))))
	#define SC2_NR9(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR9(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),((j)),(90*(tk) + (r) + (w))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j,k) do { SY_cb2_hook(t,i,j,k); if (t==12*(tt_INJ-1)+1 && i==90*ti_INJ+57 && j==90*tj_INJ+57 && k==90*tk_INJ+57) inject_star3d1r_abft_v2_12_90_90_90(&Y(t,i,j,k)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb25[tt, ti, tj, tk, p, q = 0, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2; SC2_NR16[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < r <= 2 and 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w; SC2_cb1[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0; SC2_cb24[tt, ti, tj, tk, p, q = 0, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0; SC2_cb21[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2; SC2_NR14[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 12; SC2_cb23[tt, ti, tj, tk, p = 0, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2; SW[i, j, k] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 and -1 <= k <= 1; SC2_cb16[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < r <= 2; SC2_NR15[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w; SC2_NR24[tt, ti, tj, tk, p = 0, q, r = 0, w, i, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tk + w <= k <= 113 + 90tk - w; SC2_cb13[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2; SC2_cb18[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0; SY_cb2[t, i, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N and 0 < k < N; SC2_cb4[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 12; SWKernel[i, j, k] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2; SC2_NR9[tt, ti, tj, tk, p = 0, q = 0, r, w, i, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= r < 0 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tj + w <= j <= 113 + 90tj - w; SC2_cb0[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0; SC2_cb20[tt, ti, tj, tk, p = 0, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0; SC2_cb11[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 and 0 < r <= 2; SI_NR[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p <= 2 and -2 <= q <= 2 and -2 <= r <= 2; SY_cb1[t, i, j, k = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= j <= N; SY_cb1[t, i, j = N, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= k <= N; SY_cb1[t, i = N, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N and 0 <= k <= N; SY_cb1[t, i, j, k = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= j <= N; SY_cb1[t, i, j = 0, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= k <= N; SY_cb1[t, i = 0, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N and 0 <= k <= N; SC2_NR17[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < r <= 2 and 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w; SC2_NR12[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w; SC2_NR21[tt, ti, tj, tk, p = 0, q, r = 0, w, i, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tk + w <= k <= 113 + 90tk - w; SC2_NR13[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 12; SC2_NR25[tt, ti, tj, tk, p, q = 0, r = 0, w, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w and 90tk + w <= k <= 113 + 90tk - w; SC2_cb22[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2; SC2_NR18[tt, ti, tj, tk, p = 0, q = 0, r, w, i, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < r <= 2 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w and 90tj + w <= j <= 113 + 90tj - w; SC2_NR23[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w; SC2_NR27[tt, ti, tj, tk, p = 0, q = 0, r = 0, w = 12, i, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 12 + 90ti <= i <= 101 + 90ti and 12 + 90tj <= j <= 101 + 90tj and 12 + 90tk <= k <= 101 + 90tk; SC2_NR2[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 12; SC2_NR4[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 12; SWCombos[i, j, k, p, q, r] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j and r >= -2 + k and -1 <= r <= 1 and r <= 2 + k; SC2_cb2[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 and -2 <= r < 0; SC2_cb6[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= r < 0; SC2_cb9[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2; SC2_cb7[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= r < 0; SC2_NR26[tt, ti, tj, tk, p, q = 0, r = 0, w, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w and 90tk + w <= k <= 113 + 90tk - w; SC2_cb15[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < r <= 2; SC2_cb8[tt, ti, tj, tk, p = 0, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= r < 0; SC2_cb3[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0; SC2_NR10[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 12; SC2_NR5[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 12; SC2_cb19[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb17[tt, ti, tj, tk, p = 0, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < r <= 2; SC2_NR11[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 12; SC2_NR[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 12; SC2_cb12[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2; SC2_NR8[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= r < 0 and 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w; SC2_NR7[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= r < 0 and 0 < w <= 12 and 90tj + w <= j <= 113 + 90tj - w; SC1[tt, ti, tj, tk, i, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 90ti <= i <= 113 + 90ti and 90tj <= j <= 113 + 90tj and 90tk <= k <= 113 + 90tk; SC2_cb5[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 and -2 <= r < 0; SI[tt, ti, tj, tk] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N; SC2_cb10[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2; SC2_NR22[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w; SC2_NR3[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w; SY_cb0[t, i, j, k] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N and 0 <= k <= N; SC2_cb26[tt, ti, tj, tk, p = 0, q = 0, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N; SC2_NR19[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w; SC2_cb14[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 and 0 < r <= 2; SC2_NR6[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 12 and 90ti + w <= i <= 113 + 90ti - w; SC2_NR20[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 90ti <= -115 + N and tj > 0 and 90tj <= -115 + N and tk > 0 and 90tk <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 12 and 90tk + w <= k <= 113 + 90tk - w }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j, k] }"
	 *   - filter: "{ SWKernel[i, j, k] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (c0 >= 12 && (c0 % 12) + T >= c0 + 24) {
	    for (int c2 = 1; c2 < floord(N - 25, 90); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 25) / 90; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 25) / 90; c4 += 1) {
	      ...
	      for (int c3 = 1; c3 < (N - 25) / 90; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 25) / 90; c4 += 1) {
	          for (int c6 = -2; c6 < 0; c6 += 1) {
	            for (int c9 = -(c0 % 12) + 90 * c2 + 12; c9 <= (c0 % 12) + 90 * c2 + 101; c9 += 1) {
	              for (int c10 = -(c0 % 12) + 90 * c4 + 12; c10 <= (c0 % 12) + 90 * c4 + 101; c10 += 1) {
	    ...
	    for (int c2 = 1; c2 < floord(N - 25, 90); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 25) / 90; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 25) / 90; c4 += 1) {
	          for (int c5 = 1; c5 <= 2; c5 += 1) {
	            for (int c6 = 1; c6 <= 2; c6 += 1) {
	              for (int c9 = -(c0 % 12) + 90 * c4 + 12; c9 <= (c0 % 12) + 90 * c4 + 101; c9 += 1) {
	      ...
	      for (int c3 = 1; c3 < (N - 25) / 90; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 25) / 90; c4 += 1) {
	          for (int c5 = -2; c5 < 0; c5 += 1) {
	            for (int c7 = -2; c7 < 0; c7 += 1) {
	              for (int c9 = -(c0 % 12) + 90 * c3 + 12; c9 <= (c0 % 12) + 90 * c3 + 101; c9 += 1) {
	    ...
	    for (int c2 = 1; c2 < floord(N - 25, 90); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 25) / 90; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 25) / 90; c4 += 1) {
	          for (int c7 = 1; c7 <= 2; c7 += 1) {
	            for (int c9 = -(c0 % 12) + 90 * c2 + 12; c9 <= (c0 % 12) + 90 * c2 + 101; c9 += 1) {
	              for (int c10 = -(c0 % 12) + 90 * c3 + 12; c10 <= (c0 % 12) + 90 * c3 + 101; c10 += 1) {
	  ...
	  if (c0 >= 24 && T >= c0 + 12 && c0 % 12 == 0) {
	    for (int c2 = 1; c2 < floord(N - 25, 90); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 25) / 90; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 25) / 90; c4 += 1) {
	          for (int c5 = 90 * c2; c5 <= 90 * c2 + 113; c5 += 1) {
	            for (int c6 = 90 * c3; c6 <= 90 * c3 + 113; c6 += 1) {
	              for (int c7 = 90 * c4; c7 <= 90 * c4 + 113; c7 += 1) {
	  ...
	  if (T >= c0 + 24 && c0 % 12 == 0) {
	    for (int c2 = 1; c2 < floord(N - 25, 90); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 25) / 90; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 25) / 90; c4 += 1) {
	          for (int c9 = 90 * c2 + 12; c9 <= 90 * c2 + 101; c9 += 1) {
	            for (int c10 = 90 * c3 + 12; c10 <= 90 * c3 + 101; c10 += 1) {
	              for (int c11 = 90 * c4 + 12; c11 <= 90 * c4 + 101; c11 += 1) {
	...
	for (int tt = 2; tt < T / 12; tt += 1) {
	  for (int ti = 1; ti < (N - 25) / 90; ti += 1) {
	    for (int tj = 1; tj < (N - 25) / 90; tj += 1) {
	      for (int tk = 1; tk < (N - 25) / 90; tk += 1) {
	        SI(tt, ti, tj, tk);
	      }
	    }
	  }
