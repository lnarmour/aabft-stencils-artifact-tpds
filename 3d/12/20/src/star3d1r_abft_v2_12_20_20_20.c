/* star3d1r_abft_v2_12_20_20_20.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star3d1r_abft_v2_12_20_20_20 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj, tk]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N }
 *	 		C2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p <= 2 and -2 <= q <= 2 and -2 <= r <= 2 }
 *	 		I : {[tt, ti, tj, tk]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N }
 *	 		WKernel : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WCombos : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WAll : {[w]: 0 < w <= 12 }
 *	 		C2_NR : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR5 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR6 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR7 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= r < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= r < 0 }
 *	 		C2_NR9 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= r < 0 }
 *	 		C2_NR10 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR11 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR12 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR13 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR14 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR15 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR16 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < r <= 2 }
 *	 		C2_NR17 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < r <= 2 }
 *	 		C2_NR18 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < r <= 2 }
 *	 		C2_NR19 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR20 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR21 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 }
 *	 		C2_NR22 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR23 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR24 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 }
 *	 		C2_NR25 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 }
 *	 		C2_NR26 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 }
 *	 		C2_NR27 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and r = 0 and tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N }
 *	 		I_NR : {[tt, ti, tj, tk]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj,tk] = reduce(+, (tt,ti,tj,tk,i,j,k->tt,ti,tj,tk), {: 20ti <= i <= 43 + 20ti and 20tj <= j <= 43 + 20tj and 20tk <= k <= 43 + 20tk } : Y[12tt,i,j,k]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p+w,20tj+q+w,20tk+r+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p-w+43,20tj+q+w,20tk+r+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w } : (WAll[w] * Y[12tt-w,i,20tj+q+w,20tk+r+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p+w,20tj+q-w+43,20tk+r+w]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p-w+43,20tj+q-w+43,20tk+r+w]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w } : (WAll[w] * Y[12tt-w,i,20tj+q-w+43,20tk+r+w]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w } : (WAll[w] * Y[12tt-w,20ti+p+w,j,20tk+r+w]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w } : (WAll[w] * Y[12tt-w,20ti+p-w+43,j,20tk+r+w]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tj + w <= j <= 43 + 20tj - w } : (WAll[w] * Y[12tt-w,i,j,20tk+r+w]));
 *	 		
 *	 		C2_NR10[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p+w,20tj+q+w,20tk+r-w+43]));
 *	 		
 *	 		C2_NR11[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p-w+43,20tj+q+w,20tk+r-w+43]));
 *	 		
 *	 		C2_NR12[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w } : (WAll[w] * Y[12tt-w,i,20tj+q+w,20tk+r-w+43]));
 *	 		
 *	 		C2_NR13[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p+w,20tj+q-w+43,20tk+r-w+43]));
 *	 		
 *	 		C2_NR14[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[12tt-w,20ti+p-w+43,20tj+q-w+43,20tk+r-w+43]));
 *	 		
 *	 		C2_NR15[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w } : (WAll[w] * Y[12tt-w,i,20tj+q-w+43,20tk+r-w+43]));
 *	 		
 *	 		C2_NR16[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w } : (WAll[w] * Y[12tt-w,20ti+p+w,j,20tk+r-w+43]));
 *	 		
 *	 		C2_NR17[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w } : (WAll[w] * Y[12tt-w,20ti+p-w+43,j,20tk+r-w+43]));
 *	 		
 *	 		C2_NR18[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tj + w <= j <= 43 + 20tj - w } : (WAll[w] * Y[12tt-w,i,j,20tk+r-w+43]));
 *	 		
 *	 		C2_NR19[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,20ti+p+w,20tj+q+w,k]));
 *	 		
 *	 		C2_NR20[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,20ti+p-w+43,20tj+q+w,k]));
 *	 		
 *	 		C2_NR21[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,i,20tj+q+w,k]));
 *	 		
 *	 		C2_NR22[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,20ti+p+w,20tj+q-w+43,k]));
 *	 		
 *	 		C2_NR23[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,20ti+p-w+43,20tj+q-w+43,k]));
 *	 		
 *	 		C2_NR24[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,i,20tj+q-w+43,k]));
 *	 		
 *	 		C2_NR25[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,20ti+p+w,j,k]));
 *	 		
 *	 		C2_NR26[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w and 20tk + w <= k <= 43 + 20tk - w } : (WAll[w] * Y[12tt-w,20ti+p-w+43,j,k]));
 *	 		
 *	 		C2_NR27[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j,k->tt,ti,tj,tk,p,q,r), {: w = 12 and 12 + 20ti <= i <= 31 + 20ti and 12 + 20tj <= j <= 31 + 20tj and 12 + 20tk <= k <= 31 + 20tk } : (WAll[w] * Y[12tt-w,i,j,k]));
 *	 		
...
void inject_star3d1r_abft_v2_12_20_20_20(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star3d1r_abft_v2_12_20_20_20(double T, double N, float ***X, float ****Y)
#else
struct Result star3d1r_abft_v2_12_20_20_20(long T, long N, float ***X, float ****Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-36) + T >= ((double)0) && ((double)-65) + N >= ((double)0)) ? (((((((double)13896940) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N) - ((double)6947289) * floord(T, ((double)12))) + (((double)-13894578) + ((double)6947289) * floord(T, ((double)12))) * floord(((double)15) + N, ((double)20)) + (((double)4631526) - ((double)2315763) * floord(T, ((double)12))) * floord(((double)15) + N, ((double)20))*floord(((double)15) + N, ((double)20)) + (((double)-514614) + ((double)257307) * floord(T, ((double)12))) * floord(((double)15) + N, ((double)20))*floord(((double)15) + N, ((double)20))*floord(((double)15) + N, ((double)20)))) : ((((double)-36) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)64) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)35) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)2362) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N)) : ((double)0));
	...
	float**** I_NR = (float****)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		I_NR[tt] = (float***)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); ti++) {
			I_NR[tt][ti] = (float**)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); tj++) {
				I_NR[tt][ti][tj] = (float*)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float)));
			}
		}
	}
	
	float**** I = (float****)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		I[tt] = (float***)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); ti++) {
			I[tt][ti] = (float**)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); tj++) {
				I[tt][ti][tj] = (float*)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float)));
			}
		}
	}
	...
	float**** C1 = (float****)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		C1[tt] = (float***)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); ti++) {
			C1[tt][ti] = (float**)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); tj++) {
				C1[tt][ti][tj] = (float*)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float)));
			}
		}
	}
	...
	float******* C2 = (float*******)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0),sizeof(float******)));
	for (int tt=0; tt<((-36 + T >= 0 && -65 + N >= 0) ? ((-2 + floord(T, 12))) : 0); tt++) {
		C2[tt] = (float******)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float*****)));
		for (int ti=0; ti<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); ti++) {
			C2[tt][ti] = (float*****)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float****)));
			for (int tj=0; tj<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); tj++) {
				C2[tt][ti][tj] = (float****)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0),sizeof(float***)));
				for (int tk=0; tk<((-36 + T >= 0 && -65 + N >= 0) ? ((-3 + floord(15 + N, 20))) : 0); tk++) {
					C2[tt][ti][tj][tk] = (float***)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? (5) : 0),sizeof(float**)));
					for (int p=0; p<((-36 + T >= 0 && -65 + N >= 0) ? (5) : 0); p++) {
						C2[tt][ti][tj][tk][p] = (float**)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? (5) : 0),sizeof(float*)));
						for (int q=0; q<((-36 + T >= 0 && -65 + N >= 0) ? (5) : 0); q++) {
							C2[tt][ti][tj][tk][p][q] = (float*)(calloc(((-36 + T >= 0 && -65 + N >= 0) ? (5) : 0),sizeof(float)));
						}
					}
				}
			}
	...
	#define SC2_NR(tt,ti,tj,tk,p,q,r,w) C2_NR(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),(20*(tj) + (q) + (w)),(20*(tk) + (r) + (w))))
	#define SC2_NR10(tt,ti,tj,tk,p,q,r,w) C2_NR10(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),(20*(tj) + (q) + (w)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR11(tt,ti,tj,tk,p,q,r,w) C2_NR11(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),(20*(tj) + (q) + (w)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR12(tt,ti,tj,tk,p,q,r,w,i) C2_NR12(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(20*(tj) + (q) + (w)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR13(tt,ti,tj,tk,p,q,r,w) C2_NR13(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),(43 + 20*(tj) + (q) - (w)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR14(tt,ti,tj,tk,p,q,r,w) C2_NR14(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),(43 + 20*(tj) + (q) - (w)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR15(tt,ti,tj,tk,p,q,r,w,i) C2_NR15(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(43 + 20*(tj) + (q) - (w)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR16(tt,ti,tj,tk,p,q,r,w,j) C2_NR16(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),((j)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR17(tt,ti,tj,tk,p,q,r,w,j) C2_NR17(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),((j)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR18(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR18(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),((j)),(43 + 20*(tk) + (r) - (w))))
	#define SC2_NR19(tt,ti,tj,tk,p,q,r,w,k) C2_NR19(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),(20*(tj) + (q) + (w)),((k))))
	#define SC2_NR2(tt,ti,tj,tk,p,q,r,w) C2_NR2(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),(20*(tj) + (q) + (w)),(20*(tk) + (r) + (w))))
	#define SC2_NR20(tt,ti,tj,tk,p,q,r,w,k) C2_NR20(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),(20*(tj) + (q) + (w)),((k))))
	#define SC2_NR21(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR21(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(20*(tj) + (q) + (w)),((k))))
	#define SC2_NR22(tt,ti,tj,tk,p,q,r,w,k) C2_NR22(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),(43 + 20*(tj) + (q) - (w)),((k))))
	#define SC2_NR23(tt,ti,tj,tk,p,q,r,w,k) C2_NR23(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),(43 + 20*(tj) + (q) - (w)),((k))))
	#define SC2_NR24(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR24(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(43 + 20*(tj) + (q) - (w)),((k))))
	#define SC2_NR25(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR25(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),((j)),((k))))
	#define SC2_NR26(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR26(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),((j)),((k))))
	#define SC2_NR27(tt,ti,tj,tk,p,q,r,w,i,j,k) C2_NR27(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),((j)),((k))))
	#define SC2_NR3(tt,ti,tj,tk,p,q,r,w,i) C2_NR3(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(20*(tj) + (q) + (w)),(20*(tk) + (r) + (w))))
	#define SC2_NR4(tt,ti,tj,tk,p,q,r,w) C2_NR4(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),(43 + 20*(tj) + (q) - (w)),(20*(tk) + (r) + (w))))
	#define SC2_NR5(tt,ti,tj,tk,p,q,r,w) C2_NR5(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),(43 + 20*(tj) + (q) - (w)),(20*(tk) + (r) + (w))))
	#define SC2_NR6(tt,ti,tj,tk,p,q,r,w,i) C2_NR6(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),(43 + 20*(tj) + (q) - (w)),(20*(tk) + (r) + (w))))
	#define SC2_NR7(tt,ti,tj,tk,p,q,r,w,j) C2_NR7(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(20*(ti) + (p) + (w)),((j)),(20*(tk) + (r) + (w))))
	#define SC2_NR8(tt,ti,tj,tk,p,q,r,w,j) C2_NR8(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),(43 + 20*(ti) + (p) - (w)),((j)),(20*(tk) + (r) + (w))))
	#define SC2_NR9(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR9(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((12*(tt) - (w)),((i)),((j)),(20*(tk) + (r) + (w))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j,k) do { SY_cb2_hook(t,i,j,k); if (t==12*(tt_INJ-1)+1 && i==20*ti_INJ+22 && j==20*tj_INJ+22 && k==20*tk_INJ+22) inject_star3d1r_abft_v2_12_20_20_20(&Y(t,i,j,k)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb25[tt, ti, tj, tk, p, q = 0, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2; SC2_NR16[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < r <= 2 and 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w; SC2_cb1[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0; SC2_cb24[tt, ti, tj, tk, p, q = 0, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0; SC2_cb21[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2; SC2_NR14[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 12; SC2_cb23[tt, ti, tj, tk, p = 0, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2; SW[i, j, k] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 and -1 <= k <= 1; SC2_cb16[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < r <= 2; SC2_NR15[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w; SC2_NR24[tt, ti, tj, tk, p = 0, q, r = 0, w, i, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tk + w <= k <= 43 + 20tk - w; SC2_cb13[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2; SC2_cb18[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0; SY_cb2[t, i, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N and 0 < k < N; SC2_cb4[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 12; SWKernel[i, j, k] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2; SC2_NR9[tt, ti, tj, tk, p = 0, q = 0, r, w, i, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= r < 0 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tj + w <= j <= 43 + 20tj - w; SC2_cb0[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0; SC2_cb20[tt, ti, tj, tk, p = 0, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0; SC2_cb11[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 and 0 < r <= 2; SI_NR[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p <= 2 and -2 <= q <= 2 and -2 <= r <= 2; SY_cb1[t, i, j, k = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= j <= N; SY_cb1[t, i, j = N, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= k <= N; SY_cb1[t, i = N, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N and 0 <= k <= N; SY_cb1[t, i, j, k = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= j <= N; SY_cb1[t, i, j = 0, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= k <= N; SY_cb1[t, i = 0, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N and 0 <= k <= N; SC2_NR17[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < r <= 2 and 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w; SC2_NR12[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w; SC2_NR21[tt, ti, tj, tk, p = 0, q, r = 0, w, i, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tk + w <= k <= 43 + 20tk - w; SC2_NR13[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 12; SC2_NR25[tt, ti, tj, tk, p, q = 0, r = 0, w, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w and 20tk + w <= k <= 43 + 20tk - w; SC2_cb22[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2; SC2_NR18[tt, ti, tj, tk, p = 0, q = 0, r, w, i, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < r <= 2 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w and 20tj + w <= j <= 43 + 20tj - w; SC2_NR23[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w; SC2_NR27[tt, ti, tj, tk, p = 0, q = 0, r = 0, w = 12, i, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 12 + 20ti <= i <= 31 + 20ti and 12 + 20tj <= j <= 31 + 20tj and 12 + 20tk <= k <= 31 + 20tk; SC2_NR2[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 12; SC2_NR4[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 12; SWCombos[i, j, k, p, q, r] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j and r >= -2 + k and -1 <= r <= 1 and r <= 2 + k; SC2_cb2[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 and -2 <= r < 0; SC2_cb6[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= r < 0; SC2_cb9[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2; SC2_cb7[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= r < 0; SC2_NR26[tt, ti, tj, tk, p, q = 0, r = 0, w, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w and 20tk + w <= k <= 43 + 20tk - w; SC2_cb15[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < r <= 2; SC2_cb8[tt, ti, tj, tk, p = 0, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= r < 0; SC2_cb3[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0; SC2_NR10[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 12; SC2_NR5[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 12; SC2_cb19[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb17[tt, ti, tj, tk, p = 0, q = 0, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < r <= 2; SC2_NR11[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 12; SC2_NR[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 12; SC2_cb12[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2; SC2_NR8[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= r < 0 and 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w; SC2_NR7[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= r < 0 and 0 < w <= 12 and 20tj + w <= j <= 43 + 20tj - w; SC1[tt, ti, tj, tk, i, j, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 20ti <= i <= 43 + 20ti and 20tj <= j <= 43 + 20tj and 20tk <= k <= 43 + 20tk; SC2_cb5[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 and -2 <= r < 0; SI[tt, ti, tj, tk] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N; SC2_cb10[tt, ti, tj, tk, p, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2; SC2_NR22[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w; SC2_NR3[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w; SY_cb0[t, i, j, k] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N and 0 <= k <= N; SC2_cb26[tt, ti, tj, tk, p = 0, q = 0, r = 0] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N; SC2_NR19[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w; SC2_cb14[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 and 0 < r <= 2; SC2_NR6[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 12 and 20ti + w <= i <= 43 + 20ti - w; SC2_NR20[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 20ti <= -45 + N and tj > 0 and 20tj <= -45 + N and tk > 0 and 20tk <= -45 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 12 and 20tk + w <= k <= 43 + 20tk - w }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j, k] }"
	 *   - filter: "{ SWKernel[i, j, k] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	      ...
	      for (int c3 = 1; c3 < (N - 5) / 20 - 1; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 5) / 20 - 1; c4 += 1) {
	          for (int c6 = -2; c6 < 0; c6 += 1) {
	            for (int c9 = -(c0 % 12) + 20 * c2 + 12; c9 <= (c0 % 12) + 20 * c2 + 31; c9 += 1) {
	              for (int c10 = -(c0 % 12) + 20 * c4 + 12; c10 <= (c0 % 12) + 20 * c4 + 31; c10 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 5) / 20 - 1; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 5) / 20 - 1; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 5) / 20 - 1; c4 += 1) {
	          for (int c5 = 1; c5 <= 2; c5 += 1) {
	            for (int c6 = 1; c6 <= 2; c6 += 1) {
	              for (int c9 = -(c0 % 12) + 20 * c4 + 12; c9 <= (c0 % 12) + 20 * c4 + 31; c9 += 1) {
	      ...
	      for (int c3 = 1; c3 < (N - 5) / 20 - 1; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 5) / 20 - 1; c4 += 1) {
	          for (int c5 = -2; c5 < 0; c5 += 1) {
	            for (int c7 = -2; c7 < 0; c7 += 1) {
	              for (int c9 = -(c0 % 12) + 20 * c3 + 12; c9 <= (c0 % 12) + 20 * c3 + 31; c9 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 5) / 20 - 1; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 5) / 20 - 1; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 5) / 20 - 1; c4 += 1) {
	          for (int c7 = 1; c7 <= 2; c7 += 1) {
	            for (int c9 = -(c0 % 12) + 20 * c2 + 12; c9 <= (c0 % 12) + 20 * c2 + 31; c9 += 1) {
	              for (int c10 = -(c0 % 12) + 20 * c3 + 12; c10 <= (c0 % 12) + 20 * c3 + 31; c10 += 1) {
	  ...
	  if (c0 >= 24 && T >= c0 + 12 && c0 % 12 == 0) {
	    for (int c2 = 1; c2 < (N - 5) / 20 - 1; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 5) / 20 - 1; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 5) / 20 - 1; c4 += 1) {
	          for (int c5 = 20 * c2; c5 <= 20 * c2 + 43; c5 += 1) {
	            for (int c6 = 20 * c3; c6 <= 20 * c3 + 43; c6 += 1) {
	              for (int c7 = 20 * c4; c7 <= 20 * c4 + 43; c7 += 1) {
	  ...
	  if (T >= c0 + 24 && c0 % 12 == 0) {
	    for (int c2 = 1; c2 < (N - 5) / 20 - 1; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 5) / 20 - 1; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 5) / 20 - 1; c4 += 1) {
	          for (int c9 = 20 * c2 + 12; c9 <= 20 * c2 + 31; c9 += 1) {
	            for (int c10 = 20 * c3 + 12; c10 <= 20 * c3 + 31; c10 += 1) {
	              for (int c11 = 20 * c4 + 12; c11 <= 20 * c4 + 31; c11 += 1) {
