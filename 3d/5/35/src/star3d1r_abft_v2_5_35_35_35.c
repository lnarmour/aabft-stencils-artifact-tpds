/* star3d1r_abft_v2_5_35_35_35.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star3d1r_abft_v2_5_35_35_35 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj, tk]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N }
 *	 		C2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p <= 2 and -2 <= q <= 2 and -2 <= r <= 2 }
 *	 		I : {[tt, ti, tj, tk]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N }
 *	 		WKernel : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WCombos : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WAll : {[w]: 0 < w <= 5 }
 *	 		C2_NR : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR5 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR6 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR7 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and -2 <= r < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and -2 <= r < 0 }
 *	 		C2_NR9 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= r < 0 }
 *	 		C2_NR10 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR11 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR12 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR13 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR14 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR15 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR16 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and 0 < r <= 2 }
 *	 		C2_NR17 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and 0 < r <= 2 }
 *	 		C2_NR18 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < r <= 2 }
 *	 		C2_NR19 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR20 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR21 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= q < 0 }
 *	 		C2_NR22 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR23 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR24 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < q <= 2 }
 *	 		C2_NR25 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and -2 <= p < 0 }
 *	 		C2_NR26 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N and 0 < p <= 2 }
 *	 		C2_NR27 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N }
 *	 		I_NR : {[tt, ti, tj, tk]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 35ti <= -46 + N and tj > 0 and 35tj <= -46 + N and tk > 0 and 35tk <= -46 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj,tk] = reduce(+, (tt,ti,tj,tk,i,j,k->tt,ti,tj,tk), {: 35ti <= i <= 44 + 35ti and 35tj <= j <= 44 + 35tj and 35tk <= k <= 44 + 35tk } : Y[5tt,i,j,k]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p+w,35tj+q+w,35tk+r+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p-w+44,35tj+q+w,35tk+r+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w } : (WAll[w] * Y[5tt-w,i,35tj+q+w,35tk+r+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p+w,35tj+q-w+44,35tk+r+w]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p-w+44,35tj+q-w+44,35tk+r+w]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w } : (WAll[w] * Y[5tt-w,i,35tj+q-w+44,35tk+r+w]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tj + w <= j <= 44 + 35tj - w } : (WAll[w] * Y[5tt-w,35ti+p+w,j,35tk+r+w]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tj + w <= j <= 44 + 35tj - w } : (WAll[w] * Y[5tt-w,35ti+p-w+44,j,35tk+r+w]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w and 35tj + w <= j <= 44 + 35tj - w } : (WAll[w] * Y[5tt-w,i,j,35tk+r+w]));
 *	 		
 *	 		C2_NR10[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p+w,35tj+q+w,35tk+r-w+44]));
 *	 		
 *	 		C2_NR11[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p-w+44,35tj+q+w,35tk+r-w+44]));
 *	 		
 *	 		C2_NR12[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w } : (WAll[w] * Y[5tt-w,i,35tj+q+w,35tk+r-w+44]));
 *	 		
 *	 		C2_NR13[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p+w,35tj+q-w+44,35tk+r-w+44]));
 *	 		
 *	 		C2_NR14[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,35ti+p-w+44,35tj+q-w+44,35tk+r-w+44]));
 *	 		
 *	 		C2_NR15[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w } : (WAll[w] * Y[5tt-w,i,35tj+q-w+44,35tk+r-w+44]));
 *	 		
 *	 		C2_NR16[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tj + w <= j <= 44 + 35tj - w } : (WAll[w] * Y[5tt-w,35ti+p+w,j,35tk+r-w+44]));
 *	 		
 *	 		C2_NR17[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tj + w <= j <= 44 + 35tj - w } : (WAll[w] * Y[5tt-w,35ti+p-w+44,j,35tk+r-w+44]));
 *	 		
 *	 		C2_NR18[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w and 35tj + w <= j <= 44 + 35tj - w } : (WAll[w] * Y[5tt-w,i,j,35tk+r-w+44]));
 *	 		
 *	 		C2_NR19[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,35ti+p+w,35tj+q+w,k]));
 *	 		
 *	 		C2_NR20[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,35ti+p-w+44,35tj+q+w,k]));
 *	 		
 *	 		C2_NR21[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,i,35tj+q+w,k]));
 *	 		
 *	 		C2_NR22[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,35ti+p+w,35tj+q-w+44,k]));
 *	 		
 *	 		C2_NR23[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,35ti+p-w+44,35tj+q-w+44,k]));
 *	 		
 *	 		C2_NR24[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35ti + w <= i <= 44 + 35ti - w and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,i,35tj+q-w+44,k]));
 *	 		
 *	 		C2_NR25[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tj + w <= j <= 44 + 35tj - w and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,35ti+p+w,j,k]));
 *	 		
 *	 		C2_NR26[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 35tj + w <= j <= 44 + 35tj - w and 35tk + w <= k <= 44 + 35tk - w } : (WAll[w] * Y[5tt-w,35ti+p-w+44,j,k]));
 *	 		
 *	 		C2_NR27[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j,k->tt,ti,tj,tk,p,q,r), {: w = 5 and 5 + 35ti <= i <= 39 + 35ti and 5 + 35tj <= j <= 39 + 35tj and 5 + 35tk <= k <= 39 + 35tk } : (WAll[w] * Y[5tt-w,i,j,k]));
 *	 		
...
void inject_star3d1r_abft_v2_5_35_35_35(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star3d1r_abft_v2_5_35_35_35(double T, double N, float ***X, float ****Y)
#else
struct Result star3d1r_abft_v2_5_35_35_35(long T, long N, float ***X, float ****Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-15) + T >= ((double)0) && ((double)-81) + N >= ((double)0)) ? (((((((double)3773091) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N) - ((double)1885368) * floord(T, ((double)5))) + (((double)-5656104) + ((double)2828052) * floord(T, ((double)5))) * floord(((double)24) + N, ((double)35)) + (((double)2828052) - ((double)1414026) * floord(T, ((double)5))) * floord(((double)24) + N, ((double)35))*floord(((double)24) + N, ((double)35)) + (((double)-471342) + ((double)235671) * floord(T, ((double)5))) * floord(((double)24) + N, ((double)35))*floord(((double)24) + N, ((double)35))*floord(((double)24) + N, ((double)35)))) : ((((double)-15) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)80) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)14) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)2355) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N)) : ((double)0));
	...
	float**** I_NR = (float****)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		I_NR[tt] = (float***)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); ti++) {
			I_NR[tt][ti] = (float**)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); tj++) {
				I_NR[tt][ti][tj] = (float*)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float)));
			}
		}
	}
	
	float**** I = (float****)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		I[tt] = (float***)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); ti++) {
			I[tt][ti] = (float**)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); tj++) {
				I[tt][ti][tj] = (float*)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float)));
			}
		}
	}
	...
	float**** C1 = (float****)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		C1[tt] = (float***)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); ti++) {
			C1[tt][ti] = (float**)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); tj++) {
				C1[tt][ti][tj] = (float*)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float)));
			}
		}
	}
	...
	float******* C2 = (float*******)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0),sizeof(float******)));
	for (int tt=0; tt<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		C2[tt] = (float******)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float*****)));
		for (int ti=0; ti<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); ti++) {
			C2[tt][ti] = (float*****)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float****)));
			for (int tj=0; tj<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); tj++) {
				C2[tt][ti][tj] = (float****)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0),sizeof(float***)));
				for (int tk=0; tk<((-15 + T >= 0 && -81 + N >= 0) ? ((-2 + floord(24 + N, 35))) : 0); tk++) {
					C2[tt][ti][tj][tk] = (float***)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? (5) : 0),sizeof(float**)));
					for (int p=0; p<((-15 + T >= 0 && -81 + N >= 0) ? (5) : 0); p++) {
						C2[tt][ti][tj][tk][p] = (float**)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? (5) : 0),sizeof(float*)));
						for (int q=0; q<((-15 + T >= 0 && -81 + N >= 0) ? (5) : 0); q++) {
							C2[tt][ti][tj][tk][p][q] = (float*)(calloc(((-15 + T >= 0 && -81 + N >= 0) ? (5) : 0),sizeof(float)));
						}
					}
				}
			}
	...
	#define SC2_NR(tt,ti,tj,tk,p,q,r,w) C2_NR(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),(35*(tj) + (q) + (w)),(35*(tk) + (r) + (w))))
	#define SC2_NR10(tt,ti,tj,tk,p,q,r,w) C2_NR10(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),(35*(tj) + (q) + (w)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR11(tt,ti,tj,tk,p,q,r,w) C2_NR11(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),(35*(tj) + (q) + (w)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR12(tt,ti,tj,tk,p,q,r,w,i) C2_NR12(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(35*(tj) + (q) + (w)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR13(tt,ti,tj,tk,p,q,r,w) C2_NR13(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),(44 + 35*(tj) + (q) - (w)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR14(tt,ti,tj,tk,p,q,r,w) C2_NR14(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),(44 + 35*(tj) + (q) - (w)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR15(tt,ti,tj,tk,p,q,r,w,i) C2_NR15(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(44 + 35*(tj) + (q) - (w)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR16(tt,ti,tj,tk,p,q,r,w,j) C2_NR16(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),((j)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR17(tt,ti,tj,tk,p,q,r,w,j) C2_NR17(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),((j)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR18(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR18(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),((j)),(44 + 35*(tk) + (r) - (w))))
	#define SC2_NR19(tt,ti,tj,tk,p,q,r,w,k) C2_NR19(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),(35*(tj) + (q) + (w)),((k))))
	#define SC2_NR2(tt,ti,tj,tk,p,q,r,w) C2_NR2(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),(35*(tj) + (q) + (w)),(35*(tk) + (r) + (w))))
	#define SC2_NR20(tt,ti,tj,tk,p,q,r,w,k) C2_NR20(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),(35*(tj) + (q) + (w)),((k))))
	#define SC2_NR21(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR21(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(35*(tj) + (q) + (w)),((k))))
	#define SC2_NR22(tt,ti,tj,tk,p,q,r,w,k) C2_NR22(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),(44 + 35*(tj) + (q) - (w)),((k))))
	#define SC2_NR23(tt,ti,tj,tk,p,q,r,w,k) C2_NR23(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),(44 + 35*(tj) + (q) - (w)),((k))))
	#define SC2_NR24(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR24(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(44 + 35*(tj) + (q) - (w)),((k))))
	#define SC2_NR25(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR25(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),((j)),((k))))
	#define SC2_NR26(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR26(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),((j)),((k))))
	#define SC2_NR27(tt,ti,tj,tk,p,q,r,w,i,j,k) C2_NR27(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),((j)),((k))))
	#define SC2_NR3(tt,ti,tj,tk,p,q,r,w,i) C2_NR3(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(35*(tj) + (q) + (w)),(35*(tk) + (r) + (w))))
	#define SC2_NR4(tt,ti,tj,tk,p,q,r,w) C2_NR4(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),(44 + 35*(tj) + (q) - (w)),(35*(tk) + (r) + (w))))
	#define SC2_NR5(tt,ti,tj,tk,p,q,r,w) C2_NR5(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),(44 + 35*(tj) + (q) - (w)),(35*(tk) + (r) + (w))))
	#define SC2_NR6(tt,ti,tj,tk,p,q,r,w,i) C2_NR6(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(44 + 35*(tj) + (q) - (w)),(35*(tk) + (r) + (w))))
	#define SC2_NR7(tt,ti,tj,tk,p,q,r,w,j) C2_NR7(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(35*(ti) + (p) + (w)),((j)),(35*(tk) + (r) + (w))))
	#define SC2_NR8(tt,ti,tj,tk,p,q,r,w,j) C2_NR8(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(44 + 35*(ti) + (p) - (w)),((j)),(35*(tk) + (r) + (w))))
	#define SC2_NR9(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR9(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),((j)),(35*(tk) + (r) + (w))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j,k) do { SY_cb2_hook(t,i,j,k); if (t==5*(tt_INJ-1)+1 && i==35*ti_INJ+22 && j==35*tj_INJ+22 && k==35*tk_INJ+22) inject_star3d1r_abft_v2_5_35_35_35(&Y(t,i,j,k)); } while(0)
	#else
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (c0 >= 10 && T >= c0 + 5 && c0 % 5 == 0) {
	    for (int c2 = 1; c2 < (N - 11) / 35; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 11) / 35; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 35; c4 += 1) {
	          for (int c5 = 35 * c2; c5 <= 35 * c2 + 44; c5 += 1) {
	            for (int c6 = 35 * c3; c6 <= 35 * c3 + 44; c6 += 1) {
	              for (int c7 = 35 * c4; c7 <= 35 * c4 + 44; c7 += 1) {
	  ...
	  if (c0 >= 5 && (c0 % 5) + T >= c0 + 10) {
	      ...
	      for (int c3 = 1; c3 < (N - 11) / 35; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 35; c4 += 1) {
	          for (int c6 = -2; c6 < 0; c6 += 1) {
	            for (int c9 = -(c0 % 5) + 35 * c2 + 5; c9 <= (c0 % 5) + 35 * c2 + 39; c9 += 1) {
	              for (int c10 = -(c0 % 5) + 35 * c4 + 5; c10 <= (c0 % 5) + 35 * c4 + 39; c10 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 11) / 35; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 11) / 35; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 35; c4 += 1) {
	          for (int c5 = 1; c5 <= 2; c5 += 1) {
	            for (int c6 = 1; c6 <= 2; c6 += 1) {
	              for (int c9 = -(c0 % 5) + 35 * c4 + 5; c9 <= (c0 % 5) + 35 * c4 + 39; c9 += 1) {
	      ...
	      for (int c3 = 1; c3 < (N - 11) / 35; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 35; c4 += 1) {
	          for (int c5 = -2; c5 < 0; c5 += 1) {
	            for (int c7 = -2; c7 < 0; c7 += 1) {
	              for (int c9 = -(c0 % 5) + 35 * c3 + 5; c9 <= (c0 % 5) + 35 * c3 + 39; c9 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 11) / 35; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 11) / 35; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 35; c4 += 1) {
	          for (int c7 = 1; c7 <= 2; c7 += 1) {
	            for (int c9 = -(c0 % 5) + 35 * c2 + 5; c9 <= (c0 % 5) + 35 * c2 + 39; c9 += 1) {
	              for (int c10 = -(c0 % 5) + 35 * c3 + 5; c10 <= (c0 % 5) + 35 * c3 + 39; c10 += 1) {
	    ...
	    if (c0 % 5 == 0) {
	      for (int c2 = 1; c2 < (N - 11) / 35; c2 += 1) {
	        for (int c3 = 1; c3 < (N - 11) / 35; c3 += 1) {
	          for (int c4 = 1; c4 < (N - 11) / 35; c4 += 1) {
	            for (int c9 = 35 * c2 + 5; c9 <= 35 * c2 + 39; c9 += 1) {
	              for (int c10 = 35 * c3 + 5; c10 <= 35 * c3 + 39; c10 += 1) {
	                for (int c11 = 35 * c4 + 5; c11 <= 35 * c4 + 39; c11 += 1) {
	...
	for (int tt = 2; tt < T / 5; tt += 1) {
	  for (int ti = 1; ti < (N - 11) / 35; ti += 1) {
	    for (int tj = 1; tj < (N - 11) / 35; tj += 1) {
	      for (int tk = 1; tk < (N - 11) / 35; tk += 1) {
	        SI(tt, ti, tj, tk);
	      }
	    }
	  }
