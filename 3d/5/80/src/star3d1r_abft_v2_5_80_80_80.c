/* star3d1r_abft_v2_5_80_80_80.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star3d1r_abft_v2_5_80_80_80 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj, tk]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N }
 *	 		C2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p <= 2 and -2 <= q <= 2 and -2 <= r <= 2 }
 *	 		I : {[tt, ti, tj, tk]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N }
 *	 		WKernel : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WCombos : {[i, j, k]: -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 }
 *	 		WAll : {[w]: 0 < w <= 5 }
 *	 		C2_NR : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 and -2 <= r < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR5 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR6 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 and -2 <= r < 0 }
 *	 		C2_NR7 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= r < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= r < 0 }
 *	 		C2_NR9 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= r < 0 }
 *	 		C2_NR10 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR11 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR12 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 and 0 < r <= 2 }
 *	 		C2_NR13 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR14 : {[tt, ti, tj, tk, p, q, r]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR15 : {[tt, ti, tj, tk, p, q, r]: p = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 and 0 < r <= 2 }
 *	 		C2_NR16 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < r <= 2 }
 *	 		C2_NR17 : {[tt, ti, tj, tk, p, q, r]: q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < r <= 2 }
 *	 		C2_NR18 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < r <= 2 }
 *	 		C2_NR19 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR20 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR21 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 }
 *	 		C2_NR22 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR23 : {[tt, ti, tj, tk, p, q, r]: r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR24 : {[tt, ti, tj, tk, p, q, r]: p = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 }
 *	 		C2_NR25 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 }
 *	 		C2_NR26 : {[tt, ti, tj, tk, p, q, r]: q = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 }
 *	 		C2_NR27 : {[tt, ti, tj, tk, p, q, r]: p = 0 and q = 0 and r = 0 and tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N }
 *	 		I_NR : {[tt, ti, tj, tk]: tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj,tk] = reduce(+, (tt,ti,tj,tk,i,j,k->tt,ti,tj,tk), {: 80ti <= i <= 89 + 80ti and 80tj <= j <= 89 + 80tj and 80tk <= k <= 89 + 80tk } : Y[5tt,i,j,k]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p+w,80tj+q+w,80tk+r+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p-w+89,80tj+q+w,80tk+r+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w } : (WAll[w] * Y[5tt-w,i,80tj+q+w,80tk+r+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p+w,80tj+q-w+89,80tk+r+w]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p-w+89,80tj+q-w+89,80tk+r+w]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w } : (WAll[w] * Y[5tt-w,i,80tj+q-w+89,80tk+r+w]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w } : (WAll[w] * Y[5tt-w,80ti+p+w,j,80tk+r+w]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w } : (WAll[w] * Y[5tt-w,80ti+p-w+89,j,80tk+r+w]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tj + w <= j <= 89 + 80tj - w } : (WAll[w] * Y[5tt-w,i,j,80tk+r+w]));
 *	 		
 *	 		C2_NR10[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p+w,80tj+q+w,80tk+r-w+89]));
 *	 		
 *	 		C2_NR11[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p-w+89,80tj+q+w,80tk+r-w+89]));
 *	 		
 *	 		C2_NR12[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w } : (WAll[w] * Y[5tt-w,i,80tj+q+w,80tk+r-w+89]));
 *	 		
 *	 		C2_NR13[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p+w,80tj+q-w+89,80tk+r-w+89]));
 *	 		
 *	 		C2_NR14[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w->tt,ti,tj,tk,p,q,r), (WAll[w] * Y[5tt-w,80ti+p-w+89,80tj+q-w+89,80tk+r-w+89]));
 *	 		
 *	 		C2_NR15[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w } : (WAll[w] * Y[5tt-w,i,80tj+q-w+89,80tk+r-w+89]));
 *	 		
 *	 		C2_NR16[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w } : (WAll[w] * Y[5tt-w,80ti+p+w,j,80tk+r-w+89]));
 *	 		
 *	 		C2_NR17[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w } : (WAll[w] * Y[5tt-w,80ti+p-w+89,j,80tk+r-w+89]));
 *	 		
 *	 		C2_NR18[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tj + w <= j <= 89 + 80tj - w } : (WAll[w] * Y[5tt-w,i,j,80tk+r-w+89]));
 *	 		
 *	 		C2_NR19[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,80ti+p+w,80tj+q+w,k]));
 *	 		
 *	 		C2_NR20[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,80ti+p-w+89,80tj+q+w,k]));
 *	 		
 *	 		C2_NR21[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,i,80tj+q+w,k]));
 *	 		
 *	 		C2_NR22[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,80ti+p+w,80tj+q-w+89,k]));
 *	 		
 *	 		C2_NR23[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,80ti+p-w+89,80tj+q-w+89,k]));
 *	 		
 *	 		C2_NR24[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,i,80tj+q-w+89,k]));
 *	 		
 *	 		C2_NR25[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,80ti+p+w,j,k]));
 *	 		
 *	 		C2_NR26[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,j,k->tt,ti,tj,tk,p,q,r), {: 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w and 80tk + w <= k <= 89 + 80tk - w } : (WAll[w] * Y[5tt-w,80ti+p-w+89,j,k]));
 *	 		
 *	 		C2_NR27[tt,ti,tj,tk,p,q,r] = reduce(+, (tt,ti,tj,tk,p,q,r,w,i,j,k->tt,ti,tj,tk,p,q,r), {: w = 5 and 5 + 80ti <= i <= 84 + 80ti and 5 + 80tj <= j <= 84 + 80tj and 5 + 80tk <= k <= 84 + 80tk } : (WAll[w] * Y[5tt-w,i,j,k]));
 *	 		
...
void inject_star3d1r_abft_v2_5_80_80_80(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star3d1r_abft_v2_5_80_80_80(double T, double N, float ***X, float ****Y)
#else
struct Result star3d1r_abft_v2_5_80_80_80(long T, long N, float ***X, float ****Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-15) + T >= ((double)0) && ((double)-171) + N >= ((double)0)) ? (((((((double)26971491) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N) - ((double)13484568) * floord(T, ((double)5))) + (((double)-40453704) + ((double)20226852) * floord(T, ((double)5))) * floord(((double)69) + N, ((double)80)) + (((double)20226852) - ((double)10113426) * floord(T, ((double)5))) * floord(((double)69) + N, ((double)80))*floord(((double)69) + N, ((double)80)) + (((double)-3371142) + ((double)1685571) * floord(T, ((double)5))) * floord(((double)69) + N, ((double)80))*floord(((double)69) + N, ((double)80))*floord(((double)69) + N, ((double)80)))) : ((((double)-15) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)170) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)14) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)2355) + T) + (((double)3) + ((double)3) * T) * N + (((double)3) + ((double)3) * T) * N*N + (((double)1) + T) * N*N*N)) : ((double)0));
	...
	float**** I_NR = (float****)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(T, 5))) : 0),sizeof(float***)));
	for (int tt=0; tt<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		I_NR[tt] = (float***)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); ti++) {
			I_NR[tt][ti] = (float**)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); tj++) {
				I_NR[tt][ti][tj] = (float*)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float)));
			}
		}
	}
	...
	for (int tt=0; tt<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		I[tt] = (float***)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); ti++) {
			I[tt][ti] = (float**)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); tj++) {
				I[tt][ti][tj] = (float*)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float)));
			}
		}
	}
	...
	for (int tt=0; tt<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		C1[tt] = (float***)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float**)));
		for (int ti=0; ti<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); ti++) {
			C1[tt][ti] = (float**)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float*)));
			for (int tj=0; tj<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); tj++) {
				C1[tt][ti][tj] = (float*)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float)));
			}
		}
	}
	...
	for (int tt=0; tt<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(T, 5))) : 0); tt++) {
		C2[tt] = (float******)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float*****)));
		for (int ti=0; ti<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); ti++) {
			C2[tt][ti] = (float*****)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float****)));
			for (int tj=0; tj<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); tj++) {
				C2[tt][ti][tj] = (float****)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0),sizeof(float***)));
				for (int tk=0; tk<((-15 + T >= 0 && -171 + N >= 0) ? ((-2 + floord(69 + N, 80))) : 0); tk++) {
					C2[tt][ti][tj][tk] = (float***)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? (5) : 0),sizeof(float**)));
					for (int p=0; p<((-15 + T >= 0 && -171 + N >= 0) ? (5) : 0); p++) {
						C2[tt][ti][tj][tk][p] = (float**)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? (5) : 0),sizeof(float*)));
						for (int q=0; q<((-15 + T >= 0 && -171 + N >= 0) ? (5) : 0); q++) {
							C2[tt][ti][tj][tk][p][q] = (float*)(calloc(((-15 + T >= 0 && -171 + N >= 0) ? (5) : 0),sizeof(float)));
						}
					}
				}
			}
	...
	#define SC2_NR(tt,ti,tj,tk,p,q,r,w) C2_NR(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),(80*(tj) + (q) + (w)),(80*(tk) + (r) + (w))))
	#define SC2_NR10(tt,ti,tj,tk,p,q,r,w) C2_NR10(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),(80*(tj) + (q) + (w)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR11(tt,ti,tj,tk,p,q,r,w) C2_NR11(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),(80*(tj) + (q) + (w)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR12(tt,ti,tj,tk,p,q,r,w,i) C2_NR12(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(80*(tj) + (q) + (w)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR13(tt,ti,tj,tk,p,q,r,w) C2_NR13(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),(89 + 80*(tj) + (q) - (w)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR14(tt,ti,tj,tk,p,q,r,w) C2_NR14(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),(89 + 80*(tj) + (q) - (w)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR15(tt,ti,tj,tk,p,q,r,w,i) C2_NR15(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(89 + 80*(tj) + (q) - (w)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR16(tt,ti,tj,tk,p,q,r,w,j) C2_NR16(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),((j)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR17(tt,ti,tj,tk,p,q,r,w,j) C2_NR17(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),((j)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR18(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR18(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),((j)),(89 + 80*(tk) + (r) - (w))))
	#define SC2_NR19(tt,ti,tj,tk,p,q,r,w,k) C2_NR19(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),(80*(tj) + (q) + (w)),((k))))
	#define SC2_NR2(tt,ti,tj,tk,p,q,r,w) C2_NR2(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),(80*(tj) + (q) + (w)),(80*(tk) + (r) + (w))))
	#define SC2_NR20(tt,ti,tj,tk,p,q,r,w,k) C2_NR20(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),(80*(tj) + (q) + (w)),((k))))
	#define SC2_NR21(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR21(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(80*(tj) + (q) + (w)),((k))))
	#define SC2_NR22(tt,ti,tj,tk,p,q,r,w,k) C2_NR22(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),(89 + 80*(tj) + (q) - (w)),((k))))
	#define SC2_NR23(tt,ti,tj,tk,p,q,r,w,k) C2_NR23(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),(89 + 80*(tj) + (q) - (w)),((k))))
	#define SC2_NR24(tt,ti,tj,tk,p,q,r,w,i,k) C2_NR24(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(89 + 80*(tj) + (q) - (w)),((k))))
	#define SC2_NR25(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR25(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),((j)),((k))))
	#define SC2_NR26(tt,ti,tj,tk,p,q,r,w,j,k) C2_NR26(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),((j)),((k))))
	#define SC2_NR27(tt,ti,tj,tk,p,q,r,w,i,j,k) C2_NR27(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),((j)),((k))))
	#define SC2_NR3(tt,ti,tj,tk,p,q,r,w,i) C2_NR3(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(80*(tj) + (q) + (w)),(80*(tk) + (r) + (w))))
	#define SC2_NR4(tt,ti,tj,tk,p,q,r,w) C2_NR4(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),(89 + 80*(tj) + (q) - (w)),(80*(tk) + (r) + (w))))
	#define SC2_NR5(tt,ti,tj,tk,p,q,r,w) C2_NR5(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),(89 + 80*(tj) + (q) - (w)),(80*(tk) + (r) + (w))))
	#define SC2_NR6(tt,ti,tj,tk,p,q,r,w,i) C2_NR6(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),(89 + 80*(tj) + (q) - (w)),(80*(tk) + (r) + (w))))
	#define SC2_NR7(tt,ti,tj,tk,p,q,r,w,j) C2_NR7(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(80*(ti) + (p) + (w)),((j)),(80*(tk) + (r) + (w))))
	#define SC2_NR8(tt,ti,tj,tk,p,q,r,w,j) C2_NR8(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),(89 + 80*(ti) + (p) - (w)),((j)),(80*(tk) + (r) + (w))))
	#define SC2_NR9(tt,ti,tj,tk,p,q,r,w,i,j) C2_NR9(tt,ti,tj,tk,p,q,r) += (WAll(((w)))) * (Y((5*(tt) - (w)),((i)),((j)),(80*(tk) + (r) + (w))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j,k) do { SY_cb2_hook(t,i,j,k); if (t==5*(tt_INJ-1)+1 && i==80*ti_INJ+45 && j==80*tj_INJ+45 && k==80*tk_INJ+45) inject_star3d1r_abft_v2_5_80_80_80(&Y(t,i,j,k)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb25[tt, ti, tj, tk, p, q = 0, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2; SC2_NR16[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < r <= 2 and 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w; SC2_cb1[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0; SC2_cb24[tt, ti, tj, tk, p, q = 0, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0; SC2_cb21[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2; SC2_NR14[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 5; SC2_cb23[tt, ti, tj, tk, p = 0, q, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2; SW[i, j, k] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 and -1 <= k <= 1; SC2_cb16[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < r <= 2; SC2_NR15[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w; SC2_NR24[tt, ti, tj, tk, p = 0, q, r = 0, w, i, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tk + w <= k <= 89 + 80tk - w; SC2_cb13[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < r <= 2; SC2_cb18[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0; SY_cb2[t, i, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N and 0 < k < N; SC2_cb4[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 5; SWKernel[i, j, k] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2; SC2_NR9[tt, ti, tj, tk, p = 0, q = 0, r, w, i, j] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= r < 0 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tj + w <= j <= 89 + 80tj - w; SC2_cb0[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0; SC2_cb20[tt, ti, tj, tk, p = 0, q, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0; SC2_cb11[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 and 0 < r <= 2; SI_NR[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p <= 2 and -2 <= q <= 2 and -2 <= r <= 2; SY_cb1[t, i, j, k = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= j <= N; SY_cb1[t, i, j = N, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= k <= N; SY_cb1[t, i = N, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N and 0 <= k <= N; SY_cb1[t, i, j, k = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= j <= N; SY_cb1[t, i, j = 0, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N and 0 <= k <= N; SY_cb1[t, i = 0, j, k] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N and 0 <= k <= N; SC2_NR17[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < r <= 2 and 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w; SC2_NR12[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w; SC2_NR21[tt, ti, tj, tk, p = 0, q, r = 0, w, i, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tk + w <= k <= 89 + 80tk - w; SC2_NR13[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2 and 0 < w <= 5; SC2_NR25[tt, ti, tj, tk, p, q = 0, r = 0, w, j, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w and 80tk + w <= k <= 89 + 80tk - w; SC2_cb22[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2; SC2_NR18[tt, ti, tj, tk, p = 0, q = 0, r, w, i, j] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < r <= 2 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w and 80tj + w <= j <= 89 + 80tj - w; SC2_NR23[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w; SC2_NR27[tt, ti, tj, tk, p = 0, q = 0, r = 0, w = 5, i, j, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 5 + 80ti <= i <= 84 + 80ti and 5 + 80tj <= j <= 84 + 80tj and 5 + 80tk <= k <= 84 + 80tk; SC2_NR2[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 5; SC2_NR4[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 5; SWCombos[i, j, k, p, q, r] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and -2 <= k <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j and r >= -2 + k and -1 <= r <= 1 and r <= 2 + k; SC2_cb2[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 and -2 <= r < 0; SC2_cb6[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= r < 0; SC2_cb9[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2; SC2_cb7[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= r < 0; SC2_NR26[tt, ti, tj, tk, p, q = 0, r = 0, w, j, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w and 80tk + w <= k <= 89 + 80tk - w; SC2_cb15[tt, ti, tj, tk, p, q = 0, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < r <= 2; SC2_cb8[tt, ti, tj, tk, p = 0, q = 0, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= r < 0; SC2_cb3[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 and -2 <= r < 0; SC2_NR10[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 5; SC2_NR5[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 5; SC2_cb19[tt, ti, tj, tk, p, q, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb17[tt, ti, tj, tk, p = 0, q = 0, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < r <= 2; SC2_NR11[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2 and 0 < w <= 5; SC2_NR[tt, ti, tj, tk, p, q, r, w] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 5; SC2_cb12[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < r <= 2; SC2_NR8[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= r < 0 and 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w; SC2_NR7[tt, ti, tj, tk, p, q = 0, r, w, j] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= r < 0 and 0 < w <= 5 and 80tj + w <= j <= 89 + 80tj - w; SC1[tt, ti, tj, tk, i, j, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 80ti <= i <= 89 + 80ti and 80tj <= j <= 89 + 80tj and 80tk <= k <= 89 + 80tk; SC2_cb5[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 and -2 <= r < 0; SI[tt, ti, tj, tk] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N; SC2_cb10[tt, ti, tj, tk, p, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < r <= 2; SC2_NR22[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w; SC2_NR3[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= q < 0 and -2 <= r < 0 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w; SY_cb0[t, i, j, k] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N and 0 <= k <= N; SC2_cb26[tt, ti, tj, tk, p = 0, q = 0, r = 0] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N; SC2_NR19[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w; SC2_cb14[tt, ti, tj, tk, p = 0, q, r] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 and 0 < r <= 2; SC2_NR6[tt, ti, tj, tk, p = 0, q, r, w, i] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < q <= 2 and -2 <= r < 0 and 0 < w <= 5 and 80ti + w <= i <= 89 + 80ti - w; SC2_NR20[tt, ti, tj, tk, p, q, r = 0, w, k] : tt >= 2 and 5tt <= -5 + T and ti > 0 and 80ti <= -91 + N and tj > 0 and 80tj <= -91 + N and tk > 0 and 80tk <= -91 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 5 and 80tk + w <= k <= 89 + 80tk - w }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j, k] }"
	 *   - filter: "{ SWKernel[i, j, k] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (c0 >= 10 && T >= c0 + 5 && c0 % 5 == 0) {
	    for (int c2 = 1; c2 < (N - 11) / 80; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 11) / 80; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 80; c4 += 1) {
	          for (int c5 = 80 * c2; c5 <= 80 * c2 + 89; c5 += 1) {
	            for (int c6 = 80 * c3; c6 <= 80 * c3 + 89; c6 += 1) {
	              for (int c7 = 80 * c4; c7 <= 80 * c4 + 89; c7 += 1) {
	  ...
	  if (c0 >= 5 && (c0 % 5) + T >= c0 + 10) {
	      ...
	      for (int c3 = 1; c3 < (N - 11) / 80; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 80; c4 += 1) {
	          for (int c6 = -2; c6 < 0; c6 += 1) {
	            for (int c9 = -(c0 % 5) + 80 * c2 + 5; c9 <= (c0 % 5) + 80 * c2 + 84; c9 += 1) {
	              for (int c10 = -(c0 % 5) + 80 * c4 + 5; c10 <= (c0 % 5) + 80 * c4 + 84; c10 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 11) / 80; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 11) / 80; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 80; c4 += 1) {
	          for (int c5 = 1; c5 <= 2; c5 += 1) {
	            for (int c6 = 1; c6 <= 2; c6 += 1) {
	              for (int c9 = -(c0 % 5) + 80 * c4 + 5; c9 <= (c0 % 5) + 80 * c4 + 84; c9 += 1) {
	      ...
	      for (int c3 = 1; c3 < (N - 11) / 80; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 80; c4 += 1) {
	          for (int c5 = -2; c5 < 0; c5 += 1) {
	            for (int c7 = -2; c7 < 0; c7 += 1) {
	              for (int c9 = -(c0 % 5) + 80 * c3 + 5; c9 <= (c0 % 5) + 80 * c3 + 84; c9 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 11) / 80; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 11) / 80; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 11) / 80; c4 += 1) {
	          for (int c7 = 1; c7 <= 2; c7 += 1) {
	            for (int c9 = -(c0 % 5) + 80 * c2 + 5; c9 <= (c0 % 5) + 80 * c2 + 84; c9 += 1) {
	              for (int c10 = -(c0 % 5) + 80 * c3 + 5; c10 <= (c0 % 5) + 80 * c3 + 84; c10 += 1) {
	    ...
	    if (c0 % 5 == 0) {
	      for (int c2 = 1; c2 < (N - 11) / 80; c2 += 1) {
	        for (int c3 = 1; c3 < (N - 11) / 80; c3 += 1) {
	          for (int c4 = 1; c4 < (N - 11) / 80; c4 += 1) {
	            for (int c9 = 80 * c2 + 5; c9 <= 80 * c2 + 84; c9 += 1) {
	              for (int c10 = 80 * c3 + 5; c10 <= 80 * c3 + 84; c10 += 1) {
	                for (int c11 = 80 * c4 + 5; c11 <= 80 * c4 + 84; c11 += 1) {
	...
	for (int tt = 2; tt < T / 5; tt += 1) {
	  for (int ti = 1; ti < (N - 11) / 80; ti += 1) {
	    for (int tj = 1; tj < (N - 11) / 80; tj += 1) {
	      for (int tk = 1; tk < (N - 11) / 80; tk += 1) {
	        SI(tt, ti, tj, tk);
	      }
	    }
	  }
