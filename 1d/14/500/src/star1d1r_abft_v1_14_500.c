/* star1d1r_abft_v1_14_500.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_14_500 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 500ti <= -501 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 500ti <= -501 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 500ti <= -501 + N }
 *	 		patch : {[w, i]: 0 <= w <= 14 and -1 - w <= i <= 500 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 14 and -1 - w <= i <= 500 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 500ti <= i <= 499 + 500ti } : Y[14tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[14,p] * Y[14tt-14,500ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_14_500(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_14_500(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_14_500(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-42) + T >= ((double)0) && ((double)-1015) + N >= ((double)0)) ? ((((((((double)33498) + T) + (((double)1) + T) * N) - ((double)2062) * floord(T, ((double)14))) + ((((double)472) + ((double)2) * N) + (((double)-236) - N) * floord(T, ((double)14))) * floord(((double)485) + N, ((double)500)) + (((double)-500) + ((double)250) * floord(T, ((double)14))) * floord(((double)485) + N, ((double)500))*floord(((double)485) + N, ((double)500))) + ((((double)-2534) - ((double)2) * N) + (((double)1267) + N) * floord(T, ((double)14))) * floord(((double)499) + N, ((double)500)) + (((double)500) - ((double)250) * floord(T, ((double)14))) * floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500)))) : (((double)-42) + T >= ((double)0) && ((double)-1001) + N >= ((double)0) && ((double)1014) - N >= ((double)0)) ? ((((((double)29340) + T) + (((double)-1) + T) * N) + (((double)17) + N) * floord(T, ((double)14)))) : ((((double)-42) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1000) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)41) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)29374) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((14),((p)))) * (Y((-14 + 14*(tt)),(500*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==14*(tt_INJ-1)+1 && i==500*ti_INJ+250) inject_star1d1r_abft_v1_14_500(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 14 * c0); c1 <= min(T, 14 * c0 + 13); c1 += 1) {
	    ...
	    if (T >= 14 * c0 + 28 && c1 == 14 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 500; c3 += 1) {
	        for (int c4 = -15; c4 <= min(514, N - 500 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
