/* star1d1r_abft_v1_2_950.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_2_950 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 950ti <= -951 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 950ti <= -951 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 950ti <= -951 + N }
 *	 		patch : {[w, i]: 0 <= w <= 2 and -1 - w <= i <= 950 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 2 and -1 - w <= i <= 950 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 950ti <= i <= 949 + 950ti } : Y[2tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[2,p] * Y[2tt-2,950ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_2_950(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_2_950(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_2_950(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-10) + T >= ((double)0) && ((double)-1902) + N >= ((double)0)) ? ((((((((double)16212) + T) + (((double)1) + T) * N) - ((double)3814) * floord(T, ((double)2))) + ((((double)946) + ((double)2) * N) + (((double)-473) - N) * floord(T, ((double)2))) * floord(((double)947) + N, ((double)950)) + (((double)-950) + ((double)475) * floord(T, ((double)2))) * floord(((double)947) + N, ((double)950))*floord(((double)947) + N, ((double)950))) + ((((double)-4760) - ((double)2) * N) + (((double)2380) + N) * floord(T, ((double)2))) * floord(((double)949) + N, ((double)950)) + (((double)950) - ((double)475) * floord(T, ((double)2))) * floord(((double)949) + N, ((double)950))*floord(((double)949) + N, ((double)950)))) : (((double)-1901) + N == ((double)0) && ((double)-10) + T >= ((double)0)) ? (((((double)6673) + ((double)1902) * T) + ((double)1906) * floord(T, ((double)2)))) : (((double)-10) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1900) - N >= ((double)0)) ? (((((double)8584) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(3); w++) {
		patch[w] = (float*)(calloc((956),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(949 + N, 950))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((2),sizeof(float*)));
	for (int w=0; w<(2); w++) {
		patch_NR[w] = (float*)(calloc((956),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(949 + N, 950))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-6 + T >= 0 && -1901 + N >= 0) ? ((-2 + floord(949 + N, 950))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((2*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((2),((p)))) * (Y((-2 + 2*(tt)),(950*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==2*(tt_INJ-1)+1 && i==950*ti_INJ+475) inject_star1d1r_abft_v1_2_950(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = 2 * c0; c1 <= min(T, 2 * c0 + 1); c1 += 1) {
	    ...
	    if (T >= 2 * c0 + 4 && c1 == 2 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 950; c3 += 1) {
	        for (int c4 = -3; c4 <= min(952, N - 950 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
