/* star1d1r_abft_v1_2_50.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_2_50 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 50ti <= -51 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 50ti <= -51 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 50ti <= -51 + N }
 *	 		patch : {[w, i]: 0 <= w <= 2 and -1 - w <= i <= 50 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 2 and -1 - w <= i <= 50 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 50ti <= i <= 49 + 50ti } : Y[2tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[2,p] * Y[2tt-2,50ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_2_50(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_2_50(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_2_50(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-10) + T >= ((double)0) && ((double)-102) + N >= ((double)0)) ? ((((((((double)912) + T) + (((double)1) + T) * N) - ((double)214) * floord(T, ((double)2))) + ((((double)46) + ((double)2) * N) + (((double)-23) - N) * floord(T, ((double)2))) * floord(((double)47) + N, ((double)50)) + (((double)-50) + ((double)25) * floord(T, ((double)2))) * floord(((double)47) + N, ((double)50))*floord(((double)47) + N, ((double)50))) + ((((double)-260) - ((double)2) * N) + (((double)130) + N) * floord(T, ((double)2))) * floord(((double)49) + N, ((double)50)) + (((double)50) - ((double)25) * floord(T, ((double)2))) * floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50)))) : (((double)-101) + N == ((double)0) && ((double)-10) + T >= ((double)0)) ? (((((double)373) + ((double)102) * T) + ((double)106) * floord(T, ((double)2)))) : (((double)-10) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)100) - N >= ((double)0)) ? (((((double)484) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((2),((p)))) * (Y((-2 + 2*(tt)),(50*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==2*(tt_INJ-1)+1 && i==50*ti_INJ+25) inject_star1d1r_abft_v1_2_50(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = 2 * c0; c1 <= min(T, 2 * c0 + 1); c1 += 1) {
	    ...
	    if (T >= 2 * c0 + 4 && c1 == 2 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 50; c3 += 1) {
	        for (int c4 = -3; c4 <= min(52, N - 50 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
