/* star1d1r_abft_v1_2_700.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_2_700 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 700ti <= -701 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 700ti <= -701 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 700ti <= -701 + N }
 *	 		patch : {[w, i]: 0 <= w <= 2 and -1 - w <= i <= 700 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 2 and -1 - w <= i <= 700 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 700ti <= i <= 699 + 700ti } : Y[2tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[2,p] * Y[2tt-2,700ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_2_700(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_2_700(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_2_700(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-10) + T >= ((double)0) && ((double)-1402) + N >= ((double)0)) ? ((((((((double)11962) + T) + (((double)1) + T) * N) - ((double)2814) * floord(T, ((double)2))) + ((((double)696) + ((double)2) * N) + (((double)-348) - N) * floord(T, ((double)2))) * floord(((double)697) + N, ((double)700)) + (((double)-700) + ((double)350) * floord(T, ((double)2))) * floord(((double)697) + N, ((double)700))*floord(((double)697) + N, ((double)700))) + ((((double)-3510) - ((double)2) * N) + (((double)1755) + N) * floord(T, ((double)2))) * floord(((double)699) + N, ((double)700)) + (((double)700) - ((double)350) * floord(T, ((double)2))) * floord(((double)699) + N, ((double)700))*floord(((double)699) + N, ((double)700)))) : (((double)-1401) + N == ((double)0) && ((double)-10) + T >= ((double)0)) ? (((((double)4923) + ((double)1402) * T) + ((double)1406) * floord(T, ((double)2)))) : (((double)-10) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1400) - N >= ((double)0)) ? (((((double)6334) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(3); w++) {
		patch[w] = (float*)(calloc((706),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(699 + N, 700))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((2),sizeof(float*)));
	for (int w=0; w<(2); w++) {
		patch_NR[w] = (float*)(calloc((706),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(699 + N, 700))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-6 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(699 + N, 700))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((2*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((2),((p)))) * (Y((-2 + 2*(tt)),(700*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==2*(tt_INJ-1)+1 && i==700*ti_INJ+350) inject_star1d1r_abft_v1_2_700(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = 2 * c0; c1 <= min(T, 2 * c0 + 1); c1 += 1) {
	    ...
	    if (T >= 2 * c0 + 4 && c1 == 2 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 700; c3 += 1) {
	        for (int c4 = -3; c4 <= min(702, N - 700 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
