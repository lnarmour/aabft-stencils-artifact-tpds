/* star1d1r_abft_v1_2_500.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_2_500 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 500ti <= -501 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 500ti <= -501 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 500ti <= -501 + N }
 *	 		patch : {[w, i]: 0 <= w <= 2 and -1 - w <= i <= 500 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 2 and -1 - w <= i <= 500 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 500ti <= i <= 499 + 500ti } : Y[2tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[2,p] * Y[2tt-2,500ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_2_500(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_2_500(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_2_500(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-10) + T >= ((double)0) && ((double)-1002) + N >= ((double)0)) ? ((((((((double)8562) + T) + (((double)1) + T) * N) - ((double)2014) * floord(T, ((double)2))) + ((((double)496) + ((double)2) * N) + (((double)-248) - N) * floord(T, ((double)2))) * floord(((double)497) + N, ((double)500)) + (((double)-500) + ((double)250) * floord(T, ((double)2))) * floord(((double)497) + N, ((double)500))*floord(((double)497) + N, ((double)500))) + ((((double)-2510) - ((double)2) * N) + (((double)1255) + N) * floord(T, ((double)2))) * floord(((double)499) + N, ((double)500)) + (((double)500) - ((double)250) * floord(T, ((double)2))) * floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500)))) : (((double)-1001) + N == ((double)0) && ((double)-10) + T >= ((double)0)) ? (((((double)3523) + ((double)1002) * T) + ((double)1006) * floord(T, ((double)2)))) : (((double)-10) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1000) - N >= ((double)0)) ? (((((double)4534) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((2),((p)))) * (Y((-2 + 2*(tt)),(500*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==2*(tt_INJ-1)+1 && i==500*ti_INJ+250) inject_star1d1r_abft_v1_2_500(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = 2 * c0; c1 <= min(T, 2 * c0 + 1); c1 += 1) {
	    ...
	    if (T >= 2 * c0 + 4 && c1 == 2 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 500; c3 += 1) {
	        for (int c4 = -3; c4 <= min(502, N - 500 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
