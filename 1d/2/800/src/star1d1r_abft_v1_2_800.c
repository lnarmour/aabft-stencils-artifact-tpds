/* star1d1r_abft_v1_2_800.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_2_800 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 800ti <= -801 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 800ti <= -801 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 2tt <= -2 + T and ti > 0 and 800ti <= -801 + N }
 *	 		patch : {[w, i]: 0 <= w <= 2 and -1 - w <= i <= 800 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 2 and -1 - w <= i <= 800 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 800ti <= i <= 799 + 800ti } : Y[2tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[2,p] * Y[2tt-2,800ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_2_800(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_2_800(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_2_800(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-10) + T >= ((double)0) && ((double)-1602) + N >= ((double)0)) ? ((((((((double)13662) + T) + (((double)1) + T) * N) - ((double)3214) * floord(T, ((double)2))) + ((((double)796) + ((double)2) * N) + (((double)-398) - N) * floord(T, ((double)2))) * floord(((double)797) + N, ((double)800)) + (((double)-800) + ((double)400) * floord(T, ((double)2))) * floord(((double)797) + N, ((double)800))*floord(((double)797) + N, ((double)800))) + ((((double)-4010) - ((double)2) * N) + (((double)2005) + N) * floord(T, ((double)2))) * floord(((double)799) + N, ((double)800)) + (((double)800) - ((double)400) * floord(T, ((double)2))) * floord(((double)799) + N, ((double)800))*floord(((double)799) + N, ((double)800)))) : (((double)-1601) + N == ((double)0) && ((double)-10) + T >= ((double)0)) ? (((((double)5623) + ((double)1602) * T) + ((double)1606) * floord(T, ((double)2)))) : (((double)-10) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1600) - N >= ((double)0)) ? (((((double)7234) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(3); w++) {
		patch[w] = (float*)(calloc((806),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(799 + N, 800))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((2),sizeof(float*)));
	for (int w=0; w<(2); w++) {
		patch_NR[w] = (float*)(calloc((806),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(799 + N, 800))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(T, 2))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(T, 2))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-6 + T >= 0 && -1601 + N >= 0) ? ((-2 + floord(799 + N, 800))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((2*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((2),((p)))) * (Y((-2 + 2*(tt)),(800*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==2*(tt_INJ-1)+1 && i==800*ti_INJ+400) inject_star1d1r_abft_v1_2_800(&Y(t,i)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SY_cb0[t, i] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N; SI[tt, ti] : T >= 10 and tt >= 2 and 2tt <= -2 + T and ti > 0 and 800ti <= -801 + N; SC1[tt, ti, i] : T >= 10 and tt >= 2 and 2tt <= -2 + T and ti > 0 and 800ti <= -801 + N and 800ti <= i <= 799 + 800ti; SC2[tt, ti, p] : T >= 10 and tt >= 2 and 2tt <= -2 + T and ti > 0 and 800ti <= -801 + N and -3 <= p <= 802 and p <= N - 800ti; Spatch_NR[w, i, p] : T >= 10 and N >= 20 and 0 < w <= 2 and p >= -1 and -799 - w + i <= p <= 1 and p <= w + i; Spatch[w, i] : T >= 10 and N >= 20 and 0 <= w <= 2 and -1 - w <= i <= 800 + w; SY_cb2[t, i] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N; SY_cb1[t, i = N] : T >= 10 and N >= 20 and 2 <= t <= T; SY_cb1[t, i = 0] : T >= 10 and N >= 20 and 2 <= t <= T; SW[i] : T >= 10 and N >= 20 and -1 <= i <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i] }"
	 *   - filter: "{ Spatch[w, i]; Spatch_NR[w, i, p] }"
	  ...
	  for (int c1 = 2 * c0; c1 <= min(T, 2 * c0 + 1); c1 += 1) {
	    ...
	    if (T >= 2 * c0 + 4 && c1 == 2 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 800; c3 += 1) {
	        for (int c4 = -3; c4 <= min(802, N - 800 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
