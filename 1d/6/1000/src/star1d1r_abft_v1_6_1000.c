/* star1d1r_abft_v1_6_1000.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_6_1000 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 1000ti <= -1001 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 1000ti <= -1001 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 1000ti <= -1001 + N }
 *	 		patch : {[w, i]: 0 <= w <= 6 and -1 - w <= i <= 1000 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 6 and -1 - w <= i <= 1000 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 1000ti <= i <= 999 + 1000ti } : Y[6tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[6,p] * Y[6tt-6,1000ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_6_1000(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
#endif
{
	...
	double total_card = ((((double)-18) + T >= ((double)0) && ((double)-2007) + N >= ((double)0)) ? ((((((((double)33246) + T) + (((double)1) + T) * N) - ((double)4030) * floord(T, ((double)6))) + ((((double)988) + ((double)2) * N) + (((double)-494) - N) * floord(T, ((double)6))) * floord(((double)993) + N, ((double)1000)) + (((double)-1000) + ((double)500) * floord(T, ((double)6))) * floord(((double)993) + N, ((double)1000))*floord(((double)993) + N, ((double)1000))) + ((((double)-5018) - ((double)2) * N) + (((double)2509) + N) * floord(T, ((double)6))) * floord(((double)999) + N, ((double)1000)) + (((double)1000) - ((double)500) * floord(T, ((double)6))) * floord(((double)999) + N, ((double)1000))*floord(((double)999) + N, ((double)1000)))) : (((double)-18) + T >= ((double)0) && ((double)-2001) + N >= ((double)0) && ((double)2006) - N >= ((double)0)) ? ((((((double)25168) + T) + (((double)-1) + T) * N) + (((double)9) + N) * floord(T, ((double)6)))) : ((((double)-18) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)2000) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)17) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)25186) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(7); w++) {
		patch[w] = (float*)(calloc((1014),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(999 + N, 1000))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((6),sizeof(float*)));
	for (int w=0; w<(6); w++) {
		patch_NR[w] = (float*)(calloc((1014),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(999 + N, 1000))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-18 + T >= 0 && -2001 + N >= 0) ? ((-2 + floord(999 + N, 1000))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((6*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((6),((p)))) * (Y((-6 + 6*(tt)),(1000*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==6*(tt_INJ-1)+1 && i==1000*ti_INJ+500) inject_star1d1r_abft_v1_6_1000(&Y(t,i)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SY_cb0[t, i] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N; SI[tt, ti] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 1000ti <= -1001 + N; SC1[tt, ti, i] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 1000ti <= -1001 + N and 1000ti <= i <= 999 + 1000ti; SC2[tt, ti, p] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 1000ti <= -1001 + N and -7 <= p <= 1006 and p <= N - 1000ti; Spatch_NR[w, i, p] : T >= 10 and N >= 20 and 0 < w <= 6 and p >= -1 and -999 - w + i <= p <= 1 and p <= w + i; Spatch[w, i] : T >= 10 and N >= 20 and 0 <= w <= 6 and -1 - w <= i <= 1000 + w; SY_cb2[t, i] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N; SY_cb1[t, i = N] : T >= 10 and N >= 20 and 2 <= t <= T; SY_cb1[t, i = 0] : T >= 10 and N >= 20 and 2 <= t <= T; SW[i] : T >= 10 and N >= 20 and -1 <= i <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i] }"
	 *   - filter: "{ Spatch[w, i]; Spatch_NR[w, i, p] }"
	  ...
	  for (int c1 = max(2, 6 * c0); c1 <= min(T, 6 * c0 + 5); c1 += 1) {
	    ...
	    if (T >= 6 * c0 + 12 && c1 == 6 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 1000; c3 += 1) {
	        for (int c4 = -7; c4 <= min(1006, N - 1000 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
