/* star1d1r_abft_v1_6_700.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_6_700 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 700ti <= -701 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 700ti <= -701 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 700ti <= -701 + N }
 *	 		patch : {[w, i]: 0 <= w <= 6 and -1 - w <= i <= 700 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 6 and -1 - w <= i <= 700 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 700ti <= i <= 699 + 700ti } : Y[6tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[6,p] * Y[6tt-6,700ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_6_700(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_6_700(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_6_700(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-18) + T >= ((double)0) && ((double)-1407) + N >= ((double)0)) ? ((((((((double)23346) + T) + (((double)1) + T) * N) - ((double)2830) * floord(T, ((double)6))) + ((((double)688) + ((double)2) * N) + (((double)-344) - N) * floord(T, ((double)6))) * floord(((double)693) + N, ((double)700)) + (((double)-700) + ((double)350) * floord(T, ((double)6))) * floord(((double)693) + N, ((double)700))*floord(((double)693) + N, ((double)700))) + ((((double)-3518) - ((double)2) * N) + (((double)1759) + N) * floord(T, ((double)6))) * floord(((double)699) + N, ((double)700)) + (((double)700) - ((double)350) * floord(T, ((double)6))) * floord(((double)699) + N, ((double)700))*floord(((double)699) + N, ((double)700)))) : (((double)-18) + T >= ((double)0) && ((double)-1401) + N >= ((double)0) && ((double)1406) - N >= ((double)0)) ? ((((((double)17668) + T) + (((double)-1) + T) * N) + (((double)9) + N) * floord(T, ((double)6)))) : ((((double)-18) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1400) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)17) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)17686) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(7); w++) {
		patch[w] = (float*)(calloc((714),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(699 + N, 700))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((6),sizeof(float*)));
	for (int w=0; w<(6); w++) {
		patch_NR[w] = (float*)(calloc((714),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(699 + N, 700))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-18 + T >= 0 && -1401 + N >= 0) ? ((-2 + floord(699 + N, 700))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((6*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((6),((p)))) * (Y((-6 + 6*(tt)),(700*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==6*(tt_INJ-1)+1 && i==700*ti_INJ+350) inject_star1d1r_abft_v1_6_700(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 6 * c0); c1 <= min(T, 6 * c0 + 5); c1 += 1) {
	    ...
	    if (T >= 6 * c0 + 12 && c1 == 6 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 700; c3 += 1) {
	        for (int c4 = -7; c4 <= min(706, N - 700 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
