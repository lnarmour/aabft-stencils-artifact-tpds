/* star1d1r_abft_v1_6_250.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_6_250 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -251 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -251 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -251 + N }
 *	 		patch : {[w, i]: 0 <= w <= 6 and -1 - w <= i <= 250 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 6 and -1 - w <= i <= 250 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 250ti <= i <= 249 + 250ti } : Y[6tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[6,p] * Y[6tt-6,250ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_6_250(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_6_250(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_6_250(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-18) + T >= ((double)0) && ((double)-507) + N >= ((double)0)) ? ((((((((double)8496) + T) + (((double)1) + T) * N) - ((double)1030) * floord(T, ((double)6))) + ((((double)238) + ((double)2) * N) + (((double)-119) - N) * floord(T, ((double)6))) * floord(((double)243) + N, ((double)250)) + (((double)-250) + ((double)125) * floord(T, ((double)6))) * floord(((double)243) + N, ((double)250))*floord(((double)243) + N, ((double)250))) + ((((double)-1268) - ((double)2) * N) + (((double)634) + N) * floord(T, ((double)6))) * floord(((double)249) + N, ((double)250)) + (((double)250) - ((double)125) * floord(T, ((double)6))) * floord(((double)249) + N, ((double)250))*floord(((double)249) + N, ((double)250)))) : (((double)-18) + T >= ((double)0) && ((double)-501) + N >= ((double)0) && ((double)506) - N >= ((double)0)) ? ((((((double)6418) + T) + (((double)-1) + T) * N) + (((double)9) + N) * floord(T, ((double)6)))) : ((((double)-18) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)500) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)17) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)6436) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((6),((p)))) * (Y((-6 + 6*(tt)),(250*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==6*(tt_INJ-1)+1 && i==250*ti_INJ+125) inject_star1d1r_abft_v1_6_250(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 6 * c0); c1 <= min(T, 6 * c0 + 5); c1 += 1) {
	    ...
	    if (T >= 6 * c0 + 12 && c1 == 6 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 250; c3 += 1) {
	        for (int c4 = -7; c4 <= min(256, N - 250 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
