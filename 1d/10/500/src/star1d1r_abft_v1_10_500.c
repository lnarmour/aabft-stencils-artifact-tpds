 ...
 *	 affine star1d1r_abft_v1_10_500 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
...
void inject_star1d1r_abft_v1_10_500(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_10_500(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_10_500(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-30) + T >= ((double)0) && ((double)-1011) + N >= ((double)0)) ? ((((((((double)25058) + T) + (((double)1) + T) * N) - ((double)2046) * floord(T, ((double)10))) + ((((double)480) + ((double)2) * N) + (((double)-240) - N) * floord(T, ((double)10))) * floord(((double)489) + N, ((double)500)) + (((double)-500) + ((double)250) * floord(T, ((double)10))) * floord(((double)489) + N, ((double)500))*floord(((double)489) + N, ((double)500))) + ((((double)-2526) - ((double)2) * N) + (((double)1263) + N) * floord(T, ((double)10))) * floord(((double)499) + N, ((double)500)) + (((double)500) - ((double)250) * floord(T, ((double)10))) * floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500)))) : (((double)-30) + T >= ((double)0) && ((double)-1001) + N >= ((double)0) && ((double)1010) - N >= ((double)0)) ? ((((((double)20940) + T) + (((double)-1) + T) * N) + (((double)13) + N) * floord(T, ((double)10)))) : ((((double)-30) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1000) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)29) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)20966) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==10*(tt_INJ-1)+1 && i==500*ti_INJ+250) inject_star1d1r_abft_v1_10_500(&Y(t,i)); } while(0)
	#else
