/* star1d1r_abft_v1_15_250.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_15_250 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 250ti <= -251 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 250ti <= -251 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 250ti <= -251 + N }
 *	 		patch : {[w, i]: 0 <= w <= 15 and -1 - w <= i <= 250 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 15 and -1 - w <= i <= 250 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 250ti <= i <= 249 + 250ti } : Y[15tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[15,p] * Y[15tt-15,250ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_15_250(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_15_250(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_15_250(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-516) + N >= ((double)0)) ? ((((((((double)18378) + T) + (((double)1) + T) * N) - ((double)1066) * floord(T, ((double)15))) + ((((double)220) + ((double)2) * N) + (((double)-110) - N) * floord(T, ((double)15))) * floord(((double)234) + N, ((double)250)) + (((double)-250) + ((double)125) * floord(T, ((double)15))) * floord(((double)234) + N, ((double)250))*floord(((double)234) + N, ((double)250))) + ((((double)-1286) - ((double)2) * N) + (((double)643) + N) * floord(T, ((double)15))) * floord(((double)249) + N, ((double)250)) + (((double)250) - ((double)125) * floord(T, ((double)15))) * floord(((double)249) + N, ((double)250))*floord(((double)249) + N, ((double)250)))) : (((double)-45) + T >= ((double)0) && ((double)-501) + N >= ((double)0) && ((double)515) - N >= ((double)0)) ? ((((((double)16210) + T) + (((double)-1) + T) * N) + (((double)18) + N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)500) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)16246) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((15),((p)))) * (Y((-15 + 15*(tt)),(250*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==15*(tt_INJ-1)+1 && i==250*ti_INJ+125) inject_star1d1r_abft_v1_15_250(&Y(t,i)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SY_cb0[t, i] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N; SI[tt, ti] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 250ti <= -251 + N; SC1[tt, ti, i] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 250ti <= -251 + N and 250ti <= i <= 249 + 250ti; SC2[tt, ti, p] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 250ti <= -251 + N and -16 <= p <= 265 and p <= N - 250ti; Spatch_NR[w, i, p] : T >= 10 and N >= 20 and 0 < w <= 15 and p >= -1 and -249 - w + i <= p <= 1 and p <= w + i; Spatch[w, i] : T >= 10 and N >= 20 and 0 <= w <= 15 and -1 - w <= i <= 250 + w; SY_cb2[t, i] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N; SY_cb1[t, i = N] : T >= 10 and N >= 20 and 2 <= t <= T; SY_cb1[t, i = 0] : T >= 10 and N >= 20 and 2 <= t <= T; SW[i] : T >= 10 and N >= 20 and -1 <= i <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i] }"
	 *   - filter: "{ Spatch[w, i]; Spatch_NR[w, i, p] }"
	  ...
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 250; c3 += 1) {
	        for (int c4 = -16; c4 <= min(265, N - 250 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
