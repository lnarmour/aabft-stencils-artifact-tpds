/* star1d1r_abft_v1_15_550.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_15_550 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 550ti <= -551 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 550ti <= -551 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 550ti <= -551 + N }
 *	 		patch : {[w, i]: 0 <= w <= 15 and -1 - w <= i <= 550 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 15 and -1 - w <= i <= 550 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 550ti <= i <= 549 + 550ti } : Y[15tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[15,p] * Y[15tt-15,550ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_15_550(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_15_550(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_15_550(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-1116) + N >= ((double)0)) ? ((((((((double)39078) + T) + (((double)1) + T) * N) - ((double)2266) * floord(T, ((double)15))) + ((((double)520) + ((double)2) * N) + (((double)-260) - N) * floord(T, ((double)15))) * floord(((double)534) + N, ((double)550)) + (((double)-550) + ((double)275) * floord(T, ((double)15))) * floord(((double)534) + N, ((double)550))*floord(((double)534) + N, ((double)550))) + ((((double)-2786) - ((double)2) * N) + (((double)1393) + N) * floord(T, ((double)15))) * floord(((double)549) + N, ((double)550)) + (((double)550) - ((double)275) * floord(T, ((double)15))) * floord(((double)549) + N, ((double)550))*floord(((double)549) + N, ((double)550)))) : (((double)-45) + T >= ((double)0) && ((double)-1101) + N >= ((double)0) && ((double)1115) - N >= ((double)0)) ? ((((((double)34510) + T) + (((double)-1) + T) * N) + (((double)18) + N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1100) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)34546) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(16); w++) {
		patch[w] = (float*)(calloc((582),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(549 + N, 550))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((15),sizeof(float*)));
	for (int w=0; w<(15); w++) {
		patch_NR[w] = (float*)(calloc((582),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(549 + N, 550))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-45 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(549 + N, 550))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((15*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((15),((p)))) * (Y((-15 + 15*(tt)),(550*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==15*(tt_INJ-1)+1 && i==550*ti_INJ+275) inject_star1d1r_abft_v1_15_550(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 550; c3 += 1) {
	        for (int c4 = -16; c4 <= min(565, N - 550 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
