/* star1d1r_abft_v1_15_500.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_15_500 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 500ti <= -501 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 500ti <= -501 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 500ti <= -501 + N }
 *	 		patch : {[w, i]: 0 <= w <= 15 and -1 - w <= i <= 500 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 15 and -1 - w <= i <= 500 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 500ti <= i <= 499 + 500ti } : Y[15tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[15,p] * Y[15tt-15,500ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_15_500(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_15_500(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_15_500(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-1016) + N >= ((double)0)) ? ((((((((double)35628) + T) + (((double)1) + T) * N) - ((double)2066) * floord(T, ((double)15))) + ((((double)470) + ((double)2) * N) + (((double)-235) - N) * floord(T, ((double)15))) * floord(((double)484) + N, ((double)500)) + (((double)-500) + ((double)250) * floord(T, ((double)15))) * floord(((double)484) + N, ((double)500))*floord(((double)484) + N, ((double)500))) + ((((double)-2536) - ((double)2) * N) + (((double)1268) + N) * floord(T, ((double)15))) * floord(((double)499) + N, ((double)500)) + (((double)500) - ((double)250) * floord(T, ((double)15))) * floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500)))) : (((double)-45) + T >= ((double)0) && ((double)-1001) + N >= ((double)0) && ((double)1015) - N >= ((double)0)) ? ((((((double)31460) + T) + (((double)-1) + T) * N) + (((double)18) + N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1000) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)31496) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((15),((p)))) * (Y((-15 + 15*(tt)),(500*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==15*(tt_INJ-1)+1 && i==500*ti_INJ+250) inject_star1d1r_abft_v1_15_500(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 500; c3 += 1) {
	        for (int c4 = -16; c4 <= min(515, N - 500 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
