/* star1d1r_abft_v1_15_600.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_15_600 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 600ti <= -601 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 600ti <= -601 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 600ti <= -601 + N }
 *	 		patch : {[w, i]: 0 <= w <= 15 and -1 - w <= i <= 600 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 15 and -1 - w <= i <= 600 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 600ti <= i <= 599 + 600ti } : Y[15tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[15,p] * Y[15tt-15,600ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_15_600(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_15_600(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_15_600(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-1216) + N >= ((double)0)) ? ((((((((double)42528) + T) + (((double)1) + T) * N) - ((double)2466) * floord(T, ((double)15))) + ((((double)570) + ((double)2) * N) + (((double)-285) - N) * floord(T, ((double)15))) * floord(((double)584) + N, ((double)600)) + (((double)-600) + ((double)300) * floord(T, ((double)15))) * floord(((double)584) + N, ((double)600))*floord(((double)584) + N, ((double)600))) + ((((double)-3036) - ((double)2) * N) + (((double)1518) + N) * floord(T, ((double)15))) * floord(((double)599) + N, ((double)600)) + (((double)600) - ((double)300) * floord(T, ((double)15))) * floord(((double)599) + N, ((double)600))*floord(((double)599) + N, ((double)600)))) : (((double)-45) + T >= ((double)0) && ((double)-1201) + N >= ((double)0) && ((double)1215) - N >= ((double)0)) ? ((((((double)37560) + T) + (((double)-1) + T) * N) + (((double)18) + N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1200) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)37596) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(16); w++) {
		patch[w] = (float*)(calloc((632),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(599 + N, 600))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((15),sizeof(float*)));
	for (int w=0; w<(15); w++) {
		patch_NR[w] = (float*)(calloc((632),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(599 + N, 600))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-45 + T >= 0 && -1201 + N >= 0) ? ((-2 + floord(599 + N, 600))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((15*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((15),((p)))) * (Y((-15 + 15*(tt)),(600*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==15*(tt_INJ-1)+1 && i==600*ti_INJ+300) inject_star1d1r_abft_v1_15_600(&Y(t,i)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SY_cb0[t, i] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N; SI[tt, ti] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 600ti <= -601 + N; SC1[tt, ti, i] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 600ti <= -601 + N and 600ti <= i <= 599 + 600ti; SC2[tt, ti, p] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 600ti <= -601 + N and -16 <= p <= 615 and p <= N - 600ti; Spatch_NR[w, i, p] : T >= 10 and N >= 20 and 0 < w <= 15 and p >= -1 and -599 - w + i <= p <= 1 and p <= w + i; Spatch[w, i] : T >= 10 and N >= 20 and 0 <= w <= 15 and -1 - w <= i <= 600 + w; SY_cb2[t, i] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N; SY_cb1[t, i = N] : T >= 10 and N >= 20 and 2 <= t <= T; SY_cb1[t, i = 0] : T >= 10 and N >= 20 and 2 <= t <= T; SW[i] : T >= 10 and N >= 20 and -1 <= i <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i] }"
	 *   - filter: "{ Spatch[w, i]; Spatch_NR[w, i, p] }"
	  ...
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 600; c3 += 1) {
	        for (int c4 = -16; c4 <= min(615, N - 600 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
