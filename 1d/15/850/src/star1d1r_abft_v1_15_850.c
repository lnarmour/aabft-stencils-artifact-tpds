/* star1d1r_abft_v1_15_850.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_15_850 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 850ti <= -851 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 850ti <= -851 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 850ti <= -851 + N }
 *	 		patch : {[w, i]: 0 <= w <= 15 and -1 - w <= i <= 850 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 15 and -1 - w <= i <= 850 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 850ti <= i <= 849 + 850ti } : Y[15tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[15,p] * Y[15tt-15,850ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_15_850(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_15_850(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_15_850(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-1716) + N >= ((double)0)) ? ((((((((double)59778) + T) + (((double)1) + T) * N) - ((double)3466) * floord(T, ((double)15))) + ((((double)820) + ((double)2) * N) + (((double)-410) - N) * floord(T, ((double)15))) * floord(((double)834) + N, ((double)850)) + (((double)-850) + ((double)425) * floord(T, ((double)15))) * floord(((double)834) + N, ((double)850))*floord(((double)834) + N, ((double)850))) + ((((double)-4286) - ((double)2) * N) + (((double)2143) + N) * floord(T, ((double)15))) * floord(((double)849) + N, ((double)850)) + (((double)850) - ((double)425) * floord(T, ((double)15))) * floord(((double)849) + N, ((double)850))*floord(((double)849) + N, ((double)850)))) : (((double)-45) + T >= ((double)0) && ((double)-1701) + N >= ((double)0) && ((double)1715) - N >= ((double)0)) ? ((((((double)52810) + T) + (((double)-1) + T) * N) + (((double)18) + N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1700) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)52846) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(16); w++) {
		patch[w] = (float*)(calloc((882),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(849 + N, 850))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((15),sizeof(float*)));
	for (int w=0; w<(15); w++) {
		patch_NR[w] = (float*)(calloc((882),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(849 + N, 850))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(T, 15))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-45 + T >= 0 && -1701 + N >= 0) ? ((-2 + floord(849 + N, 850))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((15*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((15),((p)))) * (Y((-15 + 15*(tt)),(850*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==15*(tt_INJ-1)+1 && i==850*ti_INJ+425) inject_star1d1r_abft_v1_15_850(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 850; c3 += 1) {
	        for (int c4 = -16; c4 <= min(865, N - 850 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
