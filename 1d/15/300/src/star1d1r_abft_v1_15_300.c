/* star1d1r_abft_v1_15_300.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_15_300 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 300ti <= -301 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 300ti <= -301 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 300ti <= -301 + N }
 *	 		patch : {[w, i]: 0 <= w <= 15 and -1 - w <= i <= 300 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 15 and -1 - w <= i <= 300 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 300ti <= i <= 299 + 300ti } : Y[15tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[15,p] * Y[15tt-15,300ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_15_300(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_15_300(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_15_300(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-616) + N >= ((double)0)) ? ((((((((double)21828) + T) + (((double)1) + T) * N) - ((double)1266) * floord(T, ((double)15))) + ((((double)270) + ((double)2) * N) + (((double)-135) - N) * floord(T, ((double)15))) * floord(((double)284) + N, ((double)300)) + (((double)-300) + ((double)150) * floord(T, ((double)15))) * floord(((double)284) + N, ((double)300))*floord(((double)284) + N, ((double)300))) + ((((double)-1536) - ((double)2) * N) + (((double)768) + N) * floord(T, ((double)15))) * floord(((double)299) + N, ((double)300)) + (((double)300) - ((double)150) * floord(T, ((double)15))) * floord(((double)299) + N, ((double)300))*floord(((double)299) + N, ((double)300)))) : (((double)-45) + T >= ((double)0) && ((double)-601) + N >= ((double)0) && ((double)615) - N >= ((double)0)) ? ((((((double)19260) + T) + (((double)-1) + T) * N) + (((double)18) + N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)600) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)19296) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((15),((p)))) * (Y((-15 + 15*(tt)),(300*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==15*(tt_INJ-1)+1 && i==300*ti_INJ+150) inject_star1d1r_abft_v1_15_300(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 300; c3 += 1) {
	        for (int c4 = -16; c4 <= min(315, N - 300 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
