/* star1d1r_abft_v1_16_350.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_16_350 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 16tt <= -16 + T and ti > 0 and 350ti <= -351 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 16tt <= -16 + T and ti > 0 and 350ti <= -351 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 16tt <= -16 + T and ti > 0 and 350ti <= -351 + N }
 *	 		patch : {[w, i]: 0 <= w <= 16 and -1 - w <= i <= 350 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 16 and -1 - w <= i <= 350 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 350ti <= i <= 349 + 350ti } : Y[16tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[16,p] * Y[16tt-16,350ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_16_350(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_16_350(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_16_350(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-48) + T >= ((double)0) && ((double)-717) + N >= ((double)0)) ? ((((((((double)26816) + T) + (((double)1) + T) * N) - ((double)1470) * floord(T, ((double)16))) + ((((double)318) + ((double)2) * N) + (((double)-159) - N) * floord(T, ((double)16))) * floord(((double)333) + N, ((double)350)) + (((double)-350) + ((double)175) * floord(T, ((double)16))) * floord(((double)333) + N, ((double)350))*floord(((double)333) + N, ((double)350))) + ((((double)-1788) - ((double)2) * N) + (((double)894) + N) * floord(T, ((double)16))) * floord(((double)349) + N, ((double)350)) + (((double)350) - ((double)175) * floord(T, ((double)16))) * floord(((double)349) + N, ((double)350))*floord(((double)349) + N, ((double)350)))) : (((double)-48) + T >= ((double)0) && ((double)-701) + N >= ((double)0) && ((double)716) - N >= ((double)0)) ? ((((((double)23838) + T) + (((double)-1) + T) * N) + (((double)19) + N) * floord(T, ((double)16)))) : ((((double)-48) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)700) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)47) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)23876) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((16),((p)))) * (Y((-16 + 16*(tt)),(350*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==16*(tt_INJ-1)+1 && i==350*ti_INJ+175) inject_star1d1r_abft_v1_16_350(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 16 * c0); c1 <= min(T, 16 * c0 + 15); c1 += 1) {
	    ...
	    if (T >= 16 * c0 + 32 && c1 == 16 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 350; c3 += 1) {
	        for (int c4 = -17; c4 <= min(366, N - 350 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
