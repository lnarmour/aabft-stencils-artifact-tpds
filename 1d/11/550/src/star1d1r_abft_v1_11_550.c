/* star1d1r_abft_v1_11_550.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_11_550 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 550ti <= -551 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 550ti <= -551 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 550ti <= -551 + N }
 *	 		patch : {[w, i]: 0 <= w <= 11 and -1 - w <= i <= 550 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 11 and -1 - w <= i <= 550 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 550ti <= i <= 549 + 550ti } : Y[11tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[11,p] * Y[11tt-11,550ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_11_550(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_11_550(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_11_550(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-33) + T >= ((double)0) && ((double)-1112) + N >= ((double)0)) ? ((((((((double)29806) + T) + (((double)1) + T) * N) - ((double)2250) * floord(T, ((double)11))) + ((((double)528) + ((double)2) * N) + (((double)-264) - N) * floord(T, ((double)11))) * floord(((double)538) + N, ((double)550)) + (((double)-550) + ((double)275) * floord(T, ((double)11))) * floord(((double)538) + N, ((double)550))*floord(((double)538) + N, ((double)550))) + ((((double)-2778) - ((double)2) * N) + (((double)1389) + N) * floord(T, ((double)11))) * floord(((double)549) + N, ((double)550)) + (((double)550) - ((double)275) * floord(T, ((double)11))) * floord(((double)549) + N, ((double)550))*floord(((double)549) + N, ((double)550)))) : (((double)-33) + T >= ((double)0) && ((double)-1101) + N >= ((double)0) && ((double)1111) - N >= ((double)0)) ? ((((((double)25278) + T) + (((double)-1) + T) * N) + (((double)14) + N) * floord(T, ((double)11)))) : ((((double)-33) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1100) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)32) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)25306) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	for (int w=0; w<(12); w++) {
		patch[w] = (float*)(calloc((574),sizeof(float)));
	}
	
	float* W = (float*)(calloc((3),sizeof(float)));
	
	float** I = (float**)(calloc(((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 11))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 11))) : 0); tt++) {
		I[tt] = (float*)(calloc(((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(549 + N, 550))) : 0),sizeof(float)));
	}
	
	float** patch_NR = (float**)(calloc((11),sizeof(float*)));
	for (int w=0; w<(11); w++) {
		patch_NR[w] = (float*)(calloc((574),sizeof(float)));
	}
	
	float** C1 = (float**)(calloc(((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 11))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 11))) : 0); tt++) {
		C1[tt] = (float*)(calloc(((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(549 + N, 550))) : 0),sizeof(float)));
	}
	
	float** C2 = (float**)(calloc(((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 11))) : 0),sizeof(float*)));
	for (int tt=0; tt<((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(T, 11))) : 0); tt++) {
		C2[tt] = (float*)(calloc(((-33 + T >= 0 && -1101 + N >= 0) ? ((-2 + floord(549 + N, 550))) : 0),sizeof(float)));
	}

	#define SC1(tt,ti,i) C1(tt,ti) += Y((11*(tt)),((i)))
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((11),((p)))) * (Y((-11 + 11*(tt)),(550*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==11*(tt_INJ-1)+1 && i==550*ti_INJ+275) inject_star1d1r_abft_v1_11_550(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 11 * c0); c1 <= min(T, 11 * c0 + 10); c1 += 1) {
	    ...
	    if (T >= 11 * c0 + 22 && c1 == 11 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 550; c3 += 1) {
	        for (int c4 = -12; c4 <= min(561, N - 550 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
