/* star1d1r_abft_v1_11_450.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_11_450 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 450ti <= -451 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 450ti <= -451 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 450ti <= -451 + N }
 *	 		patch : {[w, i]: 0 <= w <= 11 and -1 - w <= i <= 450 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 11 and -1 - w <= i <= 450 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 450ti <= i <= 449 + 450ti } : Y[11tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[11,p] * Y[11tt-11,450ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_11_450(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_11_450(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_11_450(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-33) + T >= ((double)0) && ((double)-912) + N >= ((double)0)) ? ((((((((double)24506) + T) + (((double)1) + T) * N) - ((double)1850) * floord(T, ((double)11))) + ((((double)428) + ((double)2) * N) + (((double)-214) - N) * floord(T, ((double)11))) * floord(((double)438) + N, ((double)450)) + (((double)-450) + ((double)225) * floord(T, ((double)11))) * floord(((double)438) + N, ((double)450))*floord(((double)438) + N, ((double)450))) + ((((double)-2278) - ((double)2) * N) + (((double)1139) + N) * floord(T, ((double)11))) * floord(((double)449) + N, ((double)450)) + (((double)450) - ((double)225) * floord(T, ((double)11))) * floord(((double)449) + N, ((double)450))*floord(((double)449) + N, ((double)450)))) : (((double)-33) + T >= ((double)0) && ((double)-901) + N >= ((double)0) && ((double)911) - N >= ((double)0)) ? ((((((double)20778) + T) + (((double)-1) + T) * N) + (((double)14) + N) * floord(T, ((double)11)))) : ((((double)-33) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)900) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)32) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)20806) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((11),((p)))) * (Y((-11 + 11*(tt)),(450*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==11*(tt_INJ-1)+1 && i==450*ti_INJ+225) inject_star1d1r_abft_v1_11_450(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 11 * c0); c1 <= min(T, 11 * c0 + 10); c1 += 1) {
	    ...
	    if (T >= 11 * c0 + 22 && c1 == 11 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 450; c3 += 1) {
	        for (int c4 = -12; c4 <= min(461, N - 450 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
