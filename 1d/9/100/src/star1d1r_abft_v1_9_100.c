/* star1d1r_abft_v1_9_100.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_9_100 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N }
 *	 		patch : {[w, i]: 0 <= w <= 9 and -1 - w <= i <= 100 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 9 and -1 - w <= i <= 100 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 100ti <= i <= 99 + 100ti } : Y[9tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[9,p] * Y[9tt-9,100ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_9_100(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_9_100(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_9_100(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-27) + T >= ((double)0) && ((double)-210) + N >= ((double)0)) ? ((((((((double)4968) + T) + (((double)1) + T) * N) - ((double)442) * floord(T, ((double)9))) + ((((double)82) + ((double)2) * N) + (((double)-41) - N) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100)) + (((double)-100) + ((double)50) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100))) + ((((double)-524) - ((double)2) * N) + (((double)262) + N) * floord(T, ((double)9))) * floord(((double)99) + N, ((double)100)) + (((double)100) - ((double)50) * floord(T, ((double)9))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)))) : (((double)-27) + T >= ((double)0) && ((double)-201) + N >= ((double)0) && ((double)209) - N >= ((double)0)) ? ((((((double)4060) + T) + (((double)-1) + T) * N) + (((double)12) + N) * floord(T, ((double)9)))) : ((((double)-27) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)200) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)26) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)4084) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((9),((p)))) * (Y((-9 + 9*(tt)),(100*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==9*(tt_INJ-1)+1 && i==100*ti_INJ+50) inject_star1d1r_abft_v1_9_100(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 9 * c0); c1 <= min(T, 9 * c0 + 8); c1 += 1) {
	    ...
	    if (T >= 9 * c0 + 18 && c1 == 9 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 100; c3 += 1) {
	        for (int c4 = -10; c4 <= min(109, N - 100 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
