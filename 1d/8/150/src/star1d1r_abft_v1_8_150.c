/* star1d1r_abft_v1_8_150.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_8_150 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 150ti <= -151 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 150ti <= -151 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 150ti <= -151 + N }
 *	 		patch : {[w, i]: 0 <= w <= 8 and -1 - w <= i <= 150 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 8 and -1 - w <= i <= 150 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 150ti <= i <= 149 + 150ti } : Y[8tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[8,p] * Y[8tt-8,150ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_8_150(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_8_150(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_8_150(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-24) + T >= ((double)0) && ((double)-309) + N >= ((double)0)) ? ((((((((double)6536) + T) + (((double)1) + T) * N) - ((double)638) * floord(T, ((double)8))) + ((((double)134) + ((double)2) * N) + (((double)-67) - N) * floord(T, ((double)8))) * floord(((double)141) + N, ((double)150)) + (((double)-150) + ((double)75) * floord(T, ((double)8))) * floord(((double)141) + N, ((double)150))*floord(((double)141) + N, ((double)150))) + ((((double)-772) - ((double)2) * N) + (((double)386) + N) * floord(T, ((double)8))) * floord(((double)149) + N, ((double)150)) + (((double)150) - ((double)75) * floord(T, ((double)8))) * floord(((double)149) + N, ((double)150))*floord(((double)149) + N, ((double)150)))) : (((double)-24) + T >= ((double)0) && ((double)-301) + N >= ((double)0) && ((double)308) - N >= ((double)0)) ? ((((((double)5238) + T) + (((double)-1) + T) * N) + (((double)11) + N) * floord(T, ((double)8)))) : ((((double)-24) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)300) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)23) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)5260) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((8),((p)))) * (Y((-8 + 8*(tt)),(150*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==8*(tt_INJ-1)+1 && i==150*ti_INJ+75) inject_star1d1r_abft_v1_8_150(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 8 * c0); c1 <= min(T, 8 * c0 + 7); c1 += 1) {
	    ...
	    if (T >= 8 * c0 + 16 && c1 == 8 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 150; c3 += 1) {
	        for (int c4 = -9; c4 <= min(158, N - 150 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
