/* star1d1r_abft_v1_8_250.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star1d1r_abft_v1_8_250 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 *	 		X : {[i]: 0 <= i <= N }
 *	 	outputs
 ...
 *	 	locals
 *	 		W : {[i]: -1 <= i <= 1 }
 *	 		C1 : {[tt, ti]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 250ti <= -251 + N }
 *	 		C2 : {[tt, ti]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 250ti <= -251 + N }
 *	 		I : {[tt, ti]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 250ti <= -251 + N }
 *	 		patch : {[w, i]: 0 <= w <= 8 and -1 - w <= i <= 250 + w }
 *	 		patch_NR : {[w, i]: 0 < w <= 8 and -1 - w <= i <= 250 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti] = reduce(+, (tt,ti,i->tt,ti), {: 250ti <= i <= 249 + 250ti } : Y[8tt,i]);
 *	 		
 *	 		C2[tt,ti] = reduce(+, (tt,ti,p->tt,ti), (patch[8,p] * Y[8tt-8,250ti+p]));
 *	 		
 *	 		I[tt,ti] = ((C2 - C1) / C1);
 *	 		
...
void inject_star1d1r_abft_v1_8_250(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star1d1r_abft_v1_8_250(double T, double N, float *X, float **Y)
#else
struct Result star1d1r_abft_v1_8_250(long T, long N, float *X, float **Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-24) + T >= ((double)0) && ((double)-509) + N >= ((double)0)) ? ((((((((double)10636) + T) + (((double)1) + T) * N) - ((double)1038) * floord(T, ((double)8))) + ((((double)234) + ((double)2) * N) + (((double)-117) - N) * floord(T, ((double)8))) * floord(((double)241) + N, ((double)250)) + (((double)-250) + ((double)125) * floord(T, ((double)8))) * floord(((double)241) + N, ((double)250))*floord(((double)241) + N, ((double)250))) + ((((double)-1272) - ((double)2) * N) + (((double)636) + N) * floord(T, ((double)8))) * floord(((double)249) + N, ((double)250)) + (((double)250) - ((double)125) * floord(T, ((double)8))) * floord(((double)249) + N, ((double)250))*floord(((double)249) + N, ((double)250)))) : (((double)-24) + T >= ((double)0) && ((double)-501) + N >= ((double)0) && ((double)508) - N >= ((double)0)) ? ((((((double)8538) + T) + (((double)-1) + T) * N) + (((double)11) + N) * floord(T, ((double)8)))) : ((((double)-24) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)500) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)23) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)8560) + T) + (((double)1) + T) * N)) : ((double)0));
	...
	#define SC2(tt,ti,p) C2(tt,ti) += (patch((8),((p)))) * (Y((-8 + 8*(tt)),(250*(ti) + (p))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i) do { SY_cb2_hook(t,i); if (t==8*(tt_INJ-1)+1 && i==250*ti_INJ+125) inject_star1d1r_abft_v1_8_250(&Y(t,i)); } while(0)
	#else
	  ...
	  for (int c1 = max(2, 8 * c0); c1 <= min(T, 8 * c0 + 7); c1 += 1) {
	    ...
	    if (T >= 8 * c0 + 16 && c1 == 8 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 250; c3 += 1) {
	        for (int c4 = -9; c4 <= min(258, N - 250 * c3); c4 += 1) {
	          SC2(c0 + 1, c3, c4);
	        }
	      }
	    }
