/* star2d1r_abft_v2_7_450_450.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v2_7_450_450 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N }
 *	 		C2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p <= 2 and -2 <= q <= 2 }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N }
 *	 		WKernel : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WCombos : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WAll : {[w]: 0 < w <= 7 }
 *	 		C2_NR : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= q < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR5 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR6 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < q <= 2 }
 *	 		C2_NR7 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 }
 *	 		C2_NR9 : {[tt, ti, tj, p, q]: p = 0 and q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N }
 *	 		I_NR : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 450ti <= i <= 463 + 450ti and 450tj <= j <= 463 + 450tj } : Y[7tt,i,j]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,450ti+p+w,450tj+q+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,450ti+p-w+463,450tj+q+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 450ti + w <= i <= 463 + 450ti - w } : (WAll[w] * Y[7tt-w,i,450tj+q+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,450ti+p+w,450tj+q-w+463]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,450ti+p-w+463,450tj+q-w+463]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 450ti + w <= i <= 463 + 450ti - w } : (WAll[w] * Y[7tt-w,i,450tj+q-w+463]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 450tj + w <= j <= 463 + 450tj - w } : (WAll[w] * Y[7tt-w,450ti+p+w,j]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 450tj + w <= j <= 463 + 450tj - w } : (WAll[w] * Y[7tt-w,450ti+p-w+463,j]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i,j->tt,ti,tj,p,q), {: w = 7 and 7 + 450ti <= i <= 456 + 450ti and 7 + 450tj <= j <= 456 + 450tj } : (WAll[w] * Y[7tt-w,i,j]));
 *	 		
...
void inject_star2d1r_abft_v2_7_450_450(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v2_7_450_450(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v2_7_450_450(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-21) + T >= ((double)0) && ((double)-915) + N >= ((double)0)) ? (((((((double)-3547749) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)1773980) * floord(T, ((double)7))) + (((double)3547960) - ((double)1773980) * floord(T, ((double)7))) * floord(((double)435) + N, ((double)450)) + (((double)-886990) + ((double)443495) * floord(T, ((double)7))) * floord(((double)435) + N, ((double)450))*floord(((double)435) + N, ((double)450)))) : ((((double)-21) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)914) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)20) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)211) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	float*** I_NR = (float***)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		I_NR[tt] = (float**)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0); ti++) {
			I_NR[tt][ti] = (float*)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float)));
		}
	}
	
	float*** I = (float***)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float)));
		}
	}
	...
	float*** C1 = (float***)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float)));
		}
	}
	...
	float***** C2 = (float*****)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float****)));
	for (int tt=0; tt<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		C2[tt] = (float****)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float***)));
		for (int ti=0; ti<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0); ti++) {
			C2[tt][ti] = (float***)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0),sizeof(float**)));
			for (int tj=0; tj<((-21 + T >= 0 && -915 + N >= 0) ? ((-2 + floord(435 + N, 450))) : 0); tj++) {
				C2[tt][ti][tj] = (float**)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? (5) : 0),sizeof(float*)));
				for (int p=0; p<((-21 + T >= 0 && -915 + N >= 0) ? (5) : 0); p++) {
					C2[tt][ti][tj][p] = (float*)(calloc(((-21 + T >= 0 && -915 + N >= 0) ? (5) : 0),sizeof(float)));
				}
			}
		}
	}
	...
	#define SC2_NR(tt,ti,tj,p,q,w) C2_NR(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(450*(ti) + (p) + (w)),(450*(tj) + (q) + (w))))
	#define SC2_NR2(tt,ti,tj,p,q,w) C2_NR2(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(463 + 450*(ti) + (p) - (w)),(450*(tj) + (q) + (w))))
	#define SC2_NR3(tt,ti,tj,p,q,w,i) C2_NR3(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(450*(tj) + (q) + (w))))
	#define SC2_NR4(tt,ti,tj,p,q,w) C2_NR4(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(450*(ti) + (p) + (w)),(463 + 450*(tj) + (q) - (w))))
	#define SC2_NR5(tt,ti,tj,p,q,w) C2_NR5(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(463 + 450*(ti) + (p) - (w)),(463 + 450*(tj) + (q) - (w))))
	#define SC2_NR6(tt,ti,tj,p,q,w,i) C2_NR6(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(463 + 450*(tj) + (q) - (w))))
	#define SC2_NR7(tt,ti,tj,p,q,w,j) C2_NR7(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(450*(ti) + (p) + (w)),((j))))
	#define SC2_NR8(tt,ti,tj,p,q,w,j) C2_NR8(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(463 + 450*(ti) + (p) - (w)),((j))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==7*(tt_INJ-1)+1 && i==450*ti_INJ+232 && j==450*tj_INJ+232) inject_star2d1r_abft_v2_7_450_450(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb3[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 and 0 < q <= 2; SC2_cb8[tt, ti, tj, p = 0, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N; SC2_cb5[tt, ti, tj, p = 0, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < q <= 2; SC1[tt, ti, tj, i, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 450ti <= i <= 463 + 450ti and 450tj <= j <= 463 + 450tj; SC2_cb2[tt, ti, tj, p = 0, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= q < 0; SC2_NR6[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < q <= 2 and 0 < w <= 7 and 450ti + w <= i <= 463 + 450ti - w; SC2_NR[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 7; SC2_NR8[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 and 0 < w <= 7 and 450tj + w <= j <= 463 + 450tj - w; SC2_cb4[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 and 0 < q <= 2; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SC2_NR9[tt, ti, tj, p = 0, q = 0, w = 7, i, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 7 + 450ti <= i <= 456 + 450ti and 7 + 450tj <= j <= 456 + 450tj; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 7; SC2_cb7[tt, ti, tj, p, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2; SI[tt, ti, tj] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SC2_NR2[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 7; SC2_cb6[tt, ti, tj, p, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0; SWKernel[i, j] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2; SC2_NR7[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 and 0 < w <= 7 and 450tj + w <= j <= 463 + 450tj - w; SWCombos[i, j, p, q] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j; SC2_NR3[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= q < 0 and 0 < w <= 7 and 450ti + w <= i <= 463 + 450ti - w; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; SC2_NR4[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 7; SC2_cb1[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb0[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p < 0 and -2 <= q < 0; SI_NR[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and -2 <= p <= 2 and -2 <= q <= 2; SC2_NR5[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 450ti <= -465 + N and tj > 0 and 450tj <= -465 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 7; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ SWKernel[i, j] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (T >= c0 + 14 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 450; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 450; c3 += 1) {
	        for (int c7 = 450 * c2 + 7; c7 <= 450 * c2 + 456; c7 += 1) {
	          for (int c8 = 450 * c3 + 7; c8 <= 450 * c3 + 456; c8 += 1) {
	  ...
	  if (c0 >= 7 && (c0 % 7) + T >= c0 + 14) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 450; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 450; c3 += 1) {
	        for (int c4 = 1; c4 <= 2; c4 += 1) {
	          for (int c7 = -(c0 % 7) + 450 * c3 + 7; c7 <= (c0 % 7) + 450 * c3 + 456; c7 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 450; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 450; c3 += 1) {
	        for (int c5 = 1; c5 <= 2; c5 += 1) {
	          for (int c7 = -(c0 % 7) + 450 * c2 + 7; c7 <= (c0 % 7) + 450 * c2 + 456; c7 += 1) {
	  ...
	  if (c0 >= 14 && T >= c0 + 7 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 450; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 450; c3 += 1) {
	        for (int c4 = 450 * c2; c4 <= 450 * c2 + 463; c4 += 1) {
	          for (int c5 = 450 * c3; c5 <= 450 * c3 + 463; c5 += 1) {
	...
	for (int tt = 2; tt < T / 7; tt += 1) {
	  for (int ti = 1; ti < (N - 15) / 450; ti += 1) {
	    for (int tj = 1; tj < (N - 15) / 450; tj += 1) {
	      SI(tt, ti, tj);
	    }
	  }
	}
