/* star2d1r_abft_v2_7_50_50.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v2_7_50_50 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N }
 *	 		C2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p <= 2 and -2 <= q <= 2 }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N }
 *	 		WKernel : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WCombos : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WAll : {[w]: 0 < w <= 7 }
 *	 		C2_NR : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= q < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR5 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR6 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < q <= 2 }
 *	 		C2_NR7 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 }
 *	 		C2_NR9 : {[tt, ti, tj, p, q]: p = 0 and q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N }
 *	 		I_NR : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 50ti <= i <= 63 + 50ti and 50tj <= j <= 63 + 50tj } : Y[7tt,i,j]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,50ti+p+w,50tj+q+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,50ti+p-w+63,50tj+q+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 50ti + w <= i <= 63 + 50ti - w } : (WAll[w] * Y[7tt-w,i,50tj+q+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,50ti+p+w,50tj+q-w+63]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,50ti+p-w+63,50tj+q-w+63]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 50ti + w <= i <= 63 + 50ti - w } : (WAll[w] * Y[7tt-w,i,50tj+q-w+63]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 50tj + w <= j <= 63 + 50tj - w } : (WAll[w] * Y[7tt-w,50ti+p+w,j]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 50tj + w <= j <= 63 + 50tj - w } : (WAll[w] * Y[7tt-w,50ti+p-w+63,j]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i,j->tt,ti,tj,p,q), {: w = 7 and 7 + 50ti <= i <= 56 + 50ti and 7 + 50tj <= j <= 56 + 50tj } : (WAll[w] * Y[7tt-w,i,j]));
 *	 		
...
void inject_star2d1r_abft_v2_7_50_50(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v2_7_50_50(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v2_7_50_50(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-21) + T >= ((double)0) && ((double)-115) + N >= ((double)0)) ? (((((((double)-78949) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)39580) * floord(T, ((double)7))) + (((double)79160) - ((double)39580) * floord(T, ((double)7))) * floord(((double)35) + N, ((double)50)) + (((double)-19790) + ((double)9895) * floord(T, ((double)7))) * floord(((double)35) + N, ((double)50))*floord(((double)35) + N, ((double)50)))) : ((((double)-21) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)114) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)20) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)211) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int tt=0; tt<((-21 + T >= 0 && -115 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		...
		for (int ti=0; ti<((-21 + T >= 0 && -115 + N >= 0) ? ((-2 + floord(35 + N, 50))) : 0); ti++) {
			...
			for (int tj=0; tj<((-21 + T >= 0 && -115 + N >= 0) ? ((-2 + floord(35 + N, 50))) : 0); tj++) {
				C2[tt][ti][tj] = (float**)(calloc(((-21 + T >= 0 && -115 + N >= 0) ? (5) : 0),sizeof(float*)));
				for (int p=0; p<((-21 + T >= 0 && -115 + N >= 0) ? (5) : 0); p++) {
					C2[tt][ti][tj][p] = (float*)(calloc(((-21 + T >= 0 && -115 + N >= 0) ? (5) : 0),sizeof(float)));
				}
			}
		}
	}
	...
	#define SC2_NR(tt,ti,tj,p,q,w) C2_NR(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(50*(ti) + (p) + (w)),(50*(tj) + (q) + (w))))
	#define SC2_NR2(tt,ti,tj,p,q,w) C2_NR2(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(63 + 50*(ti) + (p) - (w)),(50*(tj) + (q) + (w))))
	#define SC2_NR3(tt,ti,tj,p,q,w,i) C2_NR3(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(50*(tj) + (q) + (w))))
	#define SC2_NR4(tt,ti,tj,p,q,w) C2_NR4(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(50*(ti) + (p) + (w)),(63 + 50*(tj) + (q) - (w))))
	#define SC2_NR5(tt,ti,tj,p,q,w) C2_NR5(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(63 + 50*(ti) + (p) - (w)),(63 + 50*(tj) + (q) - (w))))
	#define SC2_NR6(tt,ti,tj,p,q,w,i) C2_NR6(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(63 + 50*(tj) + (q) - (w))))
	#define SC2_NR7(tt,ti,tj,p,q,w,j) C2_NR7(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(50*(ti) + (p) + (w)),((j))))
	#define SC2_NR8(tt,ti,tj,p,q,w,j) C2_NR8(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(63 + 50*(ti) + (p) - (w)),((j))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==7*(tt_INJ-1)+1 && i==50*ti_INJ+32 && j==50*tj_INJ+32) inject_star2d1r_abft_v2_7_50_50(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb3[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 and 0 < q <= 2; SC2_cb8[tt, ti, tj, p = 0, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N; SC2_cb5[tt, ti, tj, p = 0, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < q <= 2; SC1[tt, ti, tj, i, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 50ti <= i <= 63 + 50ti and 50tj <= j <= 63 + 50tj; SC2_cb2[tt, ti, tj, p = 0, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= q < 0; SC2_NR6[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < q <= 2 and 0 < w <= 7 and 50ti + w <= i <= 63 + 50ti - w; SC2_NR[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 7; SC2_NR8[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 and 0 < w <= 7 and 50tj + w <= j <= 63 + 50tj - w; SC2_cb4[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 and 0 < q <= 2; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SC2_NR9[tt, ti, tj, p = 0, q = 0, w = 7, i, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 7 + 50ti <= i <= 56 + 50ti and 7 + 50tj <= j <= 56 + 50tj; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 7; SC2_cb7[tt, ti, tj, p, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2; SI[tt, ti, tj] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SC2_NR2[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 7; SC2_cb6[tt, ti, tj, p, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0; SWKernel[i, j] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2; SC2_NR7[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 and 0 < w <= 7 and 50tj + w <= j <= 63 + 50tj - w; SWCombos[i, j, p, q] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j; SC2_NR3[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= q < 0 and 0 < w <= 7 and 50ti + w <= i <= 63 + 50ti - w; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; SC2_NR4[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 7; SC2_cb1[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb0[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p < 0 and -2 <= q < 0; SI_NR[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and -2 <= p <= 2 and -2 <= q <= 2; SC2_NR5[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 50ti <= -65 + N and tj > 0 and 50tj <= -65 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 7; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ SWKernel[i, j] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (T >= c0 + 14 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 50; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 50; c3 += 1) {
	        for (int c7 = 50 * c2 + 7; c7 <= 50 * c2 + 56; c7 += 1) {
	          for (int c8 = 50 * c3 + 7; c8 <= 50 * c3 + 56; c8 += 1) {
	  ...
	  if (c0 >= 7 && (c0 % 7) + T >= c0 + 14) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 50; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 50; c3 += 1) {
	        for (int c4 = 1; c4 <= 2; c4 += 1) {
	          for (int c7 = -(c0 % 7) + 50 * c3 + 7; c7 <= (c0 % 7) + 50 * c3 + 56; c7 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 50; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 50; c3 += 1) {
	        for (int c5 = 1; c5 <= 2; c5 += 1) {
	          for (int c7 = -(c0 % 7) + 50 * c2 + 7; c7 <= (c0 % 7) + 50 * c2 + 56; c7 += 1) {
	  ...
	  if (c0 >= 14 && T >= c0 + 7 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 50; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 50; c3 += 1) {
	        for (int c4 = 50 * c2; c4 <= 50 * c2 + 63; c4 += 1) {
	          for (int c5 = 50 * c3; c5 <= 50 * c3 + 63; c5 += 1) {
