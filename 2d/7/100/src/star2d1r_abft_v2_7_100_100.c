/* star2d1r_abft_v2_7_100_100.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v2_7_100_100 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N }
 *	 		C2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p <= 2 and -2 <= q <= 2 }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N }
 *	 		WKernel : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WCombos : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WAll : {[w]: 0 < w <= 7 }
 *	 		C2_NR : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= q < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR5 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR6 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < q <= 2 }
 *	 		C2_NR7 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 }
 *	 		C2_NR9 : {[tt, ti, tj, p, q]: p = 0 and q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N }
 *	 		I_NR : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 100ti <= i <= 113 + 100ti and 100tj <= j <= 113 + 100tj } : Y[7tt,i,j]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,100ti+p+w,100tj+q+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,100ti+p-w+113,100tj+q+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 100ti + w <= i <= 113 + 100ti - w } : (WAll[w] * Y[7tt-w,i,100tj+q+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,100ti+p+w,100tj+q-w+113]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,100ti+p-w+113,100tj+q-w+113]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 100ti + w <= i <= 113 + 100ti - w } : (WAll[w] * Y[7tt-w,i,100tj+q-w+113]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 100tj + w <= j <= 113 + 100tj - w } : (WAll[w] * Y[7tt-w,100ti+p+w,j]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 100tj + w <= j <= 113 + 100tj - w } : (WAll[w] * Y[7tt-w,100ti+p-w+113,j]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i,j->tt,ti,tj,p,q), {: w = 7 and 7 + 100ti <= i <= 106 + 100ti and 7 + 100tj <= j <= 106 + 100tj } : (WAll[w] * Y[7tt-w,i,j]));
 *	 		
...
void inject_star2d1r_abft_v2_7_100_100(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v2_7_100_100(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v2_7_100_100(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-21) + T >= ((double)0) && ((double)-215) + N >= ((double)0)) ? (((((((double)-232549) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)116380) * floord(T, ((double)7))) + (((double)232760) - ((double)116380) * floord(T, ((double)7))) * floord(((double)85) + N, ((double)100)) + (((double)-58190) + ((double)29095) * floord(T, ((double)7))) * floord(((double)85) + N, ((double)100))*floord(((double)85) + N, ((double)100)))) : ((((double)-21) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)214) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)20) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)211) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int tt=0; tt<((-21 + T >= 0 && -215 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		...
		for (int ti=0; ti<((-21 + T >= 0 && -215 + N >= 0) ? ((-2 + floord(85 + N, 100))) : 0); ti++) {
			...
			for (int tj=0; tj<((-21 + T >= 0 && -215 + N >= 0) ? ((-2 + floord(85 + N, 100))) : 0); tj++) {
				C2[tt][ti][tj] = (float**)(calloc(((-21 + T >= 0 && -215 + N >= 0) ? (5) : 0),sizeof(float*)));
				for (int p=0; p<((-21 + T >= 0 && -215 + N >= 0) ? (5) : 0); p++) {
					C2[tt][ti][tj][p] = (float*)(calloc(((-21 + T >= 0 && -215 + N >= 0) ? (5) : 0),sizeof(float)));
				}
			}
		}
	}
	...
	#define SC2_NR(tt,ti,tj,p,q,w) C2_NR(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(100*(ti) + (p) + (w)),(100*(tj) + (q) + (w))))
	#define SC2_NR2(tt,ti,tj,p,q,w) C2_NR2(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(113 + 100*(ti) + (p) - (w)),(100*(tj) + (q) + (w))))
	#define SC2_NR3(tt,ti,tj,p,q,w,i) C2_NR3(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(100*(tj) + (q) + (w))))
	#define SC2_NR4(tt,ti,tj,p,q,w) C2_NR4(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(100*(ti) + (p) + (w)),(113 + 100*(tj) + (q) - (w))))
	#define SC2_NR5(tt,ti,tj,p,q,w) C2_NR5(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(113 + 100*(ti) + (p) - (w)),(113 + 100*(tj) + (q) - (w))))
	#define SC2_NR6(tt,ti,tj,p,q,w,i) C2_NR6(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(113 + 100*(tj) + (q) - (w))))
	#define SC2_NR7(tt,ti,tj,p,q,w,j) C2_NR7(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(100*(ti) + (p) + (w)),((j))))
	#define SC2_NR8(tt,ti,tj,p,q,w,j) C2_NR8(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(113 + 100*(ti) + (p) - (w)),((j))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==7*(tt_INJ-1)+1 && i==100*ti_INJ+57 && j==100*tj_INJ+57) inject_star2d1r_abft_v2_7_100_100(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb3[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 and 0 < q <= 2; SC2_cb8[tt, ti, tj, p = 0, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N; SC2_cb5[tt, ti, tj, p = 0, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < q <= 2; SC1[tt, ti, tj, i, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 100ti <= i <= 113 + 100ti and 100tj <= j <= 113 + 100tj; SC2_cb2[tt, ti, tj, p = 0, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= q < 0; SC2_NR6[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < q <= 2 and 0 < w <= 7 and 100ti + w <= i <= 113 + 100ti - w; SC2_NR[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 7; SC2_NR8[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 and 0 < w <= 7 and 100tj + w <= j <= 113 + 100tj - w; SC2_cb4[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 and 0 < q <= 2; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SC2_NR9[tt, ti, tj, p = 0, q = 0, w = 7, i, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 7 + 100ti <= i <= 106 + 100ti and 7 + 100tj <= j <= 106 + 100tj; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 7; SC2_cb7[tt, ti, tj, p, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2; SI[tt, ti, tj] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SC2_NR2[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 7; SC2_cb6[tt, ti, tj, p, q = 0] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0; SWKernel[i, j] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2; SC2_NR7[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 and 0 < w <= 7 and 100tj + w <= j <= 113 + 100tj - w; SWCombos[i, j, p, q] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j; SC2_NR3[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= q < 0 and 0 < w <= 7 and 100ti + w <= i <= 113 + 100ti - w; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; SC2_NR4[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 7; SC2_cb1[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb0[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p < 0 and -2 <= q < 0; SI_NR[tt, ti, tj, p, q] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and -2 <= p <= 2 and -2 <= q <= 2; SC2_NR5[tt, ti, tj, p, q, w] : tt >= 2 and 7tt <= -7 + T and ti > 0 and 100ti <= -115 + N and tj > 0 and 100tj <= -115 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 7; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ SWKernel[i, j] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (T >= c0 + 14 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 100; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 100; c3 += 1) {
	        for (int c7 = 100 * c2 + 7; c7 <= 100 * c2 + 106; c7 += 1) {
	          for (int c8 = 100 * c3 + 7; c8 <= 100 * c3 + 106; c8 += 1) {
	  ...
	  if (c0 >= 7 && (c0 % 7) + T >= c0 + 14) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 100; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 100; c3 += 1) {
	        for (int c4 = 1; c4 <= 2; c4 += 1) {
	          for (int c7 = -(c0 % 7) + 100 * c3 + 7; c7 <= (c0 % 7) + 100 * c3 + 106; c7 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 100; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 100; c3 += 1) {
	        for (int c5 = 1; c5 <= 2; c5 += 1) {
	          for (int c7 = -(c0 % 7) + 100 * c2 + 7; c7 <= (c0 % 7) + 100 * c2 + 106; c7 += 1) {
	  ...
	  if (c0 >= 14 && T >= c0 + 7 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 100; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 100; c3 += 1) {
	        for (int c4 = 100 * c2; c4 <= 100 * c2 + 113; c4 += 1) {
	          for (int c5 = 100 * c3; c5 <= 100 * c3 + 113; c5 += 1) {
