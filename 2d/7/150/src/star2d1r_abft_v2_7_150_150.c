/* star2d1r_abft_v2_7_150_150.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v2_7_150_150 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N }
 *	 		C2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and -2 <= p <= 2 and -2 <= q <= 2 }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N }
 *	 		WKernel : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WCombos : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WAll : {[w]: 0 < w <= 7 }
 *	 		C2_NR : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and -2 <= q < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR5 : {[tt, ti, tj, p, q]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR6 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and 0 < q <= 2 }
 *	 		C2_NR7 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and -2 <= p < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N and 0 < p <= 2 }
 *	 		C2_NR9 : {[tt, ti, tj, p, q]: p = 0 and q = 0 and tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N }
 *	 		I_NR : {[tt, ti, tj]: tt >= 2 and 7tt <= -7 + T and ti > 0 and 150ti <= -165 + N and tj > 0 and 150tj <= -165 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 150ti <= i <= 163 + 150ti and 150tj <= j <= 163 + 150tj } : Y[7tt,i,j]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,150ti+p+w,150tj+q+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,150ti+p-w+163,150tj+q+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 150ti + w <= i <= 163 + 150ti - w } : (WAll[w] * Y[7tt-w,i,150tj+q+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,150ti+p+w,150tj+q-w+163]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[7tt-w,150ti+p-w+163,150tj+q-w+163]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 7 and 150ti + w <= i <= 163 + 150ti - w } : (WAll[w] * Y[7tt-w,i,150tj+q-w+163]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 150tj + w <= j <= 163 + 150tj - w } : (WAll[w] * Y[7tt-w,150ti+p+w,j]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 7 and 150tj + w <= j <= 163 + 150tj - w } : (WAll[w] * Y[7tt-w,150ti+p-w+163,j]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i,j->tt,ti,tj,p,q), {: w = 7 and 7 + 150ti <= i <= 156 + 150ti and 7 + 150tj <= j <= 156 + 150tj } : (WAll[w] * Y[7tt-w,i,j]));
 *	 		
...
void inject_star2d1r_abft_v2_7_150_150(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v2_7_150_150(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v2_7_150_150(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-21) + T >= ((double)0) && ((double)-315) + N >= ((double)0)) ? (((((((double)-466149) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)233180) * floord(T, ((double)7))) + (((double)466360) - ((double)233180) * floord(T, ((double)7))) * floord(((double)135) + N, ((double)150)) + (((double)-116590) + ((double)58295) * floord(T, ((double)7))) * floord(((double)135) + N, ((double)150))*floord(((double)135) + N, ((double)150)))) : ((((double)-21) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)314) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)20) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)211) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	float*** I_NR = (float***)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		I_NR[tt] = (float**)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0); ti++) {
			I_NR[tt][ti] = (float*)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float)));
		}
	}
	
	float*** I = (float***)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float)));
		}
	}
	...
	float*** C1 = (float***)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float)));
		}
	}
	...
	float***** C2 = (float*****)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0),sizeof(float****)));
	for (int tt=0; tt<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(T, 7))) : 0); tt++) {
		C2[tt] = (float****)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float***)));
		for (int ti=0; ti<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0); ti++) {
			C2[tt][ti] = (float***)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0),sizeof(float**)));
			for (int tj=0; tj<((-21 + T >= 0 && -315 + N >= 0) ? ((-2 + floord(135 + N, 150))) : 0); tj++) {
				C2[tt][ti][tj] = (float**)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? (5) : 0),sizeof(float*)));
				for (int p=0; p<((-21 + T >= 0 && -315 + N >= 0) ? (5) : 0); p++) {
					C2[tt][ti][tj][p] = (float*)(calloc(((-21 + T >= 0 && -315 + N >= 0) ? (5) : 0),sizeof(float)));
				}
			}
		}
	}
	...
	#define SC2_NR(tt,ti,tj,p,q,w) C2_NR(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(150*(ti) + (p) + (w)),(150*(tj) + (q) + (w))))
	#define SC2_NR2(tt,ti,tj,p,q,w) C2_NR2(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(163 + 150*(ti) + (p) - (w)),(150*(tj) + (q) + (w))))
	#define SC2_NR3(tt,ti,tj,p,q,w,i) C2_NR3(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(150*(tj) + (q) + (w))))
	#define SC2_NR4(tt,ti,tj,p,q,w) C2_NR4(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(150*(ti) + (p) + (w)),(163 + 150*(tj) + (q) - (w))))
	#define SC2_NR5(tt,ti,tj,p,q,w) C2_NR5(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(163 + 150*(ti) + (p) - (w)),(163 + 150*(tj) + (q) - (w))))
	#define SC2_NR6(tt,ti,tj,p,q,w,i) C2_NR6(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),((i)),(163 + 150*(tj) + (q) - (w))))
	#define SC2_NR7(tt,ti,tj,p,q,w,j) C2_NR7(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(150*(ti) + (p) + (w)),((j))))
	#define SC2_NR8(tt,ti,tj,p,q,w,j) C2_NR8(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((7*(tt) - (w)),(163 + 150*(ti) + (p) - (w)),((j))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==7*(tt_INJ-1)+1 && i==150*ti_INJ+82 && j==150*tj_INJ+82) inject_star2d1r_abft_v2_7_150_150(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (T >= c0 + 14 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 150; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 150; c3 += 1) {
	        for (int c7 = 150 * c2 + 7; c7 <= 150 * c2 + 156; c7 += 1) {
	          for (int c8 = 150 * c3 + 7; c8 <= 150 * c3 + 156; c8 += 1) {
	  ...
	  if (c0 >= 7 && (c0 % 7) + T >= c0 + 14) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 150; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 150; c3 += 1) {
	        for (int c4 = 1; c4 <= 2; c4 += 1) {
	          for (int c7 = -(c0 % 7) + 150 * c3 + 7; c7 <= (c0 % 7) + 150 * c3 + 156; c7 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 15) / 150; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 150; c3 += 1) {
	        for (int c5 = 1; c5 <= 2; c5 += 1) {
	          for (int c7 = -(c0 % 7) + 150 * c2 + 7; c7 <= (c0 % 7) + 150 * c2 + 156; c7 += 1) {
	  ...
	  if (c0 >= 14 && T >= c0 + 7 && c0 % 7 == 0) {
	    for (int c2 = 1; c2 < (N - 15) / 150; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 15) / 150; c3 += 1) {
	        for (int c4 = 150 * c2; c4 <= 150 * c2 + 163; c4 += 1) {
	          for (int c5 = 150 * c3; c5 <= 150 * c3 + 163; c5 += 1) {
	...
	for (int tt = 2; tt < T / 7; tt += 1) {
	  for (int ti = 1; ti < (N - 15) / 150; ti += 1) {
	    for (int tj = 1; tj < (N - 15) / 150; tj += 1) {
	      SI(tt, ti, tj);
	    }
	  }
	}
