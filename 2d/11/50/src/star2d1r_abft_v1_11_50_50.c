/* star2d1r_abft_v1_11_50_50.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_11_50_50 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 50ti <= -51 + N and tj > 0 and 50tj <= -51 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 50ti <= -51 + N and tj > 0 and 50tj <= -51 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 50ti <= -51 + N and tj > 0 and 50tj <= -51 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 11 and -1 - w <= i <= 50 + w and -1 - w <= j <= 50 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 11 and -1 - w <= i <= 50 + w and -1 - w <= j <= 50 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 50ti <= i <= 49 + 50ti and 50tj <= j <= 49 + 50tj } : Y[11tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[11,p,q] * Y[11tt-11,50ti+p,50tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_11_50_50(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_11_50_50(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_11_50_50(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-33) + T >= ((double)0) && ((double)-112) + N >= ((double)0)) ? ((((((((double)368910) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)31908) * floord(T, ((double)11))) + ((((double)-8288) - ((double)592) * N) + (((double)4144) + ((double)296) * N) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50)) + ((((double)14408) - ((double)56) * N - ((double)2) * N*N) + (((double)-7204) + ((double)28) * N + N*N) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50)) + ((((double)1400) + ((double)100) * N) + (((double)-700) - ((double)50) * N) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50)) + (((double)-1250) + ((double)625) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50))) + (((((double)72104) + ((double)592) * N) + (((double)-36052) - ((double)296) * N) * floord(T, ((double)11))) + ((((double)4928) + ((double)408) * N + ((double)4) * N*N) + (((double)-2464) - ((double)204) * N - ((double)2) * N*N) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50)) + ((((double)-8800) - ((double)100) * N) + (((double)4400) + ((double)50) * N) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50))) * floord(((double)49) + N, ((double)50)) + (((((double)-35290) - ((double)352) * N - ((double)2) * N*N) + (((double)17645) + ((double)176) * N + N*N) * floord(T, ((double)11))) + ((((double)-1400) - ((double)100) * N) + (((double)700) + ((double)50) * N) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50)) + (((double)2500) - ((double)1250) * floord(T, ((double)11))) * floord(((double)38) + N, ((double)50))*floord(((double)38) + N, ((double)50))) * floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50)) + ((((double)8800) + ((double)100) * N) + (((double)-4400) - ((double)50) * N) * floord(T, ((double)11))) * floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50)) + (((double)-1250) + ((double)625) * floord(T, ((double)11))) * floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50)))) : (((double)-33) + T >= ((double)0) && ((double)-101) + N >= ((double)0) && ((double)111) - N >= ((double)0)) ? ((((((double)424986) + T) + (((double)150) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)3870) - ((double)74) * N + N*N) * floord(T, ((double)11)))) : ((((double)-33) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)100) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)32) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)432726) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((11),((p)),((q)))) * (Y((-11 + 11*(tt)),(50*(ti) + (p)),(50*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==11*(tt_INJ-1)+1 && i==50*ti_INJ+25 && j==50*tj_INJ+25) inject_star2d1r_abft_v1_11_50_50(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 11; c0 += 1) {
	  for (int c1 = max(2, 11 * c0); c1 <= min(T, 11 * c0 + 10); c1 += 1) {
	    ...
	    if (T >= 11 * c0 + 22 && c1 == 11 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 50; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 50; c4 += 1) {
	          for (int c5 = -12; c5 <= min(61, N - 50 * c3); c5 += 1) {
	            for (int c6 = -12; c6 <= min(61, N - 50 * c4); c6 += 1) {
