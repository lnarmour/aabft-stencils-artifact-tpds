/* star2d1r_abft_v1_11_100_100.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_11_100_100 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 11tt <= -11 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 11 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 11 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj } : Y[11tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[11,p,q] * Y[11tt-11,100ti+p,100tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_11_100_100(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_11_100_100(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_11_100_100(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-33) + T >= ((double)0) && ((double)-212) + N >= ((double)0)) ? ((((((((double)1196610) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)101508) * floord(T, ((double)11))) + ((((double)-38688) - ((double)992) * N) + (((double)19344) + ((double)496) * N) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100)) + ((((double)46558) - ((double)156) * N - ((double)2) * N*N) + (((double)-23279) + ((double)78) * N + N*N) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100)) + ((((double)7800) + ((double)200) * N) + (((double)-3900) - ((double)100) * N) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100))) + (((((double)241704) + ((double)992) * N) + (((double)-120852) - ((double)496) * N) * floord(T, ((double)11))) + ((((double)25428) + ((double)808) * N + ((double)4) * N*N) + (((double)-12714) - ((double)404) * N - ((double)2) * N*N) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100)) + ((((double)-32600) - ((double)200) * N) + (((double)16300) + ((double)100) * N) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100))) * floord(((double)99) + N, ((double)100)) + (((((double)-122740) - ((double)652) * N - ((double)2) * N*N) + (((double)61370) + ((double)326) * N + N*N) * floord(T, ((double)11))) + ((((double)-7800) - ((double)200) * N) + (((double)3900) + ((double)100) * N) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100)) + (((double)10000) - ((double)5000) * floord(T, ((double)11))) * floord(((double)88) + N, ((double)100))*floord(((double)88) + N, ((double)100))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + ((((double)32600) + ((double)200) * N) + (((double)-16300) - ((double)100) * N) * floord(T, ((double)11))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)11))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)))) : (((double)-33) + T >= ((double)0) && ((double)-201) + N >= ((double)0) && ((double)211) - N >= ((double)0)) ? ((((((double)1364486) + T) + (((double)350) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)17570) - ((double)174) * N + N*N) * floord(T, ((double)11)))) : ((((double)-33) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)200) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)32) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)1399626) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((11),((p)),((q)))) * (Y((-11 + 11*(tt)),(100*(ti) + (p)),(100*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==11*(tt_INJ-1)+1 && i==100*ti_INJ+50 && j==100*tj_INJ+50) inject_star2d1r_abft_v1_11_100_100(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 11; c0 += 1) {
	  for (int c1 = max(2, 11 * c0); c1 <= min(T, 11 * c0 + 10); c1 += 1) {
	    ...
	    if (T >= 11 * c0 + 22 && c1 == 11 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 100; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 100; c4 += 1) {
	          for (int c5 = -12; c5 <= min(111, N - 100 * c3); c5 += 1) {
	            for (int c6 = -12; c6 <= min(111, N - 100 * c4); c6 += 1) {
