/* star2d1r_abft_v1_9_100_100.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_9_100_100 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 9 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 9 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj } : Y[9tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[9,p,q] * Y[9tt-9,100ti+p,100tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_9_100_100(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_9_100_100(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_9_100_100(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-27) + T >= ((double)0) && ((double)-210) + N >= ((double)0)) ? ((((((((double)910602) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)97604) * floord(T, ((double)9))) + ((((double)-39360) - ((double)960) * N) + (((double)19680) + ((double)480) * N) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100)) + ((((double)44638) - ((double)164) * N - ((double)2) * N*N) + (((double)-22319) + ((double)82) * N + N*N) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100)) + ((((double)8200) + ((double)200) * N) + (((double)-4100) - ((double)100) * N) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100))) + (((((double)234568) + ((double)960) * N) + (((double)-117284) - ((double)480) * N) * floord(T, ((double)9))) + ((((double)26404) + ((double)808) * N + ((double)4) * N*N) + (((double)-13202) - ((double)404) * N - ((double)2) * N*N) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100)) + ((((double)-32200) - ((double)200) * N) + (((double)16100) + ((double)100) * N) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100))) * floord(((double)99) + N, ((double)100)) + (((((double)-119844) - ((double)644) * N - ((double)2) * N*N) + (((double)59922) + ((double)322) * N + N*N) * floord(T, ((double)9))) + ((((double)-8200) - ((double)200) * N) + (((double)4100) + ((double)100) * N) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100)) + (((double)10000) - ((double)5000) * floord(T, ((double)9))) * floord(((double)90) + N, ((double)100))*floord(((double)90) + N, ((double)100))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + ((((double)32200) + ((double)200) * N) + (((double)-16100) - ((double)100) * N) * floord(T, ((double)9))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)9))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)))) : (((double)-27) + T >= ((double)0) && ((double)-201) + N >= ((double)0) && ((double)209) - N >= ((double)0)) ? ((((((double)1069966) + T) + (((double)358) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)17922) - ((double)178) * N + N*N) * floord(T, ((double)9)))) : ((((double)-27) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)200) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)26) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)1105810) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((9),((p)),((q)))) * (Y((-9 + 9*(tt)),(100*(ti) + (p)),(100*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==9*(tt_INJ-1)+1 && i==100*ti_INJ+50 && j==100*tj_INJ+50) inject_star2d1r_abft_v1_9_100_100(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC1[tt, ti, tj, i, j] : tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj; SC2[tt, ti, tj, p, q] : tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and -10 <= p <= 109 and p <= N - 100ti and -10 <= q <= 109 and q <= N - 100tj; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; Spatch[w, i, j] : T >= 10 and N >= 20 and 0 <= w <= 9 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1; SI[tt, ti, tj] : tt >= 2 and 9tt <= -9 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N; Spatch_NR[w, i, j, p, q] : T >= 10 and N >= 20 and 0 < w <= 9 and p >= -1 and -99 - w + i <= p <= 1 and p <= w + i and q >= -1 and -99 - w + j <= q <= 1 and q <= w + j; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ Spatch[w, i, j]; Spatch_NR[w, i, j, p, q] }"
	...
	for (int c0 = 0; c0 <= T / 9; c0 += 1) {
	  for (int c1 = max(2, 9 * c0); c1 <= min(T, 9 * c0 + 8); c1 += 1) {
	    ...
	    if (T >= 9 * c0 + 18 && c1 == 9 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 100; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 100; c4 += 1) {
	          for (int c5 = -10; c5 <= min(109, N - 100 * c3); c5 += 1) {
	            for (int c6 = -10; c6 <= min(109, N - 100 * c4); c6 += 1) {
