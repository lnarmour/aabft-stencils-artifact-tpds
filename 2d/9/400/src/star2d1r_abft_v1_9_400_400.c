/* star2d1r_abft_v1_9_400_400.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_9_400_400 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 9tt <= -9 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 9 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 9 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 400ti <= i <= 399 + 400ti and 400tj <= j <= 399 + 400tj } : Y[9tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[9,p,q] * Y[9tt-9,400ti+p,400tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_9_400_400(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_9_400_400(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_9_400_400(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-27) + T >= ((double)0) && ((double)-810) + N >= ((double)0)) ? ((((((((double)12616602) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)1345604) * floord(T, ((double)9))) + ((((double)-641760) - ((double)3360) * N) + (((double)320880) + ((double)1680) * N) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400)) + ((((double)599038) - ((double)764) * N - ((double)2) * N*N) + (((double)-299519) + ((double)382) * N + N*N) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400)) + ((((double)152800) + ((double)800) * N) + (((double)-76400) - ((double)400) * N) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400))) + (((((double)3332968) + ((double)3360) * N) + (((double)-1666484) - ((double)1680) * N) * floord(T, ((double)9))) + ((((double)466804) + ((double)3208) * N + ((double)4) * N*N) + (((double)-233402) - ((double)1604) * N - ((double)2) * N*N) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400)) + ((((double)-488800) - ((double)800) * N) + (((double)244400) + ((double)400) * N) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400))) * floord(((double)399) + N, ((double)400)) + (((((double)-1738644) - ((double)2444) * N - ((double)2) * N*N) + (((double)869322) + ((double)1222) * N + N*N) * floord(T, ((double)9))) + ((((double)-152800) - ((double)800) * N) + (((double)76400) + ((double)400) * N) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400)) + (((double)160000) - ((double)80000) * floord(T, ((double)9))) * floord(((double)390) + N, ((double)400))*floord(((double)390) + N, ((double)400))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + ((((double)488800) + ((double)800) * N) + (((double)-244400) - ((double)400) * N) * floord(T, ((double)9))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)9))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)))) : (((double)-27) + T >= ((double)0) && ((double)-801) + N >= ((double)0) && ((double)809) - N >= ((double)0)) ? ((((((double)14685166) + T) + (((double)1558) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)311322) - ((double)778) * N + N*N) * floord(T, ((double)9)))) : ((((double)-27) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)800) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)26) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)15307810) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int w=0; w<(10); w++) {
		patch[w] = (float**)(calloc((420),sizeof(float*)));
		for (int i=0; i<(420); i++) {
			patch[w][i] = (float*)(calloc((420),sizeof(float)));
		}
	}
	...
	float*** I = (float***)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 9))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 9))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** patch_NR = (float***)(calloc((9),sizeof(float**)));
	for (int w=0; w<(9); w++) {
		patch_NR[w] = (float**)(calloc((420),sizeof(float*)));
		for (int i=0; i<(420); i++) {
			patch_NR[w][i] = (float*)(calloc((420),sizeof(float)));
		}
	}
	
	float*** C1 = (float***)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 9))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 9))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** C2 = (float***)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 9))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 9))) : 0); tt++) {
		C2[tt] = (float**)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C2[tt][ti] = (float*)(calloc(((-27 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}

	#define SC1(tt,ti,tj,i,j) C1(tt,ti,tj) += Y((9*(tt)),((i)),((j)))
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((9),((p)),((q)))) * (Y((-9 + 9*(tt)),(400*(ti) + (p)),(400*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==9*(tt_INJ-1)+1 && i==400*ti_INJ+200 && j==400*tj_INJ+200) inject_star2d1r_abft_v1_9_400_400(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 9; c0 += 1) {
	  for (int c1 = max(2, 9 * c0); c1 <= min(T, 9 * c0 + 8); c1 += 1) {
	    ...
	    if (T >= 9 * c0 + 18 && c1 == 9 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 400; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 400; c4 += 1) {
	          for (int c5 = -10; c5 <= min(409, N - 400 * c3); c5 += 1) {
	            for (int c6 = -10; c6 <= min(409, N - 400 * c4); c6 += 1) {
