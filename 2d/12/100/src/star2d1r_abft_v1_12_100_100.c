/* star2d1r_abft_v1_12_100_100.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_12_100_100 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 12tt <= -12 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 12 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 12 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj } : Y[12tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[12,p,q] * Y[12tt-12,100ti+p,100tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_12_100_100(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_12_100_100(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_12_100_100(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-36) + T >= ((double)0) && ((double)-213) + N >= ((double)0)) ? ((((((((double)1346870) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)103508) * floord(T, ((double)12))) + ((((double)-38304) - ((double)1008) * N) + (((double)19152) + ((double)504) * N) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100)) + ((((double)47512) - ((double)152) * N - ((double)2) * N*N) + (((double)-23756) + ((double)76) * N + N*N) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100)) + ((((double)7600) + ((double)200) * N) + (((double)-3800) - ((double)100) * N) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100))) + (((((double)245320) + ((double)1008) * N) + (((double)-122660) - ((double)504) * N) * floord(T, ((double)12))) + ((((double)24928) + ((double)808) * N + ((double)4) * N*N) + (((double)-12464) - ((double)404) * N - ((double)2) * N*N) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100)) + ((((double)-32800) - ((double)200) * N) + (((double)16400) + ((double)100) * N) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100))) * floord(((double)99) + N, ((double)100)) + (((((double)-124194) - ((double)656) * N - ((double)2) * N*N) + (((double)62097) + ((double)328) * N + N*N) * floord(T, ((double)12))) + ((((double)-7600) - ((double)200) * N) + (((double)3800) + ((double)100) * N) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100)) + (((double)10000) - ((double)5000) * floord(T, ((double)12))) * floord(((double)87) + N, ((double)100))*floord(((double)87) + N, ((double)100))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + ((((double)32800) + ((double)200) * N) + (((double)-16400) - ((double)100) * N) * floord(T, ((double)12))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)12))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)))) : (((double)-36) + T >= ((double)0) && ((double)-201) + N >= ((double)0) && ((double)212) - N >= ((double)0)) ? ((((((double)1519092) + T) + (((double)346) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)17397) - ((double)172) * N + N*N) * floord(T, ((double)12)))) : ((((double)-36) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)200) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)35) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)1553886) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((12),((p)),((q)))) * (Y((-12 + 12*(tt)),(100*(ti) + (p)),(100*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==12*(tt_INJ-1)+1 && i==100*ti_INJ+50 && j==100*tj_INJ+50) inject_star2d1r_abft_v1_12_100_100(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC1[tt, ti, tj, i, j] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj; SC2[tt, ti, tj, p, q] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and -13 <= p <= 112 and p <= N - 100ti and -13 <= q <= 112 and q <= N - 100tj; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; Spatch[w, i, j] : T >= 10 and N >= 20 and 0 <= w <= 12 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1; SI[tt, ti, tj] : tt >= 2 and 12tt <= -12 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N; Spatch_NR[w, i, j, p, q] : T >= 10 and N >= 20 and 0 < w <= 12 and p >= -1 and -99 - w + i <= p <= 1 and p <= w + i and q >= -1 and -99 - w + j <= q <= 1 and q <= w + j; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ Spatch[w, i, j]; Spatch_NR[w, i, j, p, q] }"
	...
	for (int c0 = 0; c0 <= T / 12; c0 += 1) {
	  for (int c1 = max(2, 12 * c0); c1 <= min(T, 12 * c0 + 11); c1 += 1) {
	    ...
	    if (T >= 12 * c0 + 24 && c1 == 12 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 100; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 100; c4 += 1) {
	          for (int c5 = -13; c5 <= min(112, N - 100 * c3); c5 += 1) {
	            for (int c6 = -13; c6 <= min(112, N - 100 * c4); c6 += 1) {
