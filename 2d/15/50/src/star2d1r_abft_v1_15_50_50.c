/* star2d1r_abft_v1_15_50_50.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_15_50_50 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 50ti <= -51 + N and tj > 0 and 50tj <= -51 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 50ti <= -51 + N and tj > 0 and 50tj <= -51 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 50ti <= -51 + N and tj > 0 and 50tj <= -51 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 15 and -1 - w <= i <= 50 + w and -1 - w <= j <= 50 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 15 and -1 - w <= i <= 50 + w and -1 - w <= j <= 50 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 50ti <= i <= 49 + 50ti and 50tj <= j <= 49 + 50tj } : Y[15tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[15,p,q] * Y[15tt-15,50ti+p,50tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_15_50_50(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_15_50_50(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_15_50_50(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-116) + N >= ((double)0)) ? ((((((((double)597534) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)36900) * floord(T, ((double)15))) + ((((double)-6560) - ((double)656) * N) + (((double)3280) + ((double)328) * N) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50)) + ((((double)16200) - ((double)40) * N - ((double)2) * N*N) + (((double)-8100) + ((double)20) * N + N*N) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50)) + ((((double)1000) + ((double)100) * N) + (((double)-500) - ((double)50) * N) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50)) + (((double)-1250) + ((double)625) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50))) + (((((double)80360) + ((double)656) * N) + (((double)-40180) - ((double)328) * N) * floord(T, ((double)15))) + ((((double)3680) + ((double)408) * N + ((double)4) * N*N) + (((double)-1840) - ((double)204) * N - ((double)2) * N*N) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50)) + ((((double)-9200) - ((double)100) * N) + (((double)4600) + ((double)50) * N) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50))) * floord(((double)49) + N, ((double)50)) + (((((double)-38330) - ((double)368) * N - ((double)2) * N*N) + (((double)19165) + ((double)184) * N + N*N) * floord(T, ((double)15))) + ((((double)-1000) - ((double)100) * N) + (((double)500) + ((double)50) * N) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50)) + (((double)2500) - ((double)1250) * floord(T, ((double)15))) * floord(((double)34) + N, ((double)50))*floord(((double)34) + N, ((double)50))) * floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50)) + ((((double)9200) + ((double)100) * N) + (((double)-4600) - ((double)50) * N) * floord(T, ((double)15))) * floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50)) + (((double)-1250) + ((double)625) * floord(T, ((double)15))) * floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50))*floord(((double)49) + N, ((double)50)))) : (((double)-45) + T >= ((double)0) && ((double)-101) + N >= ((double)0) && ((double)115) - N >= ((double)0)) ? ((((((double)664154) + T) + (((double)134) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)3590) - ((double)66) * N + N*N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)100) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)671334) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((15),((p)),((q)))) * (Y((-15 + 15*(tt)),(50*(ti) + (p)),(50*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==15*(tt_INJ-1)+1 && i==50*ti_INJ+25 && j==50*tj_INJ+25) inject_star2d1r_abft_v1_15_50_50(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 15; c0 += 1) {
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 50; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 50; c4 += 1) {
	          for (int c5 = -16; c5 <= min(65, N - 50 * c3); c5 += 1) {
	            for (int c6 = -16; c6 <= min(65, N - 50 * c4); c6 += 1) {
