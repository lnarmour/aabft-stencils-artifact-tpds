/* star2d1r_abft_v1_15_350_350.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_15_350_350 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 350ti <= -351 + N and tj > 0 and 350tj <= -351 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 350ti <= -351 + N and tj > 0 and 350tj <= -351 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 350ti <= -351 + N and tj > 0 and 350tj <= -351 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 15 and -1 - w <= i <= 350 + w and -1 - w <= j <= 350 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 15 and -1 - w <= i <= 350 + w and -1 - w <= j <= 350 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 350ti <= i <= 349 + 350ti and 350tj <= j <= 349 + 350tj } : Y[15tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[15,p,q] * Y[15tt-15,350ti+p,350tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_15_350_350(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_15_350_350(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_15_350_350(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-716) + N >= ((double)0)) ? ((((((((double)18103134) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)1073700) * floord(T, ((double)15))) + ((((double)-488960) - ((double)3056) * N) + (((double)244480) + ((double)1528) * N) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350)) + ((((double)483600) - ((double)640) * N - ((double)2) * N*N) + (((double)-241800) + ((double)320) * N + N*N) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350)) + ((((double)112000) + ((double)700) * N) + (((double)-56000) - ((double)350) * N) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350)) + (((double)-61250) + ((double)30625) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350))) + (((((double)2636360) + ((double)3056) * N) + (((double)-1318180) - ((double)1528) * N) * floord(T, ((double)15))) + ((((double)346880) + ((double)2808) * N + ((double)4) * N*N) + (((double)-173440) - ((double)1404) * N - ((double)2) * N*N) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350)) + ((((double)-379400) - ((double)700) * N) + (((double)189700) + ((double)350) * N) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350))) * floord(((double)349) + N, ((double)350)) + (((((double)-1367330) - ((double)2168) * N - ((double)2) * N*N) + (((double)683665) + ((double)1084) * N + N*N) * floord(T, ((double)15))) + ((((double)-112000) - ((double)700) * N) + (((double)56000) + ((double)350) * N) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350)) + (((double)122500) - ((double)61250) * floord(T, ((double)15))) * floord(((double)334) + N, ((double)350))*floord(((double)334) + N, ((double)350))) * floord(((double)349) + N, ((double)350))*floord(((double)349) + N, ((double)350)) + ((((double)379400) + ((double)700) * N) + (((double)-189700) - ((double)350) * N) * floord(T, ((double)15))) * floord(((double)349) + N, ((double)350))*floord(((double)349) + N, ((double)350))*floord(((double)349) + N, ((double)350)) + (((double)-61250) + ((double)30625) * floord(T, ((double)15))) * floord(((double)349) + N, ((double)350))*floord(((double)349) + N, ((double)350))*floord(((double)349) + N, ((double)350))*floord(((double)349) + N, ((double)350)))) : (((double)-45) + T >= ((double)0) && ((double)-701) + N >= ((double)0) && ((double)715) - N >= ((double)0)) ? ((((((double)19783754) + T) + (((double)1334) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)233390) - ((double)666) * N + N*N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)700) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)20250534) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int w=0; w<(16); w++) {
		...
		for (int i=0; i<(382); i++) {
			patch[w][i] = (float*)(calloc((382),sizeof(float)));
		}
	}
	...
	for (int tt=0; tt<((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		...
		for (int ti=0; ti<((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(349 + N, 350))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(349 + N, 350))) : 0),sizeof(float)));
		}
	}
	...
	for (int w=0; w<(15); w++) {
		...
		for (int i=0; i<(382); i++) {
			patch_NR[w][i] = (float*)(calloc((382),sizeof(float)));
		}
	}
	...
	for (int tt=0; tt<((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		...
		for (int ti=0; ti<((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(349 + N, 350))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(349 + N, 350))) : 0),sizeof(float)));
		}
	}
	...
	for (int tt=0; tt<((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(T, 15))) : 0); tt++) {
		...
		for (int ti=0; ti<((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(349 + N, 350))) : 0); ti++) {
			C2[tt][ti] = (float*)(calloc(((-45 + T >= 0 && -701 + N >= 0) ? ((-2 + floord(349 + N, 350))) : 0),sizeof(float)));
		}
	}

	#define SC1(tt,ti,tj,i,j) C1(tt,ti,tj) += Y((15*(tt)),((i)),((j)))
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((15),((p)),((q)))) * (Y((-15 + 15*(tt)),(350*(ti) + (p)),(350*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==15*(tt_INJ-1)+1 && i==350*ti_INJ+175 && j==350*tj_INJ+175) inject_star2d1r_abft_v1_15_350_350(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 15; c0 += 1) {
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 350; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 350; c4 += 1) {
	          for (int c5 = -16; c5 <= min(365, N - 350 * c3); c5 += 1) {
	            for (int c6 = -16; c6 <= min(365, N - 350 * c4); c6 += 1) {
