/* star2d1r_abft_v1_15_100_100.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_15_100_100 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 15tt <= -15 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 15 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 15 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj } : Y[15tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[15,p,q] * Y[15tt-15,100ti+p,100tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_15_100_100(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_15_100_100(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_15_100_100(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-45) + T >= ((double)0) && ((double)-216) + N >= ((double)0)) ? ((((((((double)1827634) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)109700) * floord(T, ((double)15))) + ((((double)-36960) - ((double)1056) * N) + (((double)18480) + ((double)528) * N) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100)) + ((((double)50350) - ((double)140) * N - ((double)2) * N*N) + (((double)-25175) + ((double)70) * N + N*N) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100)) + ((((double)7000) + ((double)200) * N) + (((double)-3500) - ((double)100) * N) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100))) + (((((double)256360) + ((double)1056) * N) + (((double)-128180) - ((double)528) * N) * floord(T, ((double)15))) + ((((double)23380) + ((double)808) * N + ((double)4) * N*N) + (((double)-11690) - ((double)404) * N - ((double)2) * N*N) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100)) + ((((double)-33400) - ((double)200) * N) + (((double)16700) + ((double)100) * N) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100))) * floord(((double)99) + N, ((double)100)) + (((((double)-128580) - ((double)668) * N - ((double)2) * N*N) + (((double)64290) + ((double)334) * N + N*N) * floord(T, ((double)15))) + ((((double)-7000) - ((double)200) * N) + (((double)3500) + ((double)100) * N) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100)) + (((double)10000) - ((double)5000) * floord(T, ((double)15))) * floord(((double)84) + N, ((double)100))*floord(((double)84) + N, ((double)100))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + ((((double)33400) + ((double)200) * N) + (((double)-16700) - ((double)100) * N) * floord(T, ((double)15))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)15))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)))) : (((double)-45) + T >= ((double)0) && ((double)-201) + N >= ((double)0) && ((double)215) - N >= ((double)0)) ? ((((((double)2013254) + T) + (((double)334) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)16890) - ((double)166) * N + N*N) * floord(T, ((double)15)))) : ((((double)-45) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)200) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)44) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)2047034) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((15),((p)),((q)))) * (Y((-15 + 15*(tt)),(100*(ti) + (p)),(100*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==15*(tt_INJ-1)+1 && i==100*ti_INJ+50 && j==100*tj_INJ+50) inject_star2d1r_abft_v1_15_100_100(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC1[tt, ti, tj, i, j] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj; SC2[tt, ti, tj, p, q] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and -16 <= p <= 115 and p <= N - 100ti and -16 <= q <= 115 and q <= N - 100tj; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; Spatch[w, i, j] : T >= 10 and N >= 20 and 0 <= w <= 15 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1; SI[tt, ti, tj] : tt >= 2 and 15tt <= -15 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N; Spatch_NR[w, i, j, p, q] : T >= 10 and N >= 20 and 0 < w <= 15 and p >= -1 and -99 - w + i <= p <= 1 and p <= w + i and q >= -1 and -99 - w + j <= q <= 1 and q <= w + j; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ Spatch[w, i, j]; Spatch_NR[w, i, j, p, q] }"
	...
	for (int c0 = 0; c0 <= T / 15; c0 += 1) {
	  for (int c1 = max(2, 15 * c0); c1 <= min(T, 15 * c0 + 14); c1 += 1) {
	    ...
	    if (T >= 15 * c0 + 30 && c1 == 15 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 100; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 100; c4 += 1) {
	          for (int c5 = -16; c5 <= min(115, N - 100 * c3); c5 += 1) {
	            for (int c6 = -16; c6 <= min(115, N - 100 * c4); c6 += 1) {
