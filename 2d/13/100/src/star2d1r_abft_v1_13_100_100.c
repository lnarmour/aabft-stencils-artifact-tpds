/* star2d1r_abft_v1_13_100_100.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_13_100_100 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 13tt <= -13 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 13tt <= -13 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 13tt <= -13 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 13 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 13 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj } : Y[13tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[13,p,q] * Y[13tt-13,100ti+p,100tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_13_100_100(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_13_100_100(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_13_100_100(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-39) + T >= ((double)0) && ((double)-214) + N >= ((double)0)) ? ((((((((double)1502074) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)105540) * floord(T, ((double)13))) + ((((double)-37888) - ((double)1024) * N) + (((double)18944) + ((double)512) * N) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100)) + ((((double)48462) - ((double)148) * N - ((double)2) * N*N) + (((double)-24231) + ((double)74) * N + N*N) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100)) + ((((double)7400) + ((double)200) * N) + (((double)-3700) - ((double)100) * N) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100))) + (((((double)248968) + ((double)1024) * N) + (((double)-124484) - ((double)512) * N) * floord(T, ((double)13))) + ((((double)24420) + ((double)808) * N + ((double)4) * N*N) + (((double)-12210) - ((double)404) * N - ((double)2) * N*N) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100)) + ((((double)-33000) - ((double)200) * N) + (((double)16500) + ((double)100) * N) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100))) * floord(((double)99) + N, ((double)100)) + (((((double)-125652) - ((double)660) * N - ((double)2) * N*N) + (((double)62826) + ((double)330) * N + N*N) * floord(T, ((double)13))) + ((((double)-7400) - ((double)200) * N) + (((double)3700) + ((double)100) * N) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100)) + (((double)10000) - ((double)5000) * floord(T, ((double)13))) * floord(((double)86) + N, ((double)100))*floord(((double)86) + N, ((double)100))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + ((((double)33000) + ((double)200) * N) + (((double)-16500) - ((double)100) * N) * floord(T, ((double)13))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)) + (((double)-5000) + ((double)2500) * floord(T, ((double)13))) * floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100))*floord(((double)99) + N, ((double)100)))) : (((double)-39) + T >= ((double)0) && ((double)-201) + N >= ((double)0) && ((double)213) - N >= ((double)0)) ? ((((((double)1678702) + T) + (((double)342) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)17226) - ((double)170) * N + N*N) * floord(T, ((double)13)))) : ((((double)-39) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)200) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)38) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)1713154) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((13),((p)),((q)))) * (Y((-13 + 13*(tt)),(100*(ti) + (p)),(100*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==13*(tt_INJ-1)+1 && i==100*ti_INJ+50 && j==100*tj_INJ+50) inject_star2d1r_abft_v1_13_100_100(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC1[tt, ti, tj, i, j] : tt >= 2 and 13tt <= -13 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and 100ti <= i <= 99 + 100ti and 100tj <= j <= 99 + 100tj; SC2[tt, ti, tj, p, q] : tt >= 2 and 13tt <= -13 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N and -14 <= p <= 113 and p <= N - 100ti and -14 <= q <= 113 and q <= N - 100tj; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; Spatch[w, i, j] : T >= 10 and N >= 20 and 0 <= w <= 13 and -1 - w <= i <= 100 + w and -1 - w <= j <= 100 + w; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1; SI[tt, ti, tj] : tt >= 2 and 13tt <= -13 + T and ti > 0 and 100ti <= -101 + N and tj > 0 and 100tj <= -101 + N; Spatch_NR[w, i, j, p, q] : T >= 10 and N >= 20 and 0 < w <= 13 and p >= -1 and -99 - w + i <= p <= 1 and p <= w + i and q >= -1 and -99 - w + j <= q <= 1 and q <= w + j; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ Spatch[w, i, j]; Spatch_NR[w, i, j, p, q] }"
	...
	for (int c0 = 0; c0 <= T / 13; c0 += 1) {
	  for (int c1 = max(2, 13 * c0); c1 <= min(T, 13 * c0 + 12); c1 += 1) {
	    ...
	    if (T >= 13 * c0 + 26 && c1 == 13 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 100; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 100; c4 += 1) {
	          for (int c5 = -14; c5 <= min(113, N - 100 * c3); c5 += 1) {
	            for (int c6 = -14; c6 <= min(113, N - 100 * c4); c6 += 1) {
