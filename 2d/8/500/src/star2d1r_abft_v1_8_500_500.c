/* star2d1r_abft_v1_8_500_500.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_8_500_500 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 500ti <= -501 + N and tj > 0 and 500tj <= -501 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 500ti <= -501 + N and tj > 0 and 500tj <= -501 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 8tt <= -8 + T and ti > 0 and 500ti <= -501 + N and tj > 0 and 500tj <= -501 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 8 and -1 - w <= i <= 500 + w and -1 - w <= j <= 500 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 8 and -1 - w <= i <= 500 + w and -1 - w <= j <= 500 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 500ti <= i <= 499 + 500ti and 500tj <= j <= 499 + 500tj } : Y[8tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[8,p,q] * Y[8tt-8,500ti+p,500tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_8_500_500(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_8_500_500(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_8_500_500(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-24) + T >= ((double)0) && ((double)-1009) + N >= ((double)0)) ? ((((((((double)16849894) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)2073300) * floord(T, ((double)8))) + ((((double)-1002848) - ((double)4144) * N) + (((double)501424) + ((double)2072) * N) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500)) + ((((double)918872) - ((double)968) * N - ((double)2) * N*N) + (((double)-459436) + ((double)484) * N + N*N) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500)) + ((((double)242000) + ((double)1000) * N) + (((double)-121000) - ((double)500) * N) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500)) + (((double)-125000) + ((double)62500) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500))) + (((((double)5149448) + ((double)4144) * N) + (((double)-2574724) - ((double)2072) * N) * floord(T, ((double)8))) + ((((double)735680) + ((double)4008) * N + ((double)4) * N*N) + (((double)-367840) - ((double)2004) * N - ((double)2) * N*N) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500)) + ((((double)-760000) - ((double)1000) * N) + (((double)380000) + ((double)500) * N) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500))) * floord(((double)499) + N, ((double)500)) + (((((double)-2691202) - ((double)3040) * N - ((double)2) * N*N) + (((double)1345601) + ((double)1520) * N + N*N) * floord(T, ((double)8))) + ((((double)-242000) - ((double)1000) * N) + (((double)121000) + ((double)500) * N) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500)) + (((double)250000) - ((double)125000) * floord(T, ((double)8))) * floord(((double)491) + N, ((double)500))*floord(((double)491) + N, ((double)500))) * floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500)) + ((((double)760000) + ((double)1000) * N) + (((double)-380000) - ((double)500) * N) * floord(T, ((double)8))) * floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500)) + (((double)-125000) + ((double)62500) * floord(T, ((double)8))) * floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500))*floord(((double)499) + N, ((double)500)))) : (((double)-24) + T >= ((double)0) && ((double)-1001) + N >= ((double)0) && ((double)1008) - N >= ((double)0)) ? ((((((double)20016292) + T) + (((double)1962) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)490101) - ((double)980) * N + N*N) * floord(T, ((double)8)))) : ((((double)-24) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)1000) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)23) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)20996494) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int w=0; w<(9); w++) {
		...
		for (int i=0; i<(518); i++) {
			patch[w][i] = (float*)(calloc((518),sizeof(float)));
		}
	}
	...
	for (int tt=0; tt<((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(T, 8))) : 0); tt++) {
		...
		for (int ti=0; ti<((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(499 + N, 500))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(499 + N, 500))) : 0),sizeof(float)));
		}
	}
	...
	for (int w=0; w<(8); w++) {
		...
		for (int i=0; i<(518); i++) {
			patch_NR[w][i] = (float*)(calloc((518),sizeof(float)));
		}
	}
	...
	for (int tt=0; tt<((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(T, 8))) : 0); tt++) {
		...
		for (int ti=0; ti<((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(499 + N, 500))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(499 + N, 500))) : 0),sizeof(float)));
		}
	}
	...
	for (int tt=0; tt<((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(T, 8))) : 0); tt++) {
		...
		for (int ti=0; ti<((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(499 + N, 500))) : 0); ti++) {
			C2[tt][ti] = (float*)(calloc(((-24 + T >= 0 && -1001 + N >= 0) ? ((-2 + floord(499 + N, 500))) : 0),sizeof(float)));
		}
	}

	#define SC1(tt,ti,tj,i,j) C1(tt,ti,tj) += Y((8*(tt)),((i)),((j)))
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((8),((p)),((q)))) * (Y((-8 + 8*(tt)),(500*(ti) + (p)),(500*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==8*(tt_INJ-1)+1 && i==500*ti_INJ+250 && j==500*tj_INJ+250) inject_star2d1r_abft_v1_8_500_500(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 8; c0 += 1) {
	  for (int c1 = max(2, 8 * c0); c1 <= min(T, 8 * c0 + 7); c1 += 1) {
	    ...
	    if (T >= 8 * c0 + 16 && c1 == 8 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 500; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 500; c4 += 1) {
	          for (int c5 = -9; c5 <= min(508, N - 500 * c3); c5 += 1) {
	            for (int c6 = -9; c6 <= min(508, N - 500 * c4); c6 += 1) {
