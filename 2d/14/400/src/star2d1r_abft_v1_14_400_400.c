/* star2d1r_abft_v1_14_400_400.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_14_400_400 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 14 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 14 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 400ti <= i <= 399 + 400ti and 400tj <= j <= 399 + 400tj } : Y[14tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[14,p,q] * Y[14tt-14,400ti+p,400tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_14_400_400(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_14_400_400(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_14_400_400(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-42) + T >= ((double)0) && ((double)-815) + N >= ((double)0)) ? ((((((((double)21546302) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)1379604) * floord(T, ((double)14))) + ((((double)-639840) - ((double)3440) * N) + (((double)319920) + ((double)1720) * N) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400)) + ((((double)618808) - ((double)744) * N - ((double)2) * N*N) + (((double)-309404) + ((double)372) * N + N*N) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400)) + ((((double)148800) + ((double)800) * N) + (((double)-74400) - ((double)400) * N) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400))) + (((((double)3399048) + ((double)3440) * N) + (((double)-1699524) - ((double)1720) * N) * floord(T, ((double)14))) + ((((double)458304) + ((double)3208) * N + ((double)4) * N*N) + (((double)-229152) - ((double)1604) * N - ((double)2) * N*N) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400)) + ((((double)-492800) - ((double)800) * N) + (((double)246400) + ((double)400) * N) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400))) * floord(((double)399) + N, ((double)400)) + (((((double)-1766914) - ((double)2464) * N - ((double)2) * N*N) + (((double)883457) + ((double)1232) * N + N*N) * floord(T, ((double)14))) + ((((double)-148800) - ((double)800) * N) + (((double)74400) + ((double)400) * N) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400)) + (((double)160000) - ((double)80000) * floord(T, ((double)14))) * floord(((double)385) + N, ((double)400))*floord(((double)385) + N, ((double)400))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + ((((double)492800) + ((double)800) * N) + (((double)-246400) - ((double)400) * N) * floord(T, ((double)14))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)14))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)))) : (((double)-42) + T >= ((double)0) && ((double)-801) + N >= ((double)0) && ((double)814) - N >= ((double)0)) ? ((((((double)23690596) + T) + (((double)1538) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)307457) - ((double)768) * N + N*N) * floord(T, ((double)14)))) : ((((double)-42) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)800) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)41) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)24305510) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int w=0; w<(15); w++) {
		patch[w] = (float**)(calloc((430),sizeof(float*)));
		for (int i=0; i<(430); i++) {
			patch[w][i] = (float*)(calloc((430),sizeof(float)));
		}
	}
	...
	float*** I = (float***)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** patch_NR = (float***)(calloc((14),sizeof(float**)));
	for (int w=0; w<(14); w++) {
		patch_NR[w] = (float**)(calloc((430),sizeof(float*)));
		for (int i=0; i<(430); i++) {
			patch_NR[w][i] = (float*)(calloc((430),sizeof(float)));
		}
	}
	
	float*** C1 = (float***)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** C2 = (float***)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		C2[tt] = (float**)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C2[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}

	#define SC1(tt,ti,tj,i,j) C1(tt,ti,tj) += Y((14*(tt)),((i)),((j)))
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((14),((p)),((q)))) * (Y((-14 + 14*(tt)),(400*(ti) + (p)),(400*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==14*(tt_INJ-1)+1 && i==400*ti_INJ+200 && j==400*tj_INJ+200) inject_star2d1r_abft_v1_14_400_400(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 14; c0 += 1) {
	  for (int c1 = max(2, 14 * c0); c1 <= min(T, 14 * c0 + 13); c1 += 1) {
	    ...
	    if (T >= 14 * c0 + 28 && c1 == 14 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 400; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 400; c4 += 1) {
	          for (int c5 = -15; c5 <= min(414, N - 400 * c3); c5 += 1) {
	            for (int c6 = -15; c6 <= min(414, N - 400 * c4); c6 += 1) {
