/* star2d1r_abft_v2_14_350_350.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v2_14_350_350 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N }
 *	 		C2 : {[tt, ti, tj, p, q]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p <= 2 and -2 <= q <= 2 }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N }
 *	 		WKernel : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WCombos : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WAll : {[w]: 0 < w <= 14 }
 *	 		C2_NR : {[tt, ti, tj, p, q]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, p, q]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= q < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, p, q]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR5 : {[tt, ti, tj, p, q]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR6 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < q <= 2 }
 *	 		C2_NR7 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 }
 *	 		C2_NR9 : {[tt, ti, tj, p, q]: p = 0 and q = 0 and tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N }
 *	 		I_NR : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 350ti <= i <= 377 + 350ti and 350tj <= j <= 377 + 350tj } : Y[14tt,i,j]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[14tt-w,350ti+p+w,350tj+q+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[14tt-w,350ti+p-w+377,350tj+q+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 14 and 350ti + w <= i <= 377 + 350ti - w } : (WAll[w] * Y[14tt-w,i,350tj+q+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[14tt-w,350ti+p+w,350tj+q-w+377]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[14tt-w,350ti+p-w+377,350tj+q-w+377]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 14 and 350ti + w <= i <= 377 + 350ti - w } : (WAll[w] * Y[14tt-w,i,350tj+q-w+377]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 14 and 350tj + w <= j <= 377 + 350tj - w } : (WAll[w] * Y[14tt-w,350ti+p+w,j]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 14 and 350tj + w <= j <= 377 + 350tj - w } : (WAll[w] * Y[14tt-w,350ti+p-w+377,j]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i,j->tt,ti,tj,p,q), {: w = 14 and 14 + 350ti <= i <= 363 + 350ti and 14 + 350tj <= j <= 363 + 350tj } : (WAll[w] * Y[14tt-w,i,j]));
 *	 		
...
void inject_star2d1r_abft_v2_14_350_350(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v2_14_350_350(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v2_14_350_350(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-42) + T >= ((double)0) && ((double)-729) + N >= ((double)0)) ? (((((((double)-2450302) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)1225260) * floord(T, ((double)14))) + (((double)2450520) - ((double)1225260) * floord(T, ((double)14))) * floord(((double)321) + N, ((double)350)) + (((double)-612630) + ((double)306315) * floord(T, ((double)14))) * floord(((double)321) + N, ((double)350))*floord(((double)321) + N, ((double)350)))) : ((((double)-42) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)728) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)41) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)218) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	float*** I_NR = (float***)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		I_NR[tt] = (float**)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0); ti++) {
			I_NR[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float)));
		}
	}
	
	float*** I = (float***)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float)));
		}
	}
	...
	float*** C1 = (float***)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float)));
		}
	}
	...
	float***** C2 = (float*****)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float****)));
	for (int tt=0; tt<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		C2[tt] = (float****)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float***)));
		for (int ti=0; ti<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0); ti++) {
			C2[tt][ti] = (float***)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0),sizeof(float**)));
			for (int tj=0; tj<((-42 + T >= 0 && -729 + N >= 0) ? ((-2 + floord(321 + N, 350))) : 0); tj++) {
				C2[tt][ti][tj] = (float**)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? (5) : 0),sizeof(float*)));
				for (int p=0; p<((-42 + T >= 0 && -729 + N >= 0) ? (5) : 0); p++) {
					C2[tt][ti][tj][p] = (float*)(calloc(((-42 + T >= 0 && -729 + N >= 0) ? (5) : 0),sizeof(float)));
				}
			}
		}
	}
	...
	#define SC2_NR(tt,ti,tj,p,q,w) C2_NR(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),(350*(ti) + (p) + (w)),(350*(tj) + (q) + (w))))
	#define SC2_NR2(tt,ti,tj,p,q,w) C2_NR2(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),(377 + 350*(ti) + (p) - (w)),(350*(tj) + (q) + (w))))
	#define SC2_NR3(tt,ti,tj,p,q,w,i) C2_NR3(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),((i)),(350*(tj) + (q) + (w))))
	#define SC2_NR4(tt,ti,tj,p,q,w) C2_NR4(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),(350*(ti) + (p) + (w)),(377 + 350*(tj) + (q) - (w))))
	#define SC2_NR5(tt,ti,tj,p,q,w) C2_NR5(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),(377 + 350*(ti) + (p) - (w)),(377 + 350*(tj) + (q) - (w))))
	#define SC2_NR6(tt,ti,tj,p,q,w,i) C2_NR6(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),((i)),(377 + 350*(tj) + (q) - (w))))
	#define SC2_NR7(tt,ti,tj,p,q,w,j) C2_NR7(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),(350*(ti) + (p) + (w)),((j))))
	#define SC2_NR8(tt,ti,tj,p,q,w,j) C2_NR8(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((14*(tt) - (w)),(377 + 350*(ti) + (p) - (w)),((j))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==14*(tt_INJ-1)+1 && i==350*ti_INJ+189 && j==350*tj_INJ+189) inject_star2d1r_abft_v2_14_350_350(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb3[tt, ti, tj, p, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 and 0 < q <= 2; SC2_cb8[tt, ti, tj, p = 0, q = 0] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N; SC2_cb5[tt, ti, tj, p = 0, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < q <= 2; SC1[tt, ti, tj, i, j] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 350ti <= i <= 377 + 350ti and 350tj <= j <= 377 + 350tj; SC2_cb2[tt, ti, tj, p = 0, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= q < 0; SC2_NR6[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < q <= 2 and 0 < w <= 14 and 350ti + w <= i <= 377 + 350ti - w; SC2_NR[tt, ti, tj, p, q, w] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 14; SC2_NR8[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 and 0 < w <= 14 and 350tj + w <= j <= 377 + 350tj - w; SC2_cb4[tt, ti, tj, p, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 and 0 < q <= 2; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SC2_NR9[tt, ti, tj, p = 0, q = 0, w = 14, i, j] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 14 + 350ti <= i <= 363 + 350ti and 14 + 350tj <= j <= 363 + 350tj; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 14; SC2_cb7[tt, ti, tj, p, q = 0] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2; SI[tt, ti, tj] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SC2_NR2[tt, ti, tj, p, q, w] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 14; SC2_cb6[tt, ti, tj, p, q = 0] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0; SWKernel[i, j] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2; SC2_NR7[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 and 0 < w <= 14 and 350tj + w <= j <= 377 + 350tj - w; SWCombos[i, j, p, q] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j; SC2_NR3[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= q < 0 and 0 < w <= 14 and 350ti + w <= i <= 377 + 350ti - w; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; SC2_NR4[tt, ti, tj, p, q, w] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 14; SC2_cb1[tt, ti, tj, p, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb0[tt, ti, tj, p, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p < 0 and -2 <= q < 0; SI_NR[tt, ti, tj, p, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and -2 <= p <= 2 and -2 <= q <= 2; SC2_NR5[tt, ti, tj, p, q, w] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 350ti <= -379 + N and tj > 0 and 350tj <= -379 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 14; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ SWKernel[i, j] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (T >= c0 + 28 && c0 % 14 == 0) {
	    for (int c2 = 1; c2 < floord(N - 29, 350); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 29) / 350; c3 += 1) {
	        for (int c7 = 350 * c2 + 14; c7 <= 350 * c2 + 363; c7 += 1) {
	          for (int c8 = 350 * c3 + 14; c8 <= 350 * c3 + 363; c8 += 1) {
	  ...
	  if (c0 >= 28 && T >= c0 + 14 && c0 % 14 == 0) {
	    for (int c2 = 1; c2 < floord(N - 29, 350); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 29) / 350; c3 += 1) {
	        for (int c4 = 350 * c2; c4 <= 350 * c2 + 377; c4 += 1) {
	          for (int c5 = 350 * c3; c5 <= 350 * c3 + 377; c5 += 1) {
	  ...
	  if (c0 >= 14 && (c0 % 14) + T >= c0 + 28) {
	    ...
	    for (int c2 = 1; c2 < floord(N - 29, 350); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 29) / 350; c3 += 1) {
	        for (int c4 = 1; c4 <= 2; c4 += 1) {
	          for (int c7 = -(c0 % 14) + 350 * c3 + 14; c7 <= (c0 % 14) + 350 * c3 + 363; c7 += 1) {
	    ...
	    for (int c2 = 1; c2 < floord(N - 29, 350); c2 += 1) {
	      for (int c3 = 1; c3 < (N - 29) / 350; c3 += 1) {
	        for (int c5 = 1; c5 <= 2; c5 += 1) {
	          for (int c7 = -(c0 % 14) + 350 * c2 + 14; c7 <= (c0 % 14) + 350 * c2 + 363; c7 += 1) {
	...
	for (int tt = 2; tt < T / 14; tt += 1) {
	  for (int ti = 1; ti < (N - 29) / 350; ti += 1) {
	    for (int tj = 1; tj < (N - 29) / 350; tj += 1) {
	      SI(tt, ti, tj);
	    }
	  }
	}
