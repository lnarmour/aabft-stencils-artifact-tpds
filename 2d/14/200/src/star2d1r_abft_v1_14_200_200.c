/* star2d1r_abft_v1_14_200_200.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_14_200_200 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 200ti <= -201 + N and tj > 0 and 200tj <= -201 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 200ti <= -201 + N and tj > 0 and 200tj <= -201 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 14tt <= -14 + T and ti > 0 and 200ti <= -201 + N and tj > 0 and 200tj <= -201 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 14 and -1 - w <= i <= 200 + w and -1 - w <= j <= 200 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 14 and -1 - w <= i <= 200 + w and -1 - w <= j <= 200 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 200ti <= i <= 199 + 200ti and 200tj <= j <= 199 + 200tj } : Y[14tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[14,p,q] * Y[14tt-14,200ti+p,200tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_14_200_200(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_14_200_200(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_14_200_200(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-42) + T >= ((double)0) && ((double)-415) + N >= ((double)0)) ? ((((((((double)5790302) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)371604) * floord(T, ((double)14))) + ((((double)-158240) - ((double)1840) * N) + (((double)79120) + ((double)920) * N) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200)) + ((((double)169208) - ((double)344) * N - ((double)2) * N*N) + (((double)-84604) + ((double)172) * N + N*N) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200)) + ((((double)34400) + ((double)400) * N) + (((double)-17200) - ((double)200) * N) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200)) + (((double)-20000) + ((double)10000) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200))) + (((((double)901448) + ((double)1840) * N) + (((double)-450724) - ((double)920) * N) * floord(T, ((double)14))) + ((((double)108704) + ((double)1608) * N + ((double)4) * N*N) + (((double)-54352) - ((double)804) * N - ((double)2) * N*N) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200)) + ((((double)-126400) - ((double)400) * N) + (((double)63200) + ((double)200) * N) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200))) * floord(((double)199) + N, ((double)200)) + (((((double)-463714) - ((double)1264) * N - ((double)2) * N*N) + (((double)231857) + ((double)632) * N + N*N) * floord(T, ((double)14))) + ((((double)-34400) - ((double)400) * N) + (((double)17200) + ((double)200) * N) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200)) + (((double)40000) - ((double)20000) * floord(T, ((double)14))) * floord(((double)185) + N, ((double)200))*floord(((double)185) + N, ((double)200))) * floord(((double)199) + N, ((double)200))*floord(((double)199) + N, ((double)200)) + ((((double)126400) + ((double)400) * N) + (((double)-63200) - ((double)200) * N) * floord(T, ((double)14))) * floord(((double)199) + N, ((double)200))*floord(((double)199) + N, ((double)200))*floord(((double)199) + N, ((double)200)) + (((double)-20000) + ((double)10000) * floord(T, ((double)14))) * floord(((double)199) + N, ((double)200))*floord(((double)199) + N, ((double)200))*floord(((double)199) + N, ((double)200))*floord(((double)199) + N, ((double)200)))) : (((double)-42) + T >= ((double)0) && ((double)-401) + N >= ((double)0) && ((double)414) - N >= ((double)0)) ? ((((((double)6385796) + T) + (((double)738) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)73857) - ((double)368) * N + N*N) * floord(T, ((double)14)))) : ((((double)-42) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)400) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)41) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)6533510) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int w=0; w<(15); w++) {
		patch[w] = (float**)(calloc((230),sizeof(float*)));
		for (int i=0; i<(230); i++) {
			patch[w][i] = (float*)(calloc((230),sizeof(float)));
		}
	}
	...
	float*** I = (float***)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0),sizeof(float)));
		}
	}
	
	float*** patch_NR = (float***)(calloc((14),sizeof(float**)));
	for (int w=0; w<(14); w++) {
		patch_NR[w] = (float**)(calloc((230),sizeof(float*)));
		for (int i=0; i<(230); i++) {
			patch_NR[w][i] = (float*)(calloc((230),sizeof(float)));
		}
	}
	
	float*** C1 = (float***)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0),sizeof(float)));
		}
	}
	
	float*** C2 = (float***)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(T, 14))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(T, 14))) : 0); tt++) {
		C2[tt] = (float**)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0); ti++) {
			C2[tt][ti] = (float*)(calloc(((-42 + T >= 0 && -401 + N >= 0) ? ((-2 + floord(199 + N, 200))) : 0),sizeof(float)));
		}
	}

	#define SC1(tt,ti,tj,i,j) C1(tt,ti,tj) += Y((14*(tt)),((i)),((j)))
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((14),((p)),((q)))) * (Y((-14 + 14*(tt)),(200*(ti) + (p)),(200*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==14*(tt_INJ-1)+1 && i==200*ti_INJ+100 && j==200*tj_INJ+100) inject_star2d1r_abft_v1_14_200_200(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC1[tt, ti, tj, i, j] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 200ti <= -201 + N and tj > 0 and 200tj <= -201 + N and 200ti <= i <= 199 + 200ti and 200tj <= j <= 199 + 200tj; SC2[tt, ti, tj, p, q] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 200ti <= -201 + N and tj > 0 and 200tj <= -201 + N and -15 <= p <= 214 and p <= N - 200ti and -15 <= q <= 214 and q <= N - 200tj; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; Spatch[w, i, j] : T >= 10 and N >= 20 and 0 <= w <= 14 and -1 - w <= i <= 200 + w and -1 - w <= j <= 200 + w; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1; SI[tt, ti, tj] : tt >= 2 and 14tt <= -14 + T and ti > 0 and 200ti <= -201 + N and tj > 0 and 200tj <= -201 + N; Spatch_NR[w, i, j, p, q] : T >= 10 and N >= 20 and 0 < w <= 14 and p >= -1 and -199 - w + i <= p <= 1 and p <= w + i and q >= -1 and -199 - w + j <= q <= 1 and q <= w + j; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ Spatch[w, i, j]; Spatch_NR[w, i, j, p, q] }"
	...
	for (int c0 = 0; c0 <= T / 14; c0 += 1) {
	  for (int c1 = max(2, 14 * c0); c1 <= min(T, 14 * c0 + 13); c1 += 1) {
	    ...
	    if (T >= 14 * c0 + 28 && c1 == 14 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 200; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 200; c4 += 1) {
	          for (int c5 = -15; c5 <= min(214, N - 200 * c3); c5 += 1) {
	            for (int c6 = -15; c6 <= min(214, N - 200 * c4); c6 += 1) {
