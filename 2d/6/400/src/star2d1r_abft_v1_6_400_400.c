/* star2d1r_abft_v1_6_400_400.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_6_400_400 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 6 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 6 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 400ti <= i <= 399 + 400ti and 400tj <= j <= 399 + 400tj } : Y[6tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[6,p,q] * Y[6tt-6,400ti+p,400tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_6_400_400(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_6_400_400(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_6_400_400(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-18) + T >= ((double)0) && ((double)-807) + N >= ((double)0)) ? ((((((((double)7459870) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)1325588) * floord(T, ((double)6))) + ((((double)-642528) - ((double)3312) * N) + (((double)321264) + ((double)1656) * N) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400)) + ((((double)587128) - ((double)776) * N - ((double)2) * N*N) + (((double)-293564) + ((double)388) * N + N*N) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400)) + ((((double)155200) + ((double)800) * N) + (((double)-77600) - ((double)400) * N) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400))) + (((((double)3293704) + ((double)3312) * N) + (((double)-1646852) - ((double)1656) * N) * floord(T, ((double)6))) + ((((double)471808) + ((double)3208) * N + ((double)4) * N*N) + (((double)-235904) - ((double)1604) * N - ((double)2) * N*N) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400)) + ((((double)-486400) - ((double)800) * N) + (((double)243200) + ((double)400) * N) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400))) * floord(((double)399) + N, ((double)400)) + (((((double)-1721730) - ((double)2432) * N - ((double)2) * N*N) + (((double)860865) + ((double)1216) * N + N*N) * floord(T, ((double)6))) + ((((double)-155200) - ((double)800) * N) + (((double)77600) + ((double)400) * N) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400)) + (((double)160000) - ((double)80000) * floord(T, ((double)6))) * floord(((double)393) + N, ((double)400))*floord(((double)393) + N, ((double)400))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + ((((double)486400) + ((double)800) * N) + (((double)-243200) - ((double)400) * N) * floord(T, ((double)6))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)6))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)))) : (((double)-18) + T >= ((double)0) && ((double)-801) + N >= ((double)0) && ((double)806) - N >= ((double)0)) ? ((((((double)9483716) + T) + (((double)1570) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)313665) - ((double)784) * N + N*N) * floord(T, ((double)6)))) : ((((double)-18) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)800) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)17) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)10111046) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int w=0; w<(7); w++) {
		patch[w] = (float**)(calloc((414),sizeof(float*)));
		for (int i=0; i<(414); i++) {
			patch[w][i] = (float*)(calloc((414),sizeof(float)));
		}
	}
	...
	float*** I = (float***)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** patch_NR = (float***)(calloc((6),sizeof(float**)));
	for (int w=0; w<(6); w++) {
		patch_NR[w] = (float**)(calloc((414),sizeof(float*)));
		for (int i=0; i<(414); i++) {
			patch_NR[w][i] = (float*)(calloc((414),sizeof(float)));
		}
	}
	
	float*** C1 = (float***)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** C2 = (float***)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C2[tt] = (float**)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C2[tt][ti] = (float*)(calloc(((-18 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}

	#define SC1(tt,ti,tj,i,j) C1(tt,ti,tj) += Y((6*(tt)),((i)),((j)))
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((6),((p)),((q)))) * (Y((-6 + 6*(tt)),(400*(ti) + (p)),(400*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==6*(tt_INJ-1)+1 && i==400*ti_INJ+200 && j==400*tj_INJ+200) inject_star2d1r_abft_v1_6_400_400(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 6; c0 += 1) {
	  for (int c1 = max(2, 6 * c0); c1 <= min(T, 6 * c0 + 5); c1 += 1) {
	    ...
	    if (T >= 6 * c0 + 12 && c1 == 6 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 400; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 400; c4 += 1) {
	          for (int c5 = -7; c5 <= min(406, N - 400 * c3); c5 += 1) {
	            for (int c6 = -7; c6 <= min(406, N - 400 * c4); c6 += 1) {
