/* star2d1r_abft_v2_6_250_250.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v2_6_250_250 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N }
 *	 		C2 : {[tt, ti, tj, p, q]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p <= 2 and -2 <= q <= 2 }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N }
 *	 		WKernel : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WCombos : {[i, j]: -2 <= i <= 2 and -2 <= j <= 2 }
 *	 		WAll : {[w]: 0 < w <= 6 }
 *	 		C2_NR : {[tt, ti, tj, p, q]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 and -2 <= q < 0 }
 *	 		C2_NR2 : {[tt, ti, tj, p, q]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 and -2 <= q < 0 }
 *	 		C2_NR3 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= q < 0 }
 *	 		C2_NR4 : {[tt, ti, tj, p, q]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 and 0 < q <= 2 }
 *	 		C2_NR5 : {[tt, ti, tj, p, q]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 and 0 < q <= 2 }
 *	 		C2_NR6 : {[tt, ti, tj, p, q]: p = 0 and tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < q <= 2 }
 *	 		C2_NR7 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 }
 *	 		C2_NR8 : {[tt, ti, tj, p, q]: q = 0 and tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 }
 *	 		C2_NR9 : {[tt, ti, tj, p, q]: p = 0 and q = 0 and tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N }
 *	 		I_NR : {[tt, ti, tj]: tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 250ti <= i <= 261 + 250ti and 250tj <= j <= 261 + 250tj } : Y[6tt,i,j]);
 *	 		
 ...
 *	 		
 *	 		C2_NR[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[6tt-w,250ti+p+w,250tj+q+w]));
 *	 		
 *	 		C2_NR2[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[6tt-w,250ti+p-w+261,250tj+q+w]));
 *	 		
 *	 		C2_NR3[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 6 and 250ti + w <= i <= 261 + 250ti - w } : (WAll[w] * Y[6tt-w,i,250tj+q+w]));
 *	 		
 *	 		C2_NR4[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[6tt-w,250ti+p+w,250tj+q-w+261]));
 *	 		
 *	 		C2_NR5[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w->tt,ti,tj,p,q), (WAll[w] * Y[6tt-w,250ti+p-w+261,250tj+q-w+261]));
 *	 		
 *	 		C2_NR6[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i->tt,ti,tj,p,q), {: 0 < w <= 6 and 250ti + w <= i <= 261 + 250ti - w } : (WAll[w] * Y[6tt-w,i,250tj+q-w+261]));
 *	 		
 *	 		C2_NR7[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 6 and 250tj + w <= j <= 261 + 250tj - w } : (WAll[w] * Y[6tt-w,250ti+p+w,j]));
 *	 		
 *	 		C2_NR8[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,j->tt,ti,tj,p,q), {: 0 < w <= 6 and 250tj + w <= j <= 261 + 250tj - w } : (WAll[w] * Y[6tt-w,250ti+p-w+261,j]));
 *	 		
 *	 		C2_NR9[tt,ti,tj,p,q] = reduce(+, (tt,ti,tj,p,q,w,i,j->tt,ti,tj,p,q), {: w = 6 and 6 + 250ti <= i <= 255 + 250ti and 6 + 250tj <= j <= 255 + 250tj } : (WAll[w] * Y[6tt-w,i,j]));
 *	 		
...
void inject_star2d1r_abft_v2_6_250_250(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v2_6_250_250(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v2_6_250_250(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-18) + T >= ((double)0) && ((double)-513) + N >= ((double)0)) ? (((((((double)-1148038) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)574124) * floord(T, ((double)6))) + (((double)1148248) - ((double)574124) * floord(T, ((double)6))) * floord(((double)237) + N, ((double)250)) + (((double)-287062) + ((double)143531) * floord(T, ((double)6))) * floord(((double)237) + N, ((double)250))*floord(((double)237) + N, ((double)250)))) : ((((double)-18) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)512) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)17) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)210) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	float*** I_NR = (float***)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		I_NR[tt] = (float**)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0); ti++) {
			I_NR[tt][ti] = (float*)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float)));
		}
	}
	
	float*** I = (float***)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float)));
		}
	}
	...
	float*** C1 = (float***)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float)));
		}
	}
	...
	float***** C2 = (float*****)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0),sizeof(float****)));
	for (int tt=0; tt<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(T, 6))) : 0); tt++) {
		C2[tt] = (float****)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float***)));
		for (int ti=0; ti<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0); ti++) {
			C2[tt][ti] = (float***)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0),sizeof(float**)));
			for (int tj=0; tj<((-18 + T >= 0 && -513 + N >= 0) ? ((-2 + floord(237 + N, 250))) : 0); tj++) {
				C2[tt][ti][tj] = (float**)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? (5) : 0),sizeof(float*)));
				for (int p=0; p<((-18 + T >= 0 && -513 + N >= 0) ? (5) : 0); p++) {
					C2[tt][ti][tj][p] = (float*)(calloc(((-18 + T >= 0 && -513 + N >= 0) ? (5) : 0),sizeof(float)));
				}
			}
		}
	}
	...
	#define SC2_NR(tt,ti,tj,p,q,w) C2_NR(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),(250*(ti) + (p) + (w)),(250*(tj) + (q) + (w))))
	#define SC2_NR2(tt,ti,tj,p,q,w) C2_NR2(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),(261 + 250*(ti) + (p) - (w)),(250*(tj) + (q) + (w))))
	#define SC2_NR3(tt,ti,tj,p,q,w,i) C2_NR3(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),((i)),(250*(tj) + (q) + (w))))
	#define SC2_NR4(tt,ti,tj,p,q,w) C2_NR4(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),(250*(ti) + (p) + (w)),(261 + 250*(tj) + (q) - (w))))
	#define SC2_NR5(tt,ti,tj,p,q,w) C2_NR5(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),(261 + 250*(ti) + (p) - (w)),(261 + 250*(tj) + (q) - (w))))
	#define SC2_NR6(tt,ti,tj,p,q,w,i) C2_NR6(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),((i)),(261 + 250*(tj) + (q) - (w))))
	#define SC2_NR7(tt,ti,tj,p,q,w,j) C2_NR7(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),(250*(ti) + (p) + (w)),((j))))
	#define SC2_NR8(tt,ti,tj,p,q,w,j) C2_NR8(tt,ti,tj,p,q) += (WAll(((w)))) * (Y((6*(tt) - (w)),(261 + 250*(ti) + (p) - (w)),((j))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==6*(tt_INJ-1)+1 && i==250*ti_INJ+131 && j==250*tj_INJ+131) inject_star2d1r_abft_v2_6_250_250(&Y(t,i,j)); } while(0)
	#else
	...
	/*
	 * domain: "[T, N] -> { SC2_cb3[tt, ti, tj, p, q] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 and 0 < q <= 2; SC2_cb8[tt, ti, tj, p = 0, q = 0] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N; SC2_cb5[tt, ti, tj, p = 0, q] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < q <= 2; SC1[tt, ti, tj, i, j] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 250ti <= i <= 261 + 250ti and 250tj <= j <= 261 + 250tj; SC2_cb2[tt, ti, tj, p = 0, q] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= q < 0; SC2_NR6[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < q <= 2 and 0 < w <= 6 and 250ti + w <= i <= 261 + 250ti - w; SC2_NR[tt, ti, tj, p, q, w] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 and -2 <= q < 0 and 0 < w <= 6; SC2_NR8[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 and 0 < w <= 6 and 250tj + w <= j <= 261 + 250tj - w; SC2_cb4[tt, ti, tj, p, q] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 and 0 < q <= 2; SY_cb1[t, i, j = N] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = N, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SY_cb1[t, i, j = 0] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= i <= N; SY_cb1[t, i = 0, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 <= j <= N; SC2_NR9[tt, ti, tj, p = 0, q = 0, w = 6, i, j] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 6 + 250ti <= i <= 255 + 250ti and 6 + 250tj <= j <= 255 + 250tj; SWAll[w] : T >= 10 and N >= 20 and 0 < w <= 6; SC2_cb7[tt, ti, tj, p, q = 0] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2; SI[tt, ti, tj] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N; SY_cb2[t, i, j] : T >= 10 and N >= 20 and 2 <= t <= T and 0 < i < N and 0 < j < N; SC2_NR2[tt, ti, tj, p, q, w] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 and -2 <= q < 0 and 0 < w <= 6; SC2_cb6[tt, ti, tj, p, q = 0] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0; SWKernel[i, j] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2; SC2_NR7[tt, ti, tj, p, q = 0, w, j] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 and 0 < w <= 6 and 250tj + w <= j <= 261 + 250tj - w; SWCombos[i, j, p, q] : T >= 10 and N >= 20 and -2 <= i <= 2 and -2 <= j <= 2 and p >= -2 + i and -1 <= p <= 1 and p <= 2 + i and q >= -2 + j and -1 <= q <= 1 and q <= 2 + j; SC2_NR3[tt, ti, tj, p = 0, q, w, i] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= q < 0 and 0 < w <= 6 and 250ti + w <= i <= 261 + 250ti - w; SY_cb0[t, i, j] : T >= 10 and N >= 20 and 0 <= t <= 1 and 0 <= i <= N and 0 <= j <= N; SC2_NR4[tt, ti, tj, p, q, w] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 and 0 < q <= 2 and 0 < w <= 6; SC2_cb1[tt, ti, tj, p, q] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 and -2 <= q < 0; SC2_cb0[tt, ti, tj, p, q] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p < 0 and -2 <= q < 0; SI_NR[tt, ti, tj, p, q] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and -2 <= p <= 2 and -2 <= q <= 2; SC2_NR5[tt, ti, tj, p, q, w] : tt >= 2 and 6tt <= -6 + T and ti > 0 and 250ti <= -263 + N and tj > 0 and 250tj <= -263 + N and 0 < p <= 2 and 0 < q <= 2 and 0 < w <= 6; SW[i, j] : T >= 10 and N >= 20 and -1 <= i <= 1 and -1 <= j <= 1 }"
	 * child:
	 *   sequence:
	 *   - filter: "{ SW[i, j] }"
	 *   - filter: "{ SWKernel[i, j] }"
	...
	for (int c0 = 2; c0 <= T; c0 += 1) {
	  ...
	  if (T >= c0 + 12 && c0 % 6 == 0) {
	    for (int c2 = 1; c2 < (N - 13) / 250; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 13) / 250; c3 += 1) {
	        for (int c7 = 250 * c2 + 6; c7 <= 250 * c2 + 255; c7 += 1) {
	          for (int c8 = 250 * c3 + 6; c8 <= 250 * c3 + 255; c8 += 1) {
	  ...
	  if (c0 >= 6 && (c0 % 6) + T >= c0 + 12) {
	    ...
	    for (int c2 = 1; c2 < (N - 13) / 250; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 13) / 250; c3 += 1) {
	        for (int c4 = 1; c4 <= 2; c4 += 1) {
	          for (int c7 = -(c0 % 6) + 250 * c3 + 6; c7 <= (c0 % 6) + 250 * c3 + 255; c7 += 1) {
	    ...
	    for (int c2 = 1; c2 < (N - 13) / 250; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 13) / 250; c3 += 1) {
	        for (int c5 = 1; c5 <= 2; c5 += 1) {
	          for (int c7 = -(c0 % 6) + 250 * c2 + 6; c7 <= (c0 % 6) + 250 * c2 + 255; c7 += 1) {
	  ...
	  if (c0 >= 12 && T >= c0 + 6 && c0 % 6 == 0) {
	    for (int c2 = 1; c2 < (N - 13) / 250; c2 += 1) {
	      for (int c3 = 1; c3 < (N - 13) / 250; c3 += 1) {
	        for (int c4 = 250 * c2; c4 <= 250 * c2 + 261; c4 += 1) {
	          for (int c5 = 250 * c3; c5 <= 250 * c3 + 261; c5 += 1) {
	...
	for (int tt = 2; tt < T / 6; tt += 1) {
	  for (int ti = 1; ti < (N - 13) / 250; ti += 1) {
	    for (int tj = 1; tj < (N - 13) / 250; tj += 1) {
	      SI(tt, ti, tj);
	    }
	  }
	}
