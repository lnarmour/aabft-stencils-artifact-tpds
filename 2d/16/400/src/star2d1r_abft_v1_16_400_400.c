/* star2d1r_abft_v1_16_400_400.c
 * 
 * Code generation of the following Alpha system:
 *	 affine star2d1r_abft_v1_16_400_400 [T, N] -> {  : T >= 10 and N >= 20 }
 *	 	inputs
 ...
 *	 		C1 : {[tt, ti, tj]: tt >= 2 and 16tt <= -16 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		C2 : {[tt, ti, tj]: tt >= 2 and 16tt <= -16 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		I : {[tt, ti, tj]: tt >= 2 and 16tt <= -16 + T and ti > 0 and 400ti <= -401 + N and tj > 0 and 400tj <= -401 + N }
 *	 		patch : {[w, i, j]: 0 <= w <= 16 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 *	 		patch_NR : {[w, i, j]: 0 < w <= 16 and -1 - w <= i <= 400 + w and -1 - w <= j <= 400 + w }
 ...
 *	 		};
 *	 		
 *	 		C1[tt,ti,tj] = reduce(+, (tt,ti,tj,i,j->tt,ti,tj), {: 400ti <= i <= 399 + 400ti and 400tj <= j <= 399 + 400tj } : Y[16tt,i,j]);
 *	 		
 *	 		C2[tt,ti,tj] = reduce(+, (tt,ti,tj,p,q->tt,ti,tj), (patch[16,p,q] * Y[16tt-16,400ti+p,400tj+q]));
 *	 		
 *	 		I[tt,ti,tj] = ((C2 - C1) / C1);
 *	 		
...
void inject_star2d1r_abft_v1_16_400_400(float *val) {
	int *bits;
	bits = (int*)val;
	*bits ^= 1 << BIT;
}
...
void star2d1r_abft_v1_16_400_400(double T, double N, float **X, float ***Y)
#else
struct Result star2d1r_abft_v1_16_400_400(long T, long N, float **X, float ***Y)
#endif
{
	#if defined REPORT_COMPLEXITY_ONLY
	#undef ceild
	...
	double total_card = ((((double)-48) + T >= ((double)0) && ((double)-817) + N >= ((double)0)) ? ((((((((double)25237350) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N) + ((double)1393428) * floord(T, ((double)16))) + ((((double)-638848) - ((double)3472) * N) + (((double)319424) + ((double)1736) * N) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400)) + ((((double)626688) - ((double)736) * N - ((double)2) * N*N) + (((double)-313344) + ((double)368) * N + N*N) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400)) + ((((double)147200) + ((double)800) * N) + (((double)-73600) - ((double)400) * N) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400))) + (((((double)3425704) + ((double)3472) * N) + (((double)-1712852) - ((double)1736) * N) * floord(T, ((double)16))) + ((((double)454848) + ((double)3208) * N + ((double)4) * N*N) + (((double)-227424) - ((double)1604) * N - ((double)2) * N*N) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400)) + ((((double)-494400) - ((double)800) * N) + (((double)247200) + ((double)400) * N) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400))) * floord(((double)399) + N, ((double)400)) + (((((double)-1778250) - ((double)2472) * N - ((double)2) * N*N) + (((double)889125) + ((double)1236) * N + N*N) * floord(T, ((double)16))) + ((((double)-147200) - ((double)800) * N) + (((double)73600) + ((double)400) * N) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400)) + (((double)160000) - ((double)80000) * floord(T, ((double)16))) * floord(((double)383) + N, ((double)400))*floord(((double)383) + N, ((double)400))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + ((((double)494400) + ((double)800) * N) + (((double)-247200) - ((double)400) * N) * floord(T, ((double)16))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)) + (((double)-80000) + ((double)40000) * floord(T, ((double)16))) * floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400))*floord(((double)399) + N, ((double)400)))) : (((double)-48) + T >= ((double)0) && ((double)-801) + N >= ((double)0) && ((double)816) - N >= ((double)0)) ? ((((((double)27412356) + T) + (((double)1530) + ((double)2) * T) * N + (((double)-1) + T) * N*N) + (((double)305925) - ((double)764) * N + N*N) * floord(T, ((double)16)))) : ((((double)-48) + T >= ((double)0) && ((double)-20) + N >= ((double)0) && ((double)800) - N >= ((double)0)) || (((double)-10) + T >= ((double)0) && ((double)47) - T >= ((double)0) && ((double)-20) + N >= ((double)0))) ? (((((double)28024206) + T) + (((double)2) + ((double)2) * T) * N + (((double)1) + T) * N*N)) : ((double)0));
	...
	for (int w=0; w<(17); w++) {
		patch[w] = (float**)(calloc((434),sizeof(float*)));
		for (int i=0; i<(434); i++) {
			patch[w][i] = (float*)(calloc((434),sizeof(float)));
		}
	}
	...
	float*** I = (float***)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 16))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 16))) : 0); tt++) {
		I[tt] = (float**)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			I[tt][ti] = (float*)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** patch_NR = (float***)(calloc((16),sizeof(float**)));
	for (int w=0; w<(16); w++) {
		patch_NR[w] = (float**)(calloc((434),sizeof(float*)));
		for (int i=0; i<(434); i++) {
			patch_NR[w][i] = (float*)(calloc((434),sizeof(float)));
		}
	}
	
	float*** C1 = (float***)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 16))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 16))) : 0); tt++) {
		C1[tt] = (float**)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C1[tt][ti] = (float*)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}
	
	float*** C2 = (float***)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 16))) : 0),sizeof(float**)));
	for (int tt=0; tt<((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(T, 16))) : 0); tt++) {
		C2[tt] = (float**)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float*)));
		for (int ti=0; ti<((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0); ti++) {
			C2[tt][ti] = (float*)(calloc(((-48 + T >= 0 && -801 + N >= 0) ? ((-2 + floord(399 + N, 400))) : 0),sizeof(float)));
		}
	}

	#define SC1(tt,ti,tj,i,j) C1(tt,ti,tj) += Y((16*(tt)),((i)),((j)))
	#define SC2(tt,ti,tj,p,q) C2(tt,ti,tj) += (patch((16),((p)),((q)))) * (Y((-16 + 16*(tt)),(400*(ti) + (p)),(400*(tj) + (q))))
	...
	#ifdef ERROR_INJECTION
	#define SY_cb2(t,i,j) do { SY_cb2_hook(t,i,j); if (t==16*(tt_INJ-1)+1 && i==400*ti_INJ+200 && j==400*tj_INJ+200) inject_star2d1r_abft_v1_16_400_400(&Y(t,i,j)); } while(0)
	#else
	...
	for (int c0 = 0; c0 <= T / 16; c0 += 1) {
	  for (int c1 = max(2, 16 * c0); c1 <= min(T, 16 * c0 + 15); c1 += 1) {
	    ...
	    if (T >= 16 * c0 + 32 && c1 == 16 * c0) {
	      for (int c3 = 1; c3 < (N - 1) / 400; c3 += 1) {
	        for (int c4 = 1; c4 < (N - 1) / 400; c4 += 1) {
	          for (int c5 = -17; c5 <= min(416, N - 400 * c3); c5 += 1) {
	            for (int c6 = -17; c6 <= min(416, N - 400 * c4); c6 += 1) {
